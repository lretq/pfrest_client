...
T = TypeVar("T", bound="PostVPNWireGuardTunnelEndpointJsonBody")


@_attrs_define
class PostVPNWireGuardTunnelEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_wire_guard_tunnel_endpoint_json_body = cls(
            privatekey=privatekey,
            name=name,
            enabled=enabled,
            descr=descr,
        ...
        post_vpn_wire_guard_tunnel_endpoint_json_body.additional_properties = d
        return post_vpn_wire_guard_tunnel_endpoint_json_body
