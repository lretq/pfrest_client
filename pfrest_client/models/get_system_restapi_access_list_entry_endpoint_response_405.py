...
T = TypeVar("T", bound="GetSystemRESTAPIAccessListEntryEndpointResponse405")


@_attrs_define
class GetSystemRESTAPIAccessListEntryEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_restapi_access_list_entry_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_system_restapi_access_list_entry_endpoint_response_405.additional_properties = d
        return get_system_restapi_access_list_entry_endpoint_response_405
