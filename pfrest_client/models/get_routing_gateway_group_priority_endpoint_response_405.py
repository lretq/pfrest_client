...
T = TypeVar("T", bound="GetRoutingGatewayGroupPriorityEndpointResponse405")


@_attrs_define
class GetRoutingGatewayGroupPriorityEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_routing_gateway_group_priority_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_routing_gateway_group_priority_endpoint_response_405.additional_properties = d
        return get_routing_gateway_group_priority_endpoint_response_405
