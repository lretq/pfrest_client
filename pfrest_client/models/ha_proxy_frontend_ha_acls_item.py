...
T = TypeVar("T", bound="HAProxyFrontendHaAclsItem")


@_attrs_define
class HAProxyFrontendHaAclsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_frontend_ha_acls_item = cls(
            name=name,
            expression=expression,
            value=value,
        ...
        ha_proxy_frontend_ha_acls_item.additional_properties = d
        return ha_proxy_frontend_ha_acls_item
