...
T = TypeVar("T", bound="DeleteVPNWireGuardPeerEndpointResponse422")


@_attrs_define
class DeleteVPNWireGuardPeerEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpn_wire_guard_peer_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_vpn_wire_guard_peer_endpoint_response_422.additional_properties = d
        return delete_vpn_wire_guard_peer_endpoint_response_422
