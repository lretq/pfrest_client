...
T = TypeVar("T", bound="PostServicesDNSForwarderHostOverrideEndpointResponse405")


@_attrs_define
class PostServicesDNSForwarderHostOverrideEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_dns_forwarder_host_override_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_services_dns_forwarder_host_override_endpoint_response_405.additional_properties = d
        return post_services_dns_forwarder_host_override_endpoint_response_405
