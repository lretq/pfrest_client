...
T = TypeVar("T", bound="PatchServicesDNSResolverAccessListEndpointJsonBody")


@_attrs_define
class PatchServicesDNSResolverAccessListEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dns_resolver_access_list_endpoint_json_body = cls(
            id=id,
            name=name,
            action=action,
        ...
        patch_services_dns_resolver_access_list_endpoint_json_body.additional_properties = d
        return patch_services_dns_resolver_access_list_endpoint_json_body
