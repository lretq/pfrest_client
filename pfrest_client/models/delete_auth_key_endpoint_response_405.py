...
T = TypeVar("T", bound="DeleteAuthKeyEndpointResponse405")


@_attrs_define
class DeleteAuthKeyEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_auth_key_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_auth_key_endpoint_response_405.additional_properties = d
        return delete_auth_key_endpoint_response_405
