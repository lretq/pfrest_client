...
T = TypeVar("T", bound="GetSystemHostnameEndpointResponse406")


@_attrs_define
class GetSystemHostnameEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_hostname_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_system_hostname_endpoint_response_406.additional_properties = d
        return get_system_hostname_endpoint_response_406
