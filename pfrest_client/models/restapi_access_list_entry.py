...
T = TypeVar("T", bound="RESTAPIAccessListEntry")


@_attrs_define
class RESTAPIAccessListEntry:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restapi_access_list_entry.additional_properties = d
        return restapi_access_list_entry
