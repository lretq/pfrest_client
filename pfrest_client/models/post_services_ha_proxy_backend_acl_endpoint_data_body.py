...
T = TypeVar("T", bound="PostServicesHAProxyBackendACLEndpointDataBody")


@_attrs_define
class PostServicesHAProxyBackendACLEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_backend_acl_endpoint_data_body = cls(
            name=name,
            expression=expression,
            value=value,
            parent_id=parent_id,
        ...
        post_services_ha_proxy_backend_acl_endpoint_data_body.additional_properties = d
        return post_services_ha_proxy_backend_acl_endpoint_data_body
