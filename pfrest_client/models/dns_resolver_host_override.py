...
T = TypeVar("T", bound="DNSResolverHostOverride")
...
class DNSResolverHostOverride:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dns_resolver_host_override = cls(
            host=host,
            domain=domain,
            ip=ip,
            descr=descr,
        ...
        dns_resolver_host_override.additional_properties = d
        return dns_resolver_host_override
