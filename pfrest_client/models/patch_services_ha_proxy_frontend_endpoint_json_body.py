...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendEndpointJsonBody")


@_attrs_define
class PatchServicesHAProxyFrontendEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_frontend_endpoint_json_body = cls(
            id=id,
            name=name,
            descr=descr,
            status=status,
        ...
        patch_services_ha_proxy_frontend_endpoint_json_body.additional_properties = d
        return patch_services_ha_proxy_frontend_endpoint_json_body
