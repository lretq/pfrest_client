...
T = TypeVar("T", bound="PatchVPNWireGuardSettingsEndpointJsonBody")


@_attrs_define
class PatchVPNWireGuardSettingsEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_wire_guard_settings_endpoint_json_body = cls(
            enable=enable,
            keep_conf=keep_conf,
        ...
        patch_vpn_wire_guard_settings_endpoint_json_body.additional_properties = d
        return patch_vpn_wire_guard_settings_endpoint_json_body
