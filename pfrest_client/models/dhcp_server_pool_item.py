...
T = TypeVar("T", bound="DHCPServerPoolItem")


@_attrs_define
class DHCPServerPoolItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dhcp_server_pool_item.additional_properties = d
        return dhcp_server_pool_item
