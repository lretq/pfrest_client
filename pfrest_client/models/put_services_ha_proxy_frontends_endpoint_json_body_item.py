...
T = TypeVar("T", bound="PutServicesHAProxyFrontendsEndpointJsonBodyItem")


@_attrs_define
class PutServicesHAProxyFrontendsEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_ha_proxy_frontends_endpoint_json_body_item = cls(
            name=name,
            type_=type_,
            descr=descr,
            status=status,
        ...
        put_services_ha_proxy_frontends_endpoint_json_body_item.additional_properties = d
        return put_services_ha_proxy_frontends_endpoint_json_body_item
