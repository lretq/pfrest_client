...
T = TypeVar("T", bound="GetRoutingStaticRouteEndpointResponse405")


@_attrs_define
class GetRoutingStaticRouteEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_routing_static_route_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_routing_static_route_endpoint_response_405.additional_properties = d
        return get_routing_static_route_endpoint_response_405
