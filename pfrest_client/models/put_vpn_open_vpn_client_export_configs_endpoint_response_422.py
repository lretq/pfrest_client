...
T = TypeVar("T", bound="PutVPNOpenVPNClientExportConfigsEndpointResponse422")


@_attrs_define
class PutVPNOpenVPNClientExportConfigsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_vpn_open_vpn_client_export_configs_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_vpn_open_vpn_client_export_configs_endpoint_response_422.additional_properties = d
        return put_vpn_open_vpn_client_export_configs_endpoint_response_422
