...
T = TypeVar("T", bound="DeleteAuthKeyEndpointResponse406")


@_attrs_define
class DeleteAuthKeyEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_auth_key_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_auth_key_endpoint_response_406.additional_properties = d
        return delete_auth_key_endpoint_response_406
