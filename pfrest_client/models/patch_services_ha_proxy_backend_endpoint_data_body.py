...
T = TypeVar("T", bound="PatchServicesHAProxyBackendEndpointDataBody")


@_attrs_define
class PatchServicesHAProxyBackendEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_backend_endpoint_data_body = cls(
            id=id,
            name=name,
            servers=servers,
            balance=balance,
        ...
        patch_services_ha_proxy_backend_endpoint_data_body.additional_properties = d
        return patch_services_ha_proxy_backend_endpoint_data_body
