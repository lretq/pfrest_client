...
T = TypeVar("T", bound="DeleteVPNOpenVPNClientsEndpointResponse422")


@_attrs_define
class DeleteVPNOpenVPNClientsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpn_open_vpn_clients_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_vpn_open_vpn_clients_endpoint_response_422.additional_properties = d
        return delete_vpn_open_vpn_clients_endpoint_response_422
