...
T = TypeVar("T", bound="PatchRoutingGatewayGroupEndpointDataBody")


@_attrs_define
class PatchRoutingGatewayGroupEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_routing_gateway_group_endpoint_data_body = cls(
            id=id,
            name=name,
            trigger=trigger,
            descr=descr,
        ...
        patch_routing_gateway_group_endpoint_data_body.additional_properties = d
        return patch_routing_gateway_group_endpoint_data_body
