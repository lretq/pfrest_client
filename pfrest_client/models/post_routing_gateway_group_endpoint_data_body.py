...
T = TypeVar("T", bound="PostRoutingGatewayGroupEndpointDataBody")


@_attrs_define
class PostRoutingGatewayGroupEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routing_gateway_group_endpoint_data_body = cls(
            name=name,
            priorities=priorities,
            trigger=trigger,
            descr=descr,
        ...
        post_routing_gateway_group_endpoint_data_body.additional_properties = d
        return post_routing_gateway_group_endpoint_data_body
