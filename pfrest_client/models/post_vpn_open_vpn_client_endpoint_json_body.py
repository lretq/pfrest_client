...
T = TypeVar("T", bound="PostVPNOpenVPNClientEndpointJsonBody")


@_attrs_define
class PostVPNOpenVPNClientEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_open_vpn_client_endpoint_json_body = cls(
            mode=mode,
            dev_mode=dev_mode,
            protocol=protocol,
            interface=interface,
        ...
        post_vpn_open_vpn_client_endpoint_json_body.additional_properties = d
        return post_vpn_open_vpn_client_endpoint_json_body
