...
T = TypeVar("T", bound="HAProxyBackendAction")


@_attrs_define
class HAProxyBackendAction:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_backend_action.additional_properties = d
        return ha_proxy_backend_action
