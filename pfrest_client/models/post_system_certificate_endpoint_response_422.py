...
T = TypeVar("T", bound="PostSystemCertificateEndpointResponse422")


@_attrs_define
class PostSystemCertificateEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_certificate_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_system_certificate_endpoint_response_422.additional_properties = d
        return post_system_certificate_endpoint_response_422
