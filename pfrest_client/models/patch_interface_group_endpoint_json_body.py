...
T = TypeVar("T", bound="PatchInterfaceGroupEndpointJsonBody")


@_attrs_define
class PatchInterfaceGroupEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_group_endpoint_json_body = cls(
            id=id,
            ifname=ifname,
            members=members,
            descr=descr,
        ...
        patch_interface_group_endpoint_json_body.additional_properties = d
        return patch_interface_group_endpoint_json_body
