...
T = TypeVar("T", bound="GetSystemPackageEndpointResponse406")


@_attrs_define
class GetSystemPackageEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_package_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_system_package_endpoint_response_406.additional_properties = d
        return get_system_package_endpoint_response_406
