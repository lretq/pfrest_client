...
T = TypeVar("T", bound="PatchServicesFreeRADIUSMACEndpointResponse405")


@_attrs_define
class PatchServicesFreeRADIUSMACEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_free_radiusmac_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_services_free_radiusmac_endpoint_response_405.additional_properties = d
        return patch_services_free_radiusmac_endpoint_response_405
