...
T = TypeVar("T", bound="PatchServicesACMECertificateDomainEndpointJsonBody")


@_attrs_define
class PatchServicesACMECertificateDomainEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_acme_certificate_domain_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            name=name,
            status=status,
        ...
        patch_services_acme_certificate_domain_endpoint_json_body.additional_properties = d
        return patch_services_acme_certificate_domain_endpoint_json_body
