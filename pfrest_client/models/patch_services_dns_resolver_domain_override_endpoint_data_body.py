...
T = TypeVar("T", bound="PatchServicesDNSResolverDomainOverrideEndpointDataBody")


@_attrs_define
class PatchServicesDNSResolverDomainOverrideEndpointDataBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        domain (str | Unset): The domain to override.<br>
        ip (str | Unset): The IP address to which the domain should resolve.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dns_resolver_domain_override_endpoint_data_body = cls(
            id=id,
            domain=domain,
            ip=ip,
            descr=descr,
        ...
        patch_services_dns_resolver_domain_override_endpoint_data_body.additional_properties = d
        return patch_services_dns_resolver_domain_override_endpoint_data_body
