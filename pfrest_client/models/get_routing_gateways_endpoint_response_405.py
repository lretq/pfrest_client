...
T = TypeVar("T", bound="GetRoutingGatewaysEndpointResponse405")


@_attrs_define
class GetRoutingGatewaysEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_routing_gateways_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_routing_gateways_endpoint_response_405.additional_properties = d
        return get_routing_gateways_endpoint_response_405
