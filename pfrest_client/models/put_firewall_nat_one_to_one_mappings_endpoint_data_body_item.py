...
T = TypeVar("T", bound="PutFirewallNATOneToOneMappingsEndpointDataBodyItem")


@_attrs_define
class PutFirewallNATOneToOneMappingsEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_nat_one_to_one_mappings_endpoint_data_body_item = cls(
            interface=interface,
            external=external,
            source=source,
            destination=destination,
        ...
        put_firewall_nat_one_to_one_mappings_endpoint_data_body_item.additional_properties = d
        return put_firewall_nat_one_to_one_mappings_endpoint_data_body_item
