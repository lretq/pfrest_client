...
T = TypeVar("T", bound="PutUserAuthServersEndpointResponse405")


@_attrs_define
class PutUserAuthServersEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_user_auth_servers_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        put_user_auth_servers_endpoint_response_405.additional_properties = d
        return put_user_auth_servers_endpoint_response_405
