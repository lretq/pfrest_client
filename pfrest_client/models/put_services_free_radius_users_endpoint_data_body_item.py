...
T = TypeVar("T", bound="PutServicesFreeRADIUSUsersEndpointDataBodyItem")


@_attrs_define
class PutServicesFreeRADIUSUsersEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_free_radius_users_endpoint_data_body_item = cls(
            username=username,
            password=password,
            motp_secret=motp_secret,
            motp_pin=motp_pin,
        ...
        put_services_free_radius_users_endpoint_data_body_item.additional_properties = d
        return put_services_free_radius_users_endpoint_data_body_item
