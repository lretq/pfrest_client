...
T = TypeVar("T", bound="PutVPNWireGuardTunnelsEndpointResponse422")


@_attrs_define
class PutVPNWireGuardTunnelsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_vpn_wire_guard_tunnels_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_vpn_wire_guard_tunnels_endpoint_response_422.additional_properties = d
        return put_vpn_wire_guard_tunnels_endpoint_response_422
