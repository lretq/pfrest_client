...
T = TypeVar("T", bound="PostFirewallTrafficShaperEndpointJsonBody")


@_attrs_define
class PostFirewallTrafficShaperEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_endpoint_json_body = cls(
            interface=interface,
            scheduler=scheduler,
            bandwidthtype=bandwidthtype,
            bandwidth=bandwidth,
        ...
        post_firewall_traffic_shaper_endpoint_json_body.additional_properties = d
        return post_firewall_traffic_shaper_endpoint_json_body
