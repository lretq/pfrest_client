...
T = TypeVar("T", bound="GetFirewallStateEndpointResponse406")


@_attrs_define
class GetFirewallStateEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_state_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_firewall_state_endpoint_response_406.additional_properties = d
        return get_firewall_state_endpoint_response_406
