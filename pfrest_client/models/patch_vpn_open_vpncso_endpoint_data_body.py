...
T = TypeVar("T", bound="PatchVPNOpenVPNCSOEndpointDataBody")


@_attrs_define
class PatchVPNOpenVPNCSOEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_open_vpncso_endpoint_data_body = cls(
            id=id,
        ...
        patch_vpn_open_vpncso_endpoint_data_body.additional_properties = d
        return patch_vpn_open_vpncso_endpoint_data_body
