...
T = TypeVar("T", bound="PostVPNOpenVPNCSOEndpointDataBody")


@_attrs_define
class PostVPNOpenVPNCSOEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_open_vpncso_endpoint_data_body = cls(
            common_name=common_name,
            disable=disable,
            block=block,
        ...
        post_vpn_open_vpncso_endpoint_data_body.additional_properties = d
        return post_vpn_open_vpncso_endpoint_data_body
