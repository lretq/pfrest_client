...
T = TypeVar("T", bound="PutSystemRESTAPIAccessListEndpointJsonBodyItem")


@_attrs_define
class PutSystemRESTAPIAccessListEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_system_restapi_access_list_endpoint_json_body_item = cls(
            network=network,
            type_=type_,
            weight=weight,
            users=users,
        ...
        put_system_restapi_access_list_endpoint_json_body_item.additional_properties = d
        return put_system_restapi_access_list_endpoint_json_body_item
