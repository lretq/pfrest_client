...
T = TypeVar("T", bound="PatchInterfaceVLANEndpointResponse406")


@_attrs_define
class PatchInterfaceVLANEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_vlan_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_interface_vlan_endpoint_response_406.additional_properties = d
        return patch_interface_vlan_endpoint_response_406
