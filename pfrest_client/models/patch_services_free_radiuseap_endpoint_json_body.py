...
T = TypeVar("T", bound="PatchServicesFreeRADIUSEAPEndpointJsonBody")


@_attrs_define
class PatchServicesFreeRADIUSEAPEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_free_radiuseap_endpoint_json_body = cls(
        ...
        patch_services_free_radiuseap_endpoint_json_body.additional_properties = d
        return patch_services_free_radiuseap_endpoint_json_body
