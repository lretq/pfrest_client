...
T = TypeVar("T", bound="PatchVPNWireGuardTunnelEndpointJsonBody")


@_attrs_define
class PatchVPNWireGuardTunnelEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_wire_guard_tunnel_endpoint_json_body = cls(
            id=id,
            name=name,
            enabled=enabled,
            descr=descr,
        ...
        patch_vpn_wire_guard_tunnel_endpoint_json_body.additional_properties = d
        return patch_vpn_wire_guard_tunnel_endpoint_json_body
