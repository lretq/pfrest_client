...
T = TypeVar("T", bound="DeleteServicesBINDAccessListEntryEndpointResponse406")


@_attrs_define
class DeleteServicesBINDAccessListEntryEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_bind_access_list_entry_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_services_bind_access_list_entry_endpoint_response_406.additional_properties = d
        return delete_services_bind_access_list_entry_endpoint_response_406
