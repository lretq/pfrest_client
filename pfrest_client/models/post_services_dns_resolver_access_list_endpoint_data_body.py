...
T = TypeVar("T", bound="PostServicesDNSResolverAccessListEndpointDataBody")


@_attrs_define
class PostServicesDNSResolverAccessListEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_dns_resolver_access_list_endpoint_data_body = cls(
            name=name,
            action=action,
            networks=networks,
        ...
        post_services_dns_resolver_access_list_endpoint_data_body.additional_properties = d
        return post_services_dns_resolver_access_list_endpoint_data_body
