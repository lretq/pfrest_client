...
T = TypeVar("T", bound="GetVPNWireGuardTunnelAddressEndpointResponse406")


@_attrs_define
class GetVPNWireGuardTunnelAddressEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpn_wire_guard_tunnel_address_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_vpn_wire_guard_tunnel_address_endpoint_response_406.additional_properties = d
        return get_vpn_wire_guard_tunnel_address_endpoint_response_406
