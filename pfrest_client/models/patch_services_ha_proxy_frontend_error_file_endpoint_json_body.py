...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendErrorFileEndpointJsonBody")


@_attrs_define
class PatchServicesHAProxyFrontendErrorFileEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_frontend_error_file_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            errorcode=errorcode,
            errorfile=errorfile,
        ...
        patch_services_ha_proxy_frontend_error_file_endpoint_json_body.additional_properties = d
        return patch_services_ha_proxy_frontend_error_file_endpoint_json_body
