...
T = TypeVar("T", bound="GetDiagnosticsARPTableEntryEndpointResponse422")


@_attrs_define
class GetDiagnosticsARPTableEntryEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_diagnostics_arp_table_entry_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_diagnostics_arp_table_entry_endpoint_response_422.additional_properties = d
        return get_diagnostics_arp_table_entry_endpoint_response_422
