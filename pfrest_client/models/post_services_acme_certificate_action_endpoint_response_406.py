...
T = TypeVar("T", bound="PostServicesACMECertificateActionEndpointResponse406")


@_attrs_define
class PostServicesACMECertificateActionEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_acme_certificate_action_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_services_acme_certificate_action_endpoint_response_406.additional_properties = d
        return post_services_acme_certificate_action_endpoint_response_406
