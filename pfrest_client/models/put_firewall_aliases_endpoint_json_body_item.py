...
T = TypeVar("T", bound="PutFirewallAliasesEndpointJsonBodyItem")


@_attrs_define
class PutFirewallAliasesEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_aliases_endpoint_json_body_item = cls(
            name=name,
            type_=type_,
            descr=descr,
            address=address,
        ...
        put_firewall_aliases_endpoint_json_body_item.additional_properties = d
        return put_firewall_aliases_endpoint_json_body_item
