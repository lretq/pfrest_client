...
T = TypeVar("T", bound="PostDiagnosticsCommandPromptEndpointResponse405")


@_attrs_define
class PostDiagnosticsCommandPromptEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_diagnostics_command_prompt_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_diagnostics_command_prompt_endpoint_response_405.additional_properties = d
        return post_diagnostics_command_prompt_endpoint_response_405
