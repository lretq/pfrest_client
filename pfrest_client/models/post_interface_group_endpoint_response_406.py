...
T = TypeVar("T", bound="PostInterfaceGroupEndpointResponse406")


@_attrs_define
class PostInterfaceGroupEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_interface_group_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_interface_group_endpoint_response_406.additional_properties = d
        return post_interface_group_endpoint_response_406
