...
T = TypeVar("T", bound="GetServicesDNSForwarderHostOverridesEndpointResponse405")


@_attrs_define
class GetServicesDNSForwarderHostOverridesEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_dns_forwarder_host_overrides_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_services_dns_forwarder_host_overrides_endpoint_response_405.additional_properties = d
        return get_services_dns_forwarder_host_overrides_endpoint_response_405
