...
T = TypeVar("T", bound="PatchServicesDHCPServerStaticMappingEndpointResponse406")


@_attrs_define
class PatchServicesDHCPServerStaticMappingEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_static_mapping_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_services_dhcp_server_static_mapping_endpoint_response_406.additional_properties = d
        return patch_services_dhcp_server_static_mapping_endpoint_response_406
