...
T = TypeVar("T", bound="DeleteFirewallTrafficShaperLimiterEndpointResponse406")


@_attrs_define
class DeleteFirewallTrafficShaperLimiterEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_firewall_traffic_shaper_limiter_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_firewall_traffic_shaper_limiter_endpoint_response_406.additional_properties = d
        return delete_firewall_traffic_shaper_limiter_endpoint_response_406
