...
T = TypeVar("T", bound="GetUsersEndpointResponse405")


@_attrs_define
class GetUsersEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_users_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_users_endpoint_response_405.additional_properties = d
        return get_users_endpoint_response_405
