...
T = TypeVar("T", bound="PutFirewallTrafficShaperLimitersEndpointDataBodyItem")


@_attrs_define
class PutFirewallTrafficShaperLimitersEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_traffic_shaper_limiters_endpoint_data_body_item = cls(
            name=name,
            aqm=aqm,
            sched=sched,
            number=number,
        ...
        put_firewall_traffic_shaper_limiters_endpoint_data_body_item.additional_properties = d
        return put_firewall_traffic_shaper_limiters_endpoint_data_body_item
