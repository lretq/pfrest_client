...
T = TypeVar("T", bound="PatchServicesHAProxyBackendServerEndpointJsonBody")


@_attrs_define
class PatchServicesHAProxyBackendServerEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_backend_server_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            name=name,
            status=status,
        ...
        patch_services_ha_proxy_backend_server_endpoint_json_body.additional_properties = d
        return patch_services_ha_proxy_backend_server_endpoint_json_body
