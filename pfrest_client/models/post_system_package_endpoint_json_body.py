...
T = TypeVar("T", bound="PostSystemPackageEndpointJsonBody")


@_attrs_define
class PostSystemPackageEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_package_endpoint_json_body = cls(
            name=name,
            shortname=shortname,
            descr=descr,
        ...
        post_system_package_endpoint_json_body.additional_properties = d
        return post_system_package_endpoint_json_body
