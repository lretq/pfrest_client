...
T = TypeVar("T", bound="PostSystemCertificatePKCS12ExportEndpointDataBody")


@_attrs_define
class PostSystemCertificatePKCS12ExportEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_certificate_pkcs12_export_endpoint_data_body = cls(
            certref=certref,
        ...
        post_system_certificate_pkcs12_export_endpoint_data_body.additional_properties = d
        return post_system_certificate_pkcs12_export_endpoint_data_body
