...
T = TypeVar("T", bound="PatchStatusLogsSettingsEndpointResponse422")


@_attrs_define
class PatchStatusLogsSettingsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_status_logs_settings_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_status_logs_settings_endpoint_response_422.additional_properties = d
        return patch_status_logs_settings_endpoint_response_422
