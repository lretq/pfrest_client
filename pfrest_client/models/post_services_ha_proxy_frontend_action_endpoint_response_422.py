...
T = TypeVar("T", bound="PostServicesHAProxyFrontendActionEndpointResponse422")


@_attrs_define
class PostServicesHAProxyFrontendActionEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_frontend_action_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_services_ha_proxy_frontend_action_endpoint_response_422.additional_properties = d
        return post_services_ha_proxy_frontend_action_endpoint_response_422
