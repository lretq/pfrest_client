...
T = TypeVar("T", bound="PostServicesFreeRADIUSClientEndpointDataBody")


@_attrs_define
class PostServicesFreeRADIUSClientEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_free_radius_client_endpoint_data_body = cls(
            addr=addr,
            shortname=shortname,
            secret=secret,
        ...
        post_services_free_radius_client_endpoint_data_body.additional_properties = d
        return post_services_free_radius_client_endpoint_data_body
