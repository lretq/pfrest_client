...
T = TypeVar("T", bound="GetVPNWireGuardPeersEndpointResponse406")


@_attrs_define
class GetVPNWireGuardPeersEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpn_wire_guard_peers_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_vpn_wire_guard_peers_endpoint_response_406.additional_properties = d
        return get_vpn_wire_guard_peers_endpoint_response_406
