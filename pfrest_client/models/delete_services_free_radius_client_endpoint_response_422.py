...
T = TypeVar("T", bound="DeleteServicesFreeRADIUSClientEndpointResponse422")


@_attrs_define
class DeleteServicesFreeRADIUSClientEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_free_radius_client_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_services_free_radius_client_endpoint_response_422.additional_properties = d
        return delete_services_free_radius_client_endpoint_response_422
