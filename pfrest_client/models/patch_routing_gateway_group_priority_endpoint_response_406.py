...
T = TypeVar("T", bound="PatchRoutingGatewayGroupPriorityEndpointResponse406")


@_attrs_define
class PatchRoutingGatewayGroupPriorityEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_routing_gateway_group_priority_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_routing_gateway_group_priority_endpoint_response_406.additional_properties = d
        return patch_routing_gateway_group_priority_endpoint_response_406
