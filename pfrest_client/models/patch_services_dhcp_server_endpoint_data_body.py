...
T = TypeVar("T", bound="PatchServicesDHCPServerEndpointDataBody")


@_attrs_define
class PatchServicesDHCPServerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_endpoint_data_body = cls(
            id=id,
            interface=interface,
            enable=enable,
        ...
        patch_services_dhcp_server_endpoint_data_body.additional_properties = d
        return patch_services_dhcp_server_endpoint_data_body
