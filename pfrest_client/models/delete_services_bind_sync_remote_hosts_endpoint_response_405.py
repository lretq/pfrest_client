...
T = TypeVar("T", bound="DeleteServicesBINDSyncRemoteHostsEndpointResponse405")


@_attrs_define
class DeleteServicesBINDSyncRemoteHostsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_bind_sync_remote_hosts_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_services_bind_sync_remote_hosts_endpoint_response_405.additional_properties = d
        return delete_services_bind_sync_remote_hosts_endpoint_response_405
