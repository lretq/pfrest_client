...
T = TypeVar("T", bound="PostFirewallNATOneToOneMappingEndpointResponse405")


@_attrs_define
class PostFirewallNATOneToOneMappingEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_nat_one_to_one_mapping_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_firewall_nat_one_to_one_mapping_endpoint_response_405.additional_properties = d
        return post_firewall_nat_one_to_one_mapping_endpoint_response_405
