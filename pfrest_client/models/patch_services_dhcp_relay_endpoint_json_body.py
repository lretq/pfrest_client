...
T = TypeVar("T", bound="PatchServicesDHCPRelayEndpointJsonBody")


@_attrs_define
class PatchServicesDHCPRelayEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_relay_endpoint_json_body = cls(
            server=server,
            enable=enable,
            interface=interface,
        ...
        patch_services_dhcp_relay_endpoint_json_body.additional_properties = d
        return patch_services_dhcp_relay_endpoint_json_body
