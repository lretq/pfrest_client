...
T = TypeVar("T", bound="PatchServicesACMECertificateEndpointDataBody")


@_attrs_define
class PatchServicesACMECertificateEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_acme_certificate_endpoint_data_body = cls(
            id=id,
            name=name,
            descr=descr,
            status=status,
        ...
        patch_services_acme_certificate_endpoint_data_body.additional_properties = d
        return patch_services_acme_certificate_endpoint_data_body
