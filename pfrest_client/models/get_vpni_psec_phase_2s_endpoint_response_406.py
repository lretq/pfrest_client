...
T = TypeVar("T", bound="GetVPNIPsecPhase2SEndpointResponse406")


@_attrs_define
class GetVPNIPsecPhase2SEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpni_psec_phase_2s_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_vpni_psec_phase_2s_endpoint_response_406.additional_properties = d
        return get_vpni_psec_phase_2s_endpoint_response_406
