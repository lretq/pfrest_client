...
T = TypeVar("T", bound="GetDiagnosticsConfigHistoryRevisionEndpointResponse405")


@_attrs_define
class GetDiagnosticsConfigHistoryRevisionEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_diagnostics_config_history_revision_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_diagnostics_config_history_revision_endpoint_response_405.additional_properties = d
        return get_diagnostics_config_history_revision_endpoint_response_405
