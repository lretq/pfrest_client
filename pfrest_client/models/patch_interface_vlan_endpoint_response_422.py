...
T = TypeVar("T", bound="PatchInterfaceVLANEndpointResponse422")


@_attrs_define
class PatchInterfaceVLANEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_vlan_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_interface_vlan_endpoint_response_422.additional_properties = d
        return patch_interface_vlan_endpoint_response_422
