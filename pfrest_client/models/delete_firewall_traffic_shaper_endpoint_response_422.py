...
T = TypeVar("T", bound="DeleteFirewallTrafficShaperEndpointResponse422")


@_attrs_define
class DeleteFirewallTrafficShaperEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_firewall_traffic_shaper_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_firewall_traffic_shaper_endpoint_response_422.additional_properties = d
        return delete_firewall_traffic_shaper_endpoint_response_422
