...
T = TypeVar("T", bound="GetAuthKeysEndpointResponse406")


@_attrs_define
class GetAuthKeysEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_auth_keys_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_auth_keys_endpoint_response_406.additional_properties = d
        return get_auth_keys_endpoint_response_406
