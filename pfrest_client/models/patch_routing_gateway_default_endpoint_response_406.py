...
T = TypeVar("T", bound="PatchRoutingGatewayDefaultEndpointResponse406")


@_attrs_define
class PatchRoutingGatewayDefaultEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_routing_gateway_default_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_routing_gateway_default_endpoint_response_406.additional_properties = d
        return patch_routing_gateway_default_endpoint_response_406
