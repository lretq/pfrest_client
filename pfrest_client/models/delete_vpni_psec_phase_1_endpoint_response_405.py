...
T = TypeVar("T", bound="DeleteVPNIPsecPhase1EndpointResponse405")


@_attrs_define
class DeleteVPNIPsecPhase1EndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpni_psec_phase_1_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_vpni_psec_phase_1_endpoint_response_405.additional_properties = d
        return delete_vpni_psec_phase_1_endpoint_response_405
