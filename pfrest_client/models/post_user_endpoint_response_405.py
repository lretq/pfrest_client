...
T = TypeVar("T", bound="PostUserEndpointResponse405")


@_attrs_define
class PostUserEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_user_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_user_endpoint_response_405.additional_properties = d
        return post_user_endpoint_response_405
