...
T = TypeVar("T", bound="DHCPServerStaticmapItem")


@_attrs_define
class DHCPServerStaticmapItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dhcp_server_staticmap_item = cls(
            mac=mac,
            ipaddr=ipaddr,
            cid=cid,
            hostname=hostname,
        ...
        dhcp_server_staticmap_item.additional_properties = d
        return dhcp_server_staticmap_item
