...
T = TypeVar("T", bound="PutServicesBINDViewsEndpointJsonBodyItem")


@_attrs_define
class PutServicesBINDViewsEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_bind_views_endpoint_json_body_item = cls(
            name=name,
            descr=descr,
            recursion=recursion,
        ...
        put_services_bind_views_endpoint_json_body_item.additional_properties = d
        return put_services_bind_views_endpoint_json_body_item
