...
T = TypeVar("T", bound="HAProxyFrontendACL")


@_attrs_define
class HAProxyFrontendACL:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_frontend_acl.additional_properties = d
        return ha_proxy_frontend_acl
