...
T = TypeVar("T", bound="DeleteVPNWireGuardTunnelAddressEndpointResponse405")


@_attrs_define
class DeleteVPNWireGuardTunnelAddressEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpn_wire_guard_tunnel_address_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_vpn_wire_guard_tunnel_address_endpoint_response_405.additional_properties = d
        return delete_vpn_wire_guard_tunnel_address_endpoint_response_405
