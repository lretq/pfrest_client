...
T = TypeVar("T", bound="PostVPNIPsecPhase2EndpointJsonBody")


@_attrs_define
class PostVPNIPsecPhase2EndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpni_psec_phase_2_endpoint_json_body = cls(
            ikeid=ikeid,
            mode=mode,
            localid_type=localid_type,
            localid_address=localid_address,
        ...
        post_vpni_psec_phase_2_endpoint_json_body.additional_properties = d
        return post_vpni_psec_phase_2_endpoint_json_body
