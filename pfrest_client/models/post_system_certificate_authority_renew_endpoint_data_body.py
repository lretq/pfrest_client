...
T = TypeVar("T", bound="PostSystemCertificateAuthorityRenewEndpointDataBody")


@_attrs_define
class PostSystemCertificateAuthorityRenewEndpointDataBody:
    """
    Attributes:
        caref (str): The Certificate Authority to renew.<br>
        reusekey (bool | Unset): Reuses the existing private key when renewing the certificate authority.<br> Default:
            True.
        reuseserial (bool | Unset): Reuses the existing serial number when renewing the certificate authority.<br>
            Default: True.
        strictsecurity (bool | Unset): Enforces strict security measures when renewing the certificate authority.<br>
        oldserial (None | str | Unset): The old serial number of the Certificate Authority before the renewal.<br>
        newserial (None | str | Unset): The new serial number of the Certificate Authority after the renewal.<br>
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_certificate_authority_renew_endpoint_data_body = cls(
            caref=caref,
            reusekey=reusekey,
        ...
        post_system_certificate_authority_renew_endpoint_data_body.additional_properties = d
        return post_system_certificate_authority_renew_endpoint_data_body
