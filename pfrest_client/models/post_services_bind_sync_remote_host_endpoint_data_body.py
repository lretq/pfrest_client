...
T = TypeVar("T", bound="PostServicesBINDSyncRemoteHostEndpointDataBody")


@_attrs_define
class PostServicesBINDSyncRemoteHostEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_bind_sync_remote_host_endpoint_data_body = cls(
            syncprotocol=syncprotocol,
            ipaddress=ipaddress,
            syncport=syncport,
            username=username,
        ...
        post_services_bind_sync_remote_host_endpoint_data_body.additional_properties = d
        return post_services_bind_sync_remote_host_endpoint_data_body
