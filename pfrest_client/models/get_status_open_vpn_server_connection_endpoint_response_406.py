...
T = TypeVar("T", bound="GetStatusOpenVPNServerConnectionEndpointResponse406")


@_attrs_define
class GetStatusOpenVPNServerConnectionEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_status_open_vpn_server_connection_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_status_open_vpn_server_connection_endpoint_response_406.additional_properties = d
        return get_status_open_vpn_server_connection_endpoint_response_406
