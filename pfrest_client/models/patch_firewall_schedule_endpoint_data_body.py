...
T = TypeVar("T", bound="PatchFirewallScheduleEndpointDataBody")


@_attrs_define
class PatchFirewallScheduleEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_schedule_endpoint_data_body = cls(
            id=id,
        ...
        patch_firewall_schedule_endpoint_data_body.additional_properties = d
        return patch_firewall_schedule_endpoint_data_body
