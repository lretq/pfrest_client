...
T = TypeVar("T", bound="PostServicesServiceWatchdogEndpointResponse406")


@_attrs_define
class PostServicesServiceWatchdogEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_service_watchdog_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_services_service_watchdog_endpoint_response_406.additional_properties = d
        return post_services_service_watchdog_endpoint_response_406
