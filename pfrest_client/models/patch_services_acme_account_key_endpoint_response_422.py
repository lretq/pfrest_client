...
T = TypeVar("T", bound="PatchServicesACMEAccountKeyEndpointResponse422")


@_attrs_define
class PatchServicesACMEAccountKeyEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_acme_account_key_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_services_acme_account_key_endpoint_response_422.additional_properties = d
        return patch_services_acme_account_key_endpoint_response_422
