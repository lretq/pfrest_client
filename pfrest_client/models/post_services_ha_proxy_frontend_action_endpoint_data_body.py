...
T = TypeVar("T", bound="PostServicesHAProxyFrontendActionEndpointDataBody")


@_attrs_define
class PostServicesHAProxyFrontendActionEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_frontend_action_endpoint_data_body = cls(
            action=action,
            acl=acl,
            backend=backend,
            customaction=customaction,
        ...
        post_services_ha_proxy_frontend_action_endpoint_data_body.additional_properties = d
        return post_services_ha_proxy_frontend_action_endpoint_data_body
