...
T = TypeVar("T", bound="GetInterfaceBridgesEndpointResponse406")


@_attrs_define
class GetInterfaceBridgesEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_interface_bridges_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_interface_bridges_endpoint_response_406.additional_properties = d
        return get_interface_bridges_endpoint_response_406
