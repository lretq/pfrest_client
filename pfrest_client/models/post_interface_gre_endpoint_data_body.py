...
T = TypeVar("T", bound="PostInterfaceGREEndpointDataBody")


@_attrs_define
class PostInterfaceGREEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_interface_gre_endpoint_data_body = cls(
            if_=if_,
            remote_addr=remote_addr,
            tunnel_remote_addr=tunnel_remote_addr,
            tunnel_remote_addr6=tunnel_remote_addr6,
        ...
        post_interface_gre_endpoint_data_body.additional_properties = d
        return post_interface_gre_endpoint_data_body
