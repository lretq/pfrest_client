...
T = TypeVar("T", bound="PutServicesHAProxyFrontendsEndpointResponse406")


@_attrs_define
class PutServicesHAProxyFrontendsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_ha_proxy_frontends_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        put_services_ha_proxy_frontends_endpoint_response_406.additional_properties = d
        return put_services_ha_proxy_frontends_endpoint_response_406
