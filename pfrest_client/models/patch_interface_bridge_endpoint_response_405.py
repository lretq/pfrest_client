...
T = TypeVar("T", bound="PatchInterfaceBridgeEndpointResponse405")


@_attrs_define
class PatchInterfaceBridgeEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_bridge_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_interface_bridge_endpoint_response_405.additional_properties = d
        return patch_interface_bridge_endpoint_response_405
