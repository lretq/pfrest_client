...
T = TypeVar("T", bound="GetRoutingGatewayGroupPrioritiesEndpointResponse422")


@_attrs_define
class GetRoutingGatewayGroupPrioritiesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_routing_gateway_group_priorities_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_routing_gateway_group_priorities_endpoint_response_422.additional_properties = d
        return get_routing_gateway_group_priorities_endpoint_response_422
