...
T = TypeVar("T", bound="PostRoutingApplyEndpointJsonBody")


@_attrs_define
class PostRoutingApplyEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routing_apply_endpoint_json_body = cls(
            applied=applied,
        )

        post_routing_apply_endpoint_json_body.additional_properties = d
        return post_routing_apply_endpoint_json_body
