...
T = TypeVar("T", bound="DeleteRoutingGatewayGroupPrioritiesEndpointResponse406")


@_attrs_define
class DeleteRoutingGatewayGroupPrioritiesEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_routing_gateway_group_priorities_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_routing_gateway_group_priorities_endpoint_response_406.additional_properties = d
        return delete_routing_gateway_group_priorities_endpoint_response_406
