...
T = TypeVar("T", bound="GetUserGroupEndpointResponse422")


@_attrs_define
class GetUserGroupEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_group_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_user_group_endpoint_response_422.additional_properties = d
        return get_user_group_endpoint_response_422
