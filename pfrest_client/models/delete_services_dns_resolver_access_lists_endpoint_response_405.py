...
T = TypeVar("T", bound="DeleteServicesDNSResolverAccessListsEndpointResponse405")


@_attrs_define
class DeleteServicesDNSResolverAccessListsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_dns_resolver_access_lists_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_services_dns_resolver_access_lists_endpoint_response_405.additional_properties = d
        return delete_services_dns_resolver_access_lists_endpoint_response_405
