...
T = TypeVar("T", bound="PatchRoutingGatewayDefaultEndpointJsonBody")


@_attrs_define
class PatchRoutingGatewayDefaultEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_routing_gateway_default_endpoint_json_body = cls(
            defaultgw4=defaultgw4,
            defaultgw6=defaultgw6,
        )

        patch_routing_gateway_default_endpoint_json_body.additional_properties = d
        return patch_routing_gateway_default_endpoint_json_body
