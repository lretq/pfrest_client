...
T = TypeVar("T", bound="PatchServicesBINDSyncRemoteHostEndpointResponse405")


@_attrs_define
class PatchServicesBINDSyncRemoteHostEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_bind_sync_remote_host_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_services_bind_sync_remote_host_endpoint_response_405.additional_properties = d
        return patch_services_bind_sync_remote_host_endpoint_response_405
