...
T = TypeVar("T", bound="PutSystemTunablesEndpointResponse405")


@_attrs_define
class PutSystemTunablesEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_system_tunables_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        put_system_tunables_endpoint_response_405.additional_properties = d
        return put_system_tunables_endpoint_response_405
