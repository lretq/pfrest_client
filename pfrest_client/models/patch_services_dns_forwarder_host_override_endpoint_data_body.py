...
T = TypeVar("T", bound="PatchServicesDNSForwarderHostOverrideEndpointDataBody")


@_attrs_define
class PatchServicesDNSForwarderHostOverrideEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dns_forwarder_host_override_endpoint_data_body = cls(
            id=id,
            host=host,
            domain=domain,
            ip=ip,
        ...
        patch_services_dns_forwarder_host_override_endpoint_data_body.additional_properties = d
        return patch_services_dns_forwarder_host_override_endpoint_data_body
