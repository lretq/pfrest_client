...
T = TypeVar("T", bound="DeleteServicesHAProxyBackendActionEndpointResponse422")


@_attrs_define
class DeleteServicesHAProxyBackendActionEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_ha_proxy_backend_action_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_services_ha_proxy_backend_action_endpoint_response_422.additional_properties = d
        return delete_services_ha_proxy_backend_action_endpoint_response_422
