...
T = TypeVar("T", bound="GetInterfaceGroupsEndpointResponse422")


@_attrs_define
class GetInterfaceGroupsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_interface_groups_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_interface_groups_endpoint_response_422.additional_properties = d
        return get_interface_groups_endpoint_response_422
