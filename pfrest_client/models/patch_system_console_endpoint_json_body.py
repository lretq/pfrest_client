...
T = TypeVar("T", bound="PatchSystemConsoleEndpointJsonBody")


@_attrs_define
class PatchSystemConsoleEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_console_endpoint_json_body = cls(
            passwd_protect_console=passwd_protect_console,
        )

        patch_system_console_endpoint_json_body.additional_properties = d
        return patch_system_console_endpoint_json_body
