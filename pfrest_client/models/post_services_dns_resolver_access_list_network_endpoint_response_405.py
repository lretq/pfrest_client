...
T = TypeVar("T", bound="PostServicesDNSResolverAccessListNetworkEndpointResponse405")


@_attrs_define
class PostServicesDNSResolverAccessListNetworkEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_dns_resolver_access_list_network_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_services_dns_resolver_access_list_network_endpoint_response_405.additional_properties = d
        return post_services_dns_resolver_access_list_network_endpoint_response_405
