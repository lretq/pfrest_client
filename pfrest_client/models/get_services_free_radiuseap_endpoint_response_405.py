...
T = TypeVar("T", bound="GetServicesFreeRADIUSEAPEndpointResponse405")


@_attrs_define
class GetServicesFreeRADIUSEAPEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_free_radiuseap_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_services_free_radiuseap_endpoint_response_405.additional_properties = d
        return get_services_free_radiuseap_endpoint_response_405
