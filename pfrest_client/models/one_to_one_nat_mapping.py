...
T = TypeVar("T", bound="OneToOneNATMapping")


@_attrs_define
class OneToOneNATMapping:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        one_to_one_nat_mapping.additional_properties = d
        return one_to_one_nat_mapping
