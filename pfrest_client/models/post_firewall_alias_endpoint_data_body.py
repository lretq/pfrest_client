...
T = TypeVar("T", bound="PostFirewallAliasEndpointDataBody")


@_attrs_define
class PostFirewallAliasEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_alias_endpoint_data_body = cls(
            name=name,
            type_=type_,
            descr=descr,
            address=address,
        ...
        post_firewall_alias_endpoint_data_body.additional_properties = d
        return post_firewall_alias_endpoint_data_body
