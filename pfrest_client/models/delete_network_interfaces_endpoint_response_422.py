...
T = TypeVar("T", bound="DeleteNetworkInterfacesEndpointResponse422")


@_attrs_define
class DeleteNetworkInterfacesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_network_interfaces_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_network_interfaces_endpoint_response_422.additional_properties = d
        return delete_network_interfaces_endpoint_response_422
