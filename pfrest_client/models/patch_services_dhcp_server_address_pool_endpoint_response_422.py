...
T = TypeVar("T", bound="PatchServicesDHCPServerAddressPoolEndpointResponse422")


@_attrs_define
class PatchServicesDHCPServerAddressPoolEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_address_pool_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_services_dhcp_server_address_pool_endpoint_response_422.additional_properties = d
        return patch_services_dhcp_server_address_pool_endpoint_response_422
