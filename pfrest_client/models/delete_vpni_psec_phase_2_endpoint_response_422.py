...
T = TypeVar("T", bound="DeleteVPNIPsecPhase2EndpointResponse422")


@_attrs_define
class DeleteVPNIPsecPhase2EndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpni_psec_phase_2_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_vpni_psec_phase_2_endpoint_response_422.additional_properties = d
        return delete_vpni_psec_phase_2_endpoint_response_422
