...
T = TypeVar("T", bound="PutServicesFreeRADIUSUsersEndpointResponse405")


@_attrs_define
class PutServicesFreeRADIUSUsersEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_free_radius_users_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        put_services_free_radius_users_endpoint_response_405.additional_properties = d
        return put_services_free_radius_users_endpoint_response_405
