...
T = TypeVar("T", bound="PutServicesDNSForwarderHostOverridesEndpointJsonBodyItem")


@_attrs_define
class PutServicesDNSForwarderHostOverridesEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_dns_forwarder_host_overrides_endpoint_json_body_item = cls(
            host=host,
            domain=domain,
            ip=ip,
            descr=descr,
        ...
        put_services_dns_forwarder_host_overrides_endpoint_json_body_item.additional_properties = d
        return put_services_dns_forwarder_host_overrides_endpoint_json_body_item
