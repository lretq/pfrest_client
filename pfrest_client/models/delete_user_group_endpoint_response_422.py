...
T = TypeVar("T", bound="DeleteUserGroupEndpointResponse422")


@_attrs_define
class DeleteUserGroupEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_user_group_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_user_group_endpoint_response_422.additional_properties = d
        return delete_user_group_endpoint_response_422
