...
T = TypeVar("T", bound="PutFirewallTrafficShapersEndpointResponse405")


@_attrs_define
class PutFirewallTrafficShapersEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_traffic_shapers_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        put_firewall_traffic_shapers_endpoint_response_405.additional_properties = d
        return put_firewall_traffic_shapers_endpoint_response_405
