...
T = TypeVar("T", bound="PostFirewallRuleEndpointJsonBody")


@_attrs_define
class PostFirewallRuleEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_rule_endpoint_json_body = cls(
            type_=type_,
            interface=interface,
            ipprotocol=ipprotocol,
            source=source,
        ...
        post_firewall_rule_endpoint_json_body.additional_properties = d
        return post_firewall_rule_endpoint_json_body
