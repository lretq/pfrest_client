...
T = TypeVar("T", bound="GetInterfaceGREsEndpointResponse406")


@_attrs_define
class GetInterfaceGREsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_interface_gr_es_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_interface_gr_es_endpoint_response_406.additional_properties = d
        return get_interface_gr_es_endpoint_response_406
