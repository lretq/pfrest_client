...
T = TypeVar("T", bound="GetUserGroupsEndpointResponse405")


@_attrs_define
class GetUserGroupsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_groups_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_user_groups_endpoint_response_405.additional_properties = d
        return get_user_groups_endpoint_response_405
