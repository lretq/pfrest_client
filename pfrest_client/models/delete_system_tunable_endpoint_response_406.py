...
T = TypeVar("T", bound="DeleteSystemTunableEndpointResponse406")


@_attrs_define
class DeleteSystemTunableEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_system_tunable_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_system_tunable_endpoint_response_406.additional_properties = d
        return delete_system_tunable_endpoint_response_406
