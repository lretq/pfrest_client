...
T = TypeVar("T", bound="PutServicesNTPTimeServersEndpointResponse422")


@_attrs_define
class PutServicesNTPTimeServersEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_ntp_time_servers_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_services_ntp_time_servers_endpoint_response_422.additional_properties = d
        return put_services_ntp_time_servers_endpoint_response_422
