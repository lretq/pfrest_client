...
T = TypeVar("T", bound="PutServicesFreeRADIUSMACsEndpointResponse422")


@_attrs_define
class PutServicesFreeRADIUSMACsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_free_radiusma_cs_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_services_free_radiusma_cs_endpoint_response_422.additional_properties = d
        return put_services_free_radiusma_cs_endpoint_response_422
