...
T = TypeVar("T", bound="PostDiagnosticsRebootEndpointResponse422")


@_attrs_define
class PostDiagnosticsRebootEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_diagnostics_reboot_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_diagnostics_reboot_endpoint_response_422.additional_properties = d
        return post_diagnostics_reboot_endpoint_response_422
