...
T = TypeVar("T", bound="PutServicesACMECertificatesEndpointDataBodyItem")


@_attrs_define
class PutServicesACMECertificatesEndpointDataBodyItem:
    """
    Attributes:
        name (str): The name of the ACME certificate.<br>
        acmeaccount (str): The ACME account key to use for the ACME certificate.<br>
        keypaste (str): The custom private key to use for the ACME certificate.<br><br>This field is only available when
            the following conditions are met:<br>- `keylength` must be equal to `'custom'`<br>
        a_domainlist (list[ACMECertificateADomainlistItem]): The list of domain verifications  to include in the ACME
            certificate.<br>
    ...
    acmeaccount: str
    keypaste: str
    a_domainlist: list[ACMECertificateADomainlistItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        acmeaccount = d.pop("acmeaccount")

        keypaste = d.pop("keypaste")

        a_domainlist = []
        _a_domainlist = d.pop("a_domainlist")
        ...
        put_services_acme_certificates_endpoint_data_body_item = cls(
            name=name,
            acmeaccount=acmeaccount,
            keypaste=keypaste,
            a_domainlist=a_domainlist,
        ...
        put_services_acme_certificates_endpoint_data_body_item.additional_properties = d
        return put_services_acme_certificates_endpoint_data_body_item
