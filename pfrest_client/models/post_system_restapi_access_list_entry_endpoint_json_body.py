...
T = TypeVar("T", bound="PostSystemRESTAPIAccessListEntryEndpointJsonBody")


@_attrs_define
class PostSystemRESTAPIAccessListEntryEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_restapi_access_list_entry_endpoint_json_body = cls(
            network=network,
            type_=type_,
            weight=weight,
            users=users,
        ...
        post_system_restapi_access_list_entry_endpoint_json_body.additional_properties = d
        return post_system_restapi_access_list_entry_endpoint_json_body
