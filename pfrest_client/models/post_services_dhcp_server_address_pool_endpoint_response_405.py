...
T = TypeVar("T", bound="PostServicesDHCPServerAddressPoolEndpointResponse405")


@_attrs_define
class PostServicesDHCPServerAddressPoolEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_dhcp_server_address_pool_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_services_dhcp_server_address_pool_endpoint_response_405.additional_properties = d
        return post_services_dhcp_server_address_pool_endpoint_response_405
