...
T = TypeVar("T", bound="PatchInterfaceGREEndpointJsonBody")


@_attrs_define
class PatchInterfaceGREEndpointJsonBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        if_ (str | Unset): The pfSense interface interface serving as the local address to be used for the GRE
            tunnel.<br>
        ...
        remote_addr (str | Unset): The remote address to use for the GRE tunnel.<br>
        tunnel_local_addr (None | str | Unset): The local IPv4 address to use for the GRE tunnel.<br>
        tunnel_remote_addr (str | Unset): The remote IPv4 address to use for the GRE tunnel.<br><br>This field is only
            available when the following conditions are met:<br>- `tunnel_local_addr` must not be equal to `NULL`<br>
        ...
        tunnel_remote_addr6 (str | Unset): The remote IPv6 address to use for the GRE tunnel.<br><br>This field is only
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_gre_endpoint_json_body = cls(
            id=id,
            if_=if_,
            greif=greif,
            descr=descr,
        ...
        patch_interface_gre_endpoint_json_body.additional_properties = d
        return patch_interface_gre_endpoint_json_body
