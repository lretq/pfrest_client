...
T = TypeVar("T", bound="DNSResolverSettings")
...
class DNSResolverSettings:
    ...
    Attributes:
        ...
        sslcertref (str | Unset): The SSL/TLS certificate to use for the DNS Resolver service.<br><br>This field is only
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dns_resolver_settings.additional_properties = d
        return dns_resolver_settings
