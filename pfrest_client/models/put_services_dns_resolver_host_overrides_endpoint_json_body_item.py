...
T = TypeVar("T", bound="PutServicesDNSResolverHostOverridesEndpointJsonBodyItem")


@_attrs_define
class PutServicesDNSResolverHostOverridesEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_dns_resolver_host_overrides_endpoint_json_body_item = cls(
            host=host,
            domain=domain,
            ip=ip,
            descr=descr,
        ...
        put_services_dns_resolver_host_overrides_endpoint_json_body_item.additional_properties = d
        return put_services_dns_resolver_host_overrides_endpoint_json_body_item
