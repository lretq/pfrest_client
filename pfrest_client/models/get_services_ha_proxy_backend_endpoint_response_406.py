...
T = TypeVar("T", bound="GetServicesHAProxyBackendEndpointResponse406")


@_attrs_define
class GetServicesHAProxyBackendEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_ha_proxy_backend_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_services_ha_proxy_backend_endpoint_response_406.additional_properties = d
        return get_services_ha_proxy_backend_endpoint_response_406
