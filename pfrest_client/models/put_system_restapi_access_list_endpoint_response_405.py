...
T = TypeVar("T", bound="PutSystemRESTAPIAccessListEndpointResponse405")


@_attrs_define
class PutSystemRESTAPIAccessListEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_system_restapi_access_list_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        put_system_restapi_access_list_endpoint_response_405.additional_properties = d
        return put_system_restapi_access_list_endpoint_response_405
