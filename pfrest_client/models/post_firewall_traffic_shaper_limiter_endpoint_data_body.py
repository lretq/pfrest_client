...
T = TypeVar("T", bound="PostFirewallTrafficShaperLimiterEndpointDataBody")


@_attrs_define
class PostFirewallTrafficShaperLimiterEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_limiter_endpoint_data_body = cls(
            name=name,
            aqm=aqm,
            sched=sched,
            number=number,
        ...
        post_firewall_traffic_shaper_limiter_endpoint_data_body.additional_properties = d
        return post_firewall_traffic_shaper_limiter_endpoint_data_body
