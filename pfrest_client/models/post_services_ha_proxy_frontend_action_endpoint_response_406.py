...
T = TypeVar("T", bound="PostServicesHAProxyFrontendActionEndpointResponse406")


@_attrs_define
class PostServicesHAProxyFrontendActionEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_frontend_action_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_services_ha_proxy_frontend_action_endpoint_response_406.additional_properties = d
        return post_services_ha_proxy_frontend_action_endpoint_response_406
