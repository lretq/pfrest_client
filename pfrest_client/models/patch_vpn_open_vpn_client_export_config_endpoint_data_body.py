...
T = TypeVar("T", bound="PatchVPNOpenVPNClientExportConfigEndpointDataBody")


@_attrs_define
class PatchVPNOpenVPNClientExportConfigEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_open_vpn_client_export_config_endpoint_data_body = cls(
            id=id,
            server=server,
            useaddr=useaddr,
        ...
        patch_vpn_open_vpn_client_export_config_endpoint_data_body.additional_properties = d
        return patch_vpn_open_vpn_client_export_config_endpoint_data_body
