...
T = TypeVar("T", bound="GetRoutingGatewayEndpointResponse422")


@_attrs_define
class GetRoutingGatewayEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_routing_gateway_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_routing_gateway_endpoint_response_422.additional_properties = d
        return get_routing_gateway_endpoint_response_422
