...
T = TypeVar("T", bound="GetUsersEndpointResponse422")


@_attrs_define
class GetUsersEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_users_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_users_endpoint_response_422.additional_properties = d
        return get_users_endpoint_response_422
