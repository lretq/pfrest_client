...
T = TypeVar("T", bound="CertificateRevocationListCertItem")


@_attrs_define
class CertificateRevocationListCertItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        certificate_revocation_list_cert_item = cls(
            certref=certref,
            revoke_time=revoke_time,
            serial=serial,
            reason=reason,
        ...
        certificate_revocation_list_cert_item.additional_properties = d
        return certificate_revocation_list_cert_item
