...
T = TypeVar("T", bound="PatchServicesFreeRADIUSMACEndpointDataBody")


@_attrs_define
class PatchServicesFreeRADIUSMACEndpointDataBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        mac (str | Unset): The MAC address of the entry. May be delimited with '-' or ':' (e.g.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_free_radiusmac_endpoint_data_body = cls(
            id=id,
            mac=mac,
        ...
        patch_services_free_radiusmac_endpoint_data_body.additional_properties = d
        return patch_services_free_radiusmac_endpoint_data_body
