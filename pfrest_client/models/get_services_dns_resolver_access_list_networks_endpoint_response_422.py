...
T = TypeVar("T", bound="GetServicesDNSResolverAccessListNetworksEndpointResponse422")


@_attrs_define
class GetServicesDNSResolverAccessListNetworksEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_dns_resolver_access_list_networks_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_services_dns_resolver_access_list_networks_endpoint_response_422.additional_properties = d
        return get_services_dns_resolver_access_list_networks_endpoint_response_422
