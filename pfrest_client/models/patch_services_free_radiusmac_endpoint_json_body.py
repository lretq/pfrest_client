...
T = TypeVar("T", bound="PatchServicesFreeRADIUSMACEndpointJsonBody")


@_attrs_define
class PatchServicesFreeRADIUSMACEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_free_radiusmac_endpoint_json_body = cls(
            id=id,
            mac=mac,
        ...
        patch_services_free_radiusmac_endpoint_json_body.additional_properties = d
        return patch_services_free_radiusmac_endpoint_json_body
