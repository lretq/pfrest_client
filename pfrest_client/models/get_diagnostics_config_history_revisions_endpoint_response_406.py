...
T = TypeVar("T", bound="GetDiagnosticsConfigHistoryRevisionsEndpointResponse406")


@_attrs_define
class GetDiagnosticsConfigHistoryRevisionsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_diagnostics_config_history_revisions_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_diagnostics_config_history_revisions_endpoint_response_406.additional_properties = d
        return get_diagnostics_config_history_revisions_endpoint_response_406
