...
T = TypeVar("T", bound="DeleteInterfaceGREsEndpointResponse405")


@_attrs_define
class DeleteInterfaceGREsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_interface_gr_es_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_interface_gr_es_endpoint_response_405.additional_properties = d
        return delete_interface_gr_es_endpoint_response_405
