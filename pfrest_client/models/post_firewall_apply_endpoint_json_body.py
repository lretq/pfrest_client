...
T = TypeVar("T", bound="PostFirewallApplyEndpointJsonBody")


@_attrs_define
class PostFirewallApplyEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_apply_endpoint_json_body = cls(
            applied=applied,
            pending_subsystems=pending_subsystems,
        )

        post_firewall_apply_endpoint_json_body.additional_properties = d
        return post_firewall_apply_endpoint_json_body
