...
T = TypeVar("T", bound="PutInterfaceGroupsEndpointResponse406")


@_attrs_define
class PutInterfaceGroupsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_interface_groups_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        put_interface_groups_endpoint_response_406.additional_properties = d
        return put_interface_groups_endpoint_response_406
