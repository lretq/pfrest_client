...
T = TypeVar("T", bound="HAProxyFrontendAction")


@_attrs_define
class HAProxyFrontendAction:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_frontend_action.additional_properties = d
        return ha_proxy_frontend_action
