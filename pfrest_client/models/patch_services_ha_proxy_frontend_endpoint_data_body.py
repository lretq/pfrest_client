...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendEndpointDataBody")


@_attrs_define
class PatchServicesHAProxyFrontendEndpointDataBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        name (str | Unset): The unique name for this HAProxy frontend.<br>
        ...
        type_ (HAProxyFrontendType | Unset): The processing type for this frontend.<br>
    ...
    type_: HAProxyFrontendType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: HAProxyFrontendType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = HAProxyFrontendType(_type_)
        ...
        patch_services_ha_proxy_frontend_endpoint_data_body = cls(
            id=id,
            name=name,
            descr=descr,
            status=status,
        ...
        patch_services_ha_proxy_frontend_endpoint_data_body.additional_properties = d
        return patch_services_ha_proxy_frontend_endpoint_data_body
