...
T = TypeVar("T", bound="PatchFirewallNATOutboundMappingEndpointDataBody")


@_attrs_define
class PatchFirewallNATOutboundMappingEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_nat_outbound_mapping_endpoint_data_body = cls(
            id=id,
            interface=interface,
            protocol=protocol,
            disabled=disabled,
        ...
        patch_firewall_nat_outbound_mapping_endpoint_data_body.additional_properties = d
        return patch_firewall_nat_outbound_mapping_endpoint_data_body
