...
T = TypeVar("T", bound="PatchRoutingGatewayDefaultEndpointResponse422")


@_attrs_define
class PatchRoutingGatewayDefaultEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_routing_gateway_default_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_routing_gateway_default_endpoint_response_422.additional_properties = d
        return patch_routing_gateway_default_endpoint_response_422
