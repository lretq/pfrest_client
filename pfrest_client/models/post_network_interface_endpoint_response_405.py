...
T = TypeVar("T", bound="PostNetworkInterfaceEndpointResponse405")


@_attrs_define
class PostNetworkInterfaceEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_network_interface_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_network_interface_endpoint_response_405.additional_properties = d
        return post_network_interface_endpoint_response_405
