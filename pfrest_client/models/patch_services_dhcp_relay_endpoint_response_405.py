...
T = TypeVar("T", bound="PatchServicesDHCPRelayEndpointResponse405")


@_attrs_define
class PatchServicesDHCPRelayEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_relay_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_services_dhcp_relay_endpoint_response_405.additional_properties = d
        return patch_services_dhcp_relay_endpoint_response_405
