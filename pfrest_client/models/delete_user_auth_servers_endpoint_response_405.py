...
T = TypeVar("T", bound="DeleteUserAuthServersEndpointResponse405")


@_attrs_define
class DeleteUserAuthServersEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_user_auth_servers_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_user_auth_servers_endpoint_response_405.additional_properties = d
        return delete_user_auth_servers_endpoint_response_405
