...
T = TypeVar("T", bound="DeleteUserAuthServerEndpointResponse406")


@_attrs_define
class DeleteUserAuthServerEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_user_auth_server_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_user_auth_server_endpoint_response_406.additional_properties = d
        return delete_user_auth_server_endpoint_response_406
