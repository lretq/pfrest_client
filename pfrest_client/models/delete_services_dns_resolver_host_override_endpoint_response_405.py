...
T = TypeVar("T", bound="DeleteServicesDNSResolverHostOverrideEndpointResponse405")


@_attrs_define
class DeleteServicesDNSResolverHostOverrideEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_dns_resolver_host_override_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_services_dns_resolver_host_override_endpoint_response_405.additional_properties = d
        return delete_services_dns_resolver_host_override_endpoint_response_405
