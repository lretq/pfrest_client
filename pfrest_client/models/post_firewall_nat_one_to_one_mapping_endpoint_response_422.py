...
T = TypeVar("T", bound="PostFirewallNATOneToOneMappingEndpointResponse422")


@_attrs_define
class PostFirewallNATOneToOneMappingEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_nat_one_to_one_mapping_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_firewall_nat_one_to_one_mapping_endpoint_response_422.additional_properties = d
        return post_firewall_nat_one_to_one_mapping_endpoint_response_422
