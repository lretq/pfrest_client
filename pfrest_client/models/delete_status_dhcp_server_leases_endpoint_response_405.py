...
T = TypeVar("T", bound="DeleteStatusDHCPServerLeasesEndpointResponse405")


@_attrs_define
class DeleteStatusDHCPServerLeasesEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_status_dhcp_server_leases_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_status_dhcp_server_leases_endpoint_response_405.additional_properties = d
        return delete_status_dhcp_server_leases_endpoint_response_405
