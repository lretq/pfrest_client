...
T = TypeVar("T", bound="GetServicesDNSForwarderHostOverrideAliasesEndpointResponse422")


@_attrs_define
class GetServicesDNSForwarderHostOverrideAliasesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_dns_forwarder_host_override_aliases_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_services_dns_forwarder_host_override_aliases_endpoint_response_422.additional_properties = d
        return get_services_dns_forwarder_host_override_aliases_endpoint_response_422
