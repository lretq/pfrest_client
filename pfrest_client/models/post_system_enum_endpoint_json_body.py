...
T = TypeVar("T", bound="PostSystemEnumEndpointJsonBody")


@_attrs_define
class PostSystemEnumEndpointJsonBody:
    """
    Attributes:
        model_name (str): The name of the model whose field's choices are being requested.<br>
        model_field (str): The name of the field whose choices are being requested.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_enum_endpoint_json_body = cls(
            model_name=model_name,
            model_field=model_field,
            choices=choices,
        )

        post_system_enum_endpoint_json_body.additional_properties = d
        return post_system_enum_endpoint_json_body
