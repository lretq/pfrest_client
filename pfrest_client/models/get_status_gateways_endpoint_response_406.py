...
T = TypeVar("T", bound="GetStatusGatewaysEndpointResponse406")


@_attrs_define
class GetStatusGatewaysEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_status_gateways_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_status_gateways_endpoint_response_406.additional_properties = d
        return get_status_gateways_endpoint_response_406
