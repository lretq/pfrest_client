...
T = TypeVar("T", bound="PostInterfaceVLANEndpointDataBody")


@_attrs_define
class PostInterfaceVLANEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_interface_vlan_endpoint_data_body = cls(
            if_=if_,
            tag=tag,
            vlanif=vlanif,
            pcp=pcp,
        ...
        post_interface_vlan_endpoint_data_body.additional_properties = d
        return post_interface_vlan_endpoint_data_body
