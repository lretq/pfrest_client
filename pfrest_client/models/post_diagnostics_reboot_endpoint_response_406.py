...
T = TypeVar("T", bound="PostDiagnosticsRebootEndpointResponse406")


@_attrs_define
class PostDiagnosticsRebootEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_diagnostics_reboot_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_diagnostics_reboot_endpoint_response_406.additional_properties = d
        return post_diagnostics_reboot_endpoint_response_406
