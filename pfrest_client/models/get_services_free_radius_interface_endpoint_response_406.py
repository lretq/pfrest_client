...
T = TypeVar("T", bound="GetServicesFreeRADIUSInterfaceEndpointResponse406")


@_attrs_define
class GetServicesFreeRADIUSInterfaceEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_free_radius_interface_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_services_free_radius_interface_endpoint_response_406.additional_properties = d
        return get_services_free_radius_interface_endpoint_response_406
