...
T = TypeVar("T", bound="PatchInterfaceBridgeEndpointDataBody")


@_attrs_define
class PatchInterfaceBridgeEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_bridge_endpoint_data_body = cls(
            id=id,
            members=members,
            descr=descr,
            bridgeif=bridgeif,
        ...
        patch_interface_bridge_endpoint_data_body.additional_properties = d
        return patch_interface_bridge_endpoint_data_body
