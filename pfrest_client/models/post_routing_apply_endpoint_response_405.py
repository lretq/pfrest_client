...
T = TypeVar("T", bound="PostRoutingApplyEndpointResponse405")


@_attrs_define
class PostRoutingApplyEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routing_apply_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_routing_apply_endpoint_response_405.additional_properties = d
        return post_routing_apply_endpoint_response_405
