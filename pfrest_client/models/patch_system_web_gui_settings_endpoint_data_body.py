...
T = TypeVar("T", bound="PatchSystemWebGUISettingsEndpointDataBody")


@_attrs_define
class PatchSystemWebGUISettingsEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_web_gui_settings_endpoint_data_body = cls(
            sslcertref=sslcertref,
            protocol=protocol,
            port=port,
        )

        patch_system_web_gui_settings_endpoint_data_body.additional_properties = d
        return patch_system_web_gui_settings_endpoint_data_body
