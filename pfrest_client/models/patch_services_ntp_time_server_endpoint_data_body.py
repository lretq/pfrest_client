...
T = TypeVar("T", bound="PatchServicesNTPTimeServerEndpointDataBody")


@_attrs_define
class PatchServicesNTPTimeServerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ntp_time_server_endpoint_data_body = cls(
            id=id,
        ...
        patch_services_ntp_time_server_endpoint_data_body.additional_properties = d
        return patch_services_ntp_time_server_endpoint_data_body
