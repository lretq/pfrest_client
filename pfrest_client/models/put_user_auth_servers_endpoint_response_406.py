...
T = TypeVar("T", bound="PutUserAuthServersEndpointResponse406")


@_attrs_define
class PutUserAuthServersEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_user_auth_servers_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        put_user_auth_servers_endpoint_response_406.additional_properties = d
        return put_user_auth_servers_endpoint_response_406
