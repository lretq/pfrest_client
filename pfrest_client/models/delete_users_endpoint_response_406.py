...
T = TypeVar("T", bound="DeleteUsersEndpointResponse406")


@_attrs_define
class DeleteUsersEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_users_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_users_endpoint_response_406.additional_properties = d
        return delete_users_endpoint_response_406
