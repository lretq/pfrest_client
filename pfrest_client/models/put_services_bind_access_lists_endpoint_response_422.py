...
T = TypeVar("T", bound="PutServicesBINDAccessListsEndpointResponse422")


@_attrs_define
class PutServicesBINDAccessListsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_bind_access_lists_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_services_bind_access_lists_endpoint_response_422.additional_properties = d
        return put_services_bind_access_lists_endpoint_response_422
