...
T = TypeVar("T", bound="DeleteRoutingStaticRoutesEndpointResponse422")


@_attrs_define
class DeleteRoutingStaticRoutesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_routing_static_routes_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_routing_static_routes_endpoint_response_422.additional_properties = d
        return delete_routing_static_routes_endpoint_response_422
