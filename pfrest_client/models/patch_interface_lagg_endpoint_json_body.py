...
T = TypeVar("T", bound="PatchInterfaceLAGGEndpointJsonBody")


@_attrs_define
class PatchInterfaceLAGGEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_lagg_endpoint_json_body = cls(
            id=id,
            laggif=laggif,
            descr=descr,
            members=members,
        ...
        patch_interface_lagg_endpoint_json_body.additional_properties = d
        return patch_interface_lagg_endpoint_json_body
