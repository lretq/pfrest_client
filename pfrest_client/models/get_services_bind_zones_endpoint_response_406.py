...
T = TypeVar("T", bound="GetServicesBINDZonesEndpointResponse406")


@_attrs_define
class GetServicesBINDZonesEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_bind_zones_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_services_bind_zones_endpoint_response_406.additional_properties = d
        return get_services_bind_zones_endpoint_response_406
