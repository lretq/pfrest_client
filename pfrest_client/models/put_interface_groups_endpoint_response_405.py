...
T = TypeVar("T", bound="PutInterfaceGroupsEndpointResponse405")


@_attrs_define
class PutInterfaceGroupsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_interface_groups_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        put_interface_groups_endpoint_response_405.additional_properties = d
        return put_interface_groups_endpoint_response_405
