...
T = TypeVar("T", bound="PutFirewallNATOutboundMappingsEndpointJsonBodyItem")


@_attrs_define
class PutFirewallNATOutboundMappingsEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_nat_outbound_mappings_endpoint_json_body_item = cls(
            interface=interface,
            source=source,
            destination=destination,
            target=target,
        ...
        put_firewall_nat_outbound_mappings_endpoint_json_body_item.additional_properties = d
        return put_firewall_nat_outbound_mappings_endpoint_json_body_item
