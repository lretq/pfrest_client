...
T = TypeVar("T", bound="GetSystemCertificateAuthorityEndpointResponse405")


@_attrs_define
class GetSystemCertificateAuthorityEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_certificate_authority_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_system_certificate_authority_endpoint_response_405.additional_properties = d
        return get_system_certificate_authority_endpoint_response_405
