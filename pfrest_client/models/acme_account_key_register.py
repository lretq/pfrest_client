...
T = TypeVar("T", bound="ACMEAccountKeyRegister")


@_attrs_define
class ACMEAccountKeyRegister:
    """
    Attributes:
        name (str | Unset): The name of the ACME account key to register.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        acme_account_key_register = cls(
            name=name,
            status=status,
        )

        acme_account_key_register.additional_properties = d
        return acme_account_key_register
