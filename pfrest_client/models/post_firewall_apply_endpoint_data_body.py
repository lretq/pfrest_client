...
T = TypeVar("T", bound="PostFirewallApplyEndpointDataBody")


@_attrs_define
class PostFirewallApplyEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_apply_endpoint_data_body = cls(
            applied=applied,
            pending_subsystems=pending_subsystems,
        )

        post_firewall_apply_endpoint_data_body.additional_properties = d
        return post_firewall_apply_endpoint_data_body
