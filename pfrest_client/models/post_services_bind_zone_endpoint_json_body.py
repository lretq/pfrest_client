...
T = TypeVar("T", bound="PostServicesBINDZoneEndpointJsonBody")


@_attrs_define
class PostServicesBINDZoneEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_bind_zone_endpoint_json_body = cls(
            name=name,
            forwarders=forwarders,
            baseip=baseip,
            nameserver=nameserver,
        ...
        post_services_bind_zone_endpoint_json_body.additional_properties = d
        return post_services_bind_zone_endpoint_json_body
