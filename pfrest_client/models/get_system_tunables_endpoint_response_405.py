...
T = TypeVar("T", bound="GetSystemTunablesEndpointResponse405")


@_attrs_define
class GetSystemTunablesEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_tunables_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_system_tunables_endpoint_response_405.additional_properties = d
        return get_system_tunables_endpoint_response_405
