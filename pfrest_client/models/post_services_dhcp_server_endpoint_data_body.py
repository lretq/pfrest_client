...
T = TypeVar("T", bound="PostServicesDHCPServerEndpointDataBody")


@_attrs_define
class PostServicesDHCPServerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_dhcp_server_endpoint_data_body = cls(
            interface=interface,
            enable=enable,
        ...
        post_services_dhcp_server_endpoint_data_body.additional_properties = d
        return post_services_dhcp_server_endpoint_data_body
