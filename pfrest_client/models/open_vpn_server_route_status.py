...
T = TypeVar("T", bound="OpenVPNServerRouteStatus")


@_attrs_define
class OpenVPNServerRouteStatus:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_vpn_server_route_status = cls(
        ...
        open_vpn_server_route_status.additional_properties = d
        return open_vpn_server_route_status
