...
T = TypeVar("T", bound="PostVPNOpenVPNClientExportConfigEndpointJsonBody")


@_attrs_define
class PostVPNOpenVPNClientExportConfigEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_open_vpn_client_export_config_endpoint_json_body = cls(
            server=server,
            pkcs11providers=pkcs11providers,
            pkcs11id=pkcs11id,
            pass_=pass_,
        ...
        post_vpn_open_vpn_client_export_config_endpoint_json_body.additional_properties = d
        return post_vpn_open_vpn_client_export_config_endpoint_json_body
