...
T = TypeVar("T", bound="PostVPNIPsecPhase1EndpointJsonBody")


@_attrs_define
class PostVPNIPsecPhase1EndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpni_psec_phase_1_endpoint_json_body = cls(
            iketype=iketype,
            mode=mode,
            protocol=protocol,
            interface=interface,
        ...
        post_vpni_psec_phase_1_endpoint_json_body.additional_properties = d
        return post_vpni_psec_phase_1_endpoint_json_body
