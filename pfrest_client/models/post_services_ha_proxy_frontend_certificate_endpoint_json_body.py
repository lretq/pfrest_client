...
T = TypeVar("T", bound="PostServicesHAProxyFrontendCertificateEndpointJsonBody")


@_attrs_define
class PostServicesHAProxyFrontendCertificateEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_frontend_certificate_endpoint_json_body = cls(
            parent_id=parent_id,
            ssl_certificate=ssl_certificate,
        )

        post_services_ha_proxy_frontend_certificate_endpoint_json_body.additional_properties = d
        return post_services_ha_proxy_frontend_certificate_endpoint_json_body
