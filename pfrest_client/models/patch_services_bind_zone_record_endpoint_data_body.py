...
T = TypeVar("T", bound="PatchServicesBINDZoneRecordEndpointDataBody")


@_attrs_define
class PatchServicesBINDZoneRecordEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_bind_zone_record_endpoint_data_body = cls(
            parent_id=parent_id,
            id=id,
            name=name,
            type_=type_,
        ...
        patch_services_bind_zone_record_endpoint_data_body.additional_properties = d
        return patch_services_bind_zone_record_endpoint_data_body
