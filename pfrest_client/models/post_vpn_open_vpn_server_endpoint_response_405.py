...
T = TypeVar("T", bound="PostVPNOpenVPNServerEndpointResponse405")


@_attrs_define
class PostVPNOpenVPNServerEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_open_vpn_server_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_vpn_open_vpn_server_endpoint_response_405.additional_properties = d
        return post_vpn_open_vpn_server_endpoint_response_405
