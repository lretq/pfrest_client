...
T = TypeVar("T", bound="PostInterfaceLAGGEndpointDataBody")


@_attrs_define
class PostInterfaceLAGGEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_interface_lagg_endpoint_data_body = cls(
            members=members,
            proto=proto,
            laggif=laggif,
            descr=descr,
        ...
        post_interface_lagg_endpoint_data_body.additional_properties = d
        return post_interface_lagg_endpoint_data_body
