...
T = TypeVar("T", bound="PatchFirewallTrafficShaperQueueEndpointDataBody")


@_attrs_define
class PatchFirewallTrafficShaperQueueEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_traffic_shaper_queue_endpoint_data_body = cls(
            parent_id=parent_id,
            id=id,
            interface=interface,
            enabled=enabled,
        ...
        patch_firewall_traffic_shaper_queue_endpoint_data_body.additional_properties = d
        return patch_firewall_traffic_shaper_queue_endpoint_data_body
