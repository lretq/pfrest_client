...
T = TypeVar("T", bound="PostSystemCertificateRenewEndpointResponse405")


@_attrs_define
class PostSystemCertificateRenewEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_certificate_renew_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_system_certificate_renew_endpoint_response_405.additional_properties = d
        return post_system_certificate_renew_endpoint_response_405
