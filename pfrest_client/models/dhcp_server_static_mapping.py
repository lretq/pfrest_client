...
T = TypeVar("T", bound="DHCPServerStaticMapping")


@_attrs_define
class DHCPServerStaticMapping:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dhcp_server_static_mapping = cls(
            mac=mac,
            ipaddr=ipaddr,
            cid=cid,
            hostname=hostname,
        ...
        dhcp_server_static_mapping.additional_properties = d
        return dhcp_server_static_mapping
