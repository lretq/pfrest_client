...
T = TypeVar("T", bound="CertificateRevocationListRevokedCertificate")


@_attrs_define
class CertificateRevocationListRevokedCertificate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        certificate_revocation_list_revoked_certificate = cls(
            certref=certref,
            serial=serial,
            reason=reason,
        ...
        certificate_revocation_list_revoked_certificate.additional_properties = d
        return certificate_revocation_list_revoked_certificate
