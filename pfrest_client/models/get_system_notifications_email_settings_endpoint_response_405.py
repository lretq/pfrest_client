...
T = TypeVar("T", bound="GetSystemNotificationsEmailSettingsEndpointResponse405")


@_attrs_define
class GetSystemNotificationsEmailSettingsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_notifications_email_settings_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_system_notifications_email_settings_endpoint_response_405.additional_properties = d
        return get_system_notifications_email_settings_endpoint_response_405
