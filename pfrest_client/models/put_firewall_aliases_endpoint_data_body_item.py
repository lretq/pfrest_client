...
T = TypeVar("T", bound="PutFirewallAliasesEndpointDataBodyItem")


@_attrs_define
class PutFirewallAliasesEndpointDataBodyItem:
    """
    Attributes:
        name (str): Sets the name for the alias. This name must be unique from all other aliases.<br>
        type_ (FirewallAliasType): Sets the type of alias this object will be. This directly impacts what values can be
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = FirewallAliasType(d.pop("type"))
        ...
        put_firewall_aliases_endpoint_data_body_item = cls(
            name=name,
            type_=type_,
            descr=descr,
            address=address,
        ...
        put_firewall_aliases_endpoint_data_body_item.additional_properties = d
        return put_firewall_aliases_endpoint_data_body_item
