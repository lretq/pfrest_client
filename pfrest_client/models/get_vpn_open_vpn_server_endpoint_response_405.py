...
T = TypeVar("T", bound="GetVPNOpenVPNServerEndpointResponse405")


@_attrs_define
class GetVPNOpenVPNServerEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpn_open_vpn_server_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_vpn_open_vpn_server_endpoint_response_405.additional_properties = d
        return get_vpn_open_vpn_server_endpoint_response_405
