...
T = TypeVar("T", bound="DeleteVPNOpenVPNClientExportConfigEndpointResponse406")


@_attrs_define
class DeleteVPNOpenVPNClientExportConfigEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpn_open_vpn_client_export_config_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_vpn_open_vpn_client_export_config_endpoint_response_406.additional_properties = d
        return delete_vpn_open_vpn_client_export_config_endpoint_response_406
