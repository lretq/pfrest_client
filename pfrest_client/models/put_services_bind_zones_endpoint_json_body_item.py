...
T = TypeVar("T", bound="PutServicesBINDZonesEndpointJsonBodyItem")


@_attrs_define
class PutServicesBINDZonesEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_bind_zones_endpoint_json_body_item = cls(
            name=name,
            forwarders=forwarders,
            baseip=baseip,
            nameserver=nameserver,
        ...
        put_services_bind_zones_endpoint_json_body_item.additional_properties = d
        return put_services_bind_zones_endpoint_json_body_item
