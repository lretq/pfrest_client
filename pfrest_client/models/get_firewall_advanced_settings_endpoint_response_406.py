...
T = TypeVar("T", bound="GetFirewallAdvancedSettingsEndpointResponse406")


@_attrs_define
class GetFirewallAdvancedSettingsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_advanced_settings_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_firewall_advanced_settings_endpoint_response_406.additional_properties = d
        return get_firewall_advanced_settings_endpoint_response_406
