...
T = TypeVar("T", bound="PostServicesHAProxyFrontendAddressEndpointDataBody")


@_attrs_define
class PostServicesHAProxyFrontendAddressEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_frontend_address_endpoint_data_body = cls(
            extaddr=extaddr,
            extaddr_custom=extaddr_custom,
            parent_id=parent_id,
        ...
        post_services_ha_proxy_frontend_address_endpoint_data_body.additional_properties = d
        return post_services_ha_proxy_frontend_address_endpoint_data_body
