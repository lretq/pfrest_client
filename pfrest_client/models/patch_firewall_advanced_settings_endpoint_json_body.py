...
T = TypeVar("T", bound="PatchFirewallAdvancedSettingsEndpointJsonBody")


@_attrs_define
class PatchFirewallAdvancedSettingsEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_advanced_settings_endpoint_json_body = cls(
            aliasesresolveinterval=aliasesresolveinterval,
            checkaliasesurlcert=checkaliasesurlcert,
        )

        patch_firewall_advanced_settings_endpoint_json_body.additional_properties = d
        return patch_firewall_advanced_settings_endpoint_json_body
