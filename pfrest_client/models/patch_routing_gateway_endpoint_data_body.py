...
T = TypeVar("T", bound="PatchRoutingGatewayEndpointDataBody")


@_attrs_define
class PatchRoutingGatewayEndpointDataBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        name (str | Unset): Sets a name for the gateway.<br>
        descr (str | Unset): Sets a descriptions for the gateway.<br>
        disabled (bool | Unset): Disable this gateway.<br>
        ipprotocol (RoutingGatewayIpprotocol | Unset): Sets the Internet Protocol version this gateway uses.<br>
        interface (str | Unset): Sets the interface this gateway will apply to.<br>
        gateway (str | Unset): Sets the IP address of the remote gateway.<br>
    ...
    ipprotocol: RoutingGatewayIpprotocol | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ipprotocol: RoutingGatewayIpprotocol | Unset
        if isinstance(_ipprotocol, Unset):
            ipprotocol = UNSET
        else:
            ipprotocol = RoutingGatewayIpprotocol(_ipprotocol)
        ...
        patch_routing_gateway_endpoint_data_body = cls(
            id=id,
            name=name,
            descr=descr,
            disabled=disabled,
        ...
        patch_routing_gateway_endpoint_data_body.additional_properties = d
        return patch_routing_gateway_endpoint_data_body
