...
class DHCPRelay:
    ...
    Attributes:
        ...
        server (list[str] | Unset): The IPv4 addresses of the DHCP server to relay requests to.<br>
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        server = cast(list[str], d.pop("server", UNSET))
        ...
        dhcp_relay.additional_properties = d
        return dhcp_relay
