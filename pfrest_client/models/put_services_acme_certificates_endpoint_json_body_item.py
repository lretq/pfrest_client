...
T = TypeVar("T", bound="PutServicesACMECertificatesEndpointJsonBodyItem")


@_attrs_define
class PutServicesACMECertificatesEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_acme_certificates_endpoint_json_body_item = cls(
            name=name,
            acmeaccount=acmeaccount,
            keypaste=keypaste,
            a_domainlist=a_domainlist,
        ...
        put_services_acme_certificates_endpoint_json_body_item.additional_properties = d
        return put_services_acme_certificates_endpoint_json_body_item
