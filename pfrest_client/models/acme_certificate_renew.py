...
T = TypeVar("T", bound="ACMECertificateRenew")


@_attrs_define
class ACMECertificateRenew:
    """
    Attributes:
        certificate (str | Unset): The name of the ACME certificate to be renewed.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        acme_certificate_renew.additional_properties = d
        return acme_certificate_renew
