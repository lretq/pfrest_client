...
T = TypeVar("T", bound="GetRoutingGatewayGroupPriorityEndpointResponse406")


@_attrs_define
class GetRoutingGatewayGroupPriorityEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_routing_gateway_group_priority_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_routing_gateway_group_priority_endpoint_response_406.additional_properties = d
        return get_routing_gateway_group_priority_endpoint_response_406
