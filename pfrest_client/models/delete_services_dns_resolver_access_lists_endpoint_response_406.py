...
T = TypeVar("T", bound="DeleteServicesDNSResolverAccessListsEndpointResponse406")


@_attrs_define
class DeleteServicesDNSResolverAccessListsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_dns_resolver_access_lists_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_services_dns_resolver_access_lists_endpoint_response_406.additional_properties = d
        return delete_services_dns_resolver_access_lists_endpoint_response_406
