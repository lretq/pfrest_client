...
T = TypeVar("T", bound="DeleteServicesBINDSyncRemoteHostsEndpointResponse406")


@_attrs_define
class DeleteServicesBINDSyncRemoteHostsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_bind_sync_remote_hosts_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_services_bind_sync_remote_hosts_endpoint_response_406.additional_properties = d
        return delete_services_bind_sync_remote_hosts_endpoint_response_406
