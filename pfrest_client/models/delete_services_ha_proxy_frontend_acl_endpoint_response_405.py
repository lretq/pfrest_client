...
T = TypeVar("T", bound="DeleteServicesHAProxyFrontendACLEndpointResponse405")


@_attrs_define
class DeleteServicesHAProxyFrontendACLEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_ha_proxy_frontend_acl_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_services_ha_proxy_frontend_acl_endpoint_response_405.additional_properties = d
        return delete_services_ha_proxy_frontend_acl_endpoint_response_405
