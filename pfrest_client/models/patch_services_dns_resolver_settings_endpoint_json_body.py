...
T = TypeVar("T", bound="PatchServicesDNSResolverSettingsEndpointJsonBody")


@_attrs_define
class PatchServicesDNSResolverSettingsEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dns_resolver_settings_endpoint_json_body = cls(
            sslcertref=sslcertref,
            enable=enable,
            port=port,
            enablessl=enablessl,
        ...
        patch_services_dns_resolver_settings_endpoint_json_body.additional_properties = d
        return patch_services_dns_resolver_settings_endpoint_json_body
