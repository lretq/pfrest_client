...
T = TypeVar("T", bound="PostRoutingGatewayGroupPriorityEndpointResponse422")


@_attrs_define
class PostRoutingGatewayGroupPriorityEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routing_gateway_group_priority_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_routing_gateway_group_priority_endpoint_response_422.additional_properties = d
        return post_routing_gateway_group_priority_endpoint_response_422
