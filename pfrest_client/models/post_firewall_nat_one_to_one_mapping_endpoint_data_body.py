...
T = TypeVar("T", bound="PostFirewallNATOneToOneMappingEndpointDataBody")


@_attrs_define
class PostFirewallNATOneToOneMappingEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_nat_one_to_one_mapping_endpoint_data_body = cls(
            interface=interface,
            external=external,
            source=source,
            destination=destination,
        ...
        post_firewall_nat_one_to_one_mapping_endpoint_data_body.additional_properties = d
        return post_firewall_nat_one_to_one_mapping_endpoint_data_body
