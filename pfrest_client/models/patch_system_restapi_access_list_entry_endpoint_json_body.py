...
T = TypeVar("T", bound="PatchSystemRESTAPIAccessListEntryEndpointJsonBody")


@_attrs_define
class PatchSystemRESTAPIAccessListEntryEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_restapi_access_list_entry_endpoint_json_body = cls(
            id=id,
            type_=type_,
            weight=weight,
            network=network,
        ...
        patch_system_restapi_access_list_entry_endpoint_json_body.additional_properties = d
        return patch_system_restapi_access_list_entry_endpoint_json_body
