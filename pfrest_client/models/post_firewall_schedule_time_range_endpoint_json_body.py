...
T = TypeVar("T", bound="PostFirewallScheduleTimeRangeEndpointJsonBody")


@_attrs_define
class PostFirewallScheduleTimeRangeEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_schedule_time_range_endpoint_json_body = cls(
            month=month,
            day=day,
            hour=hour,
            parent_id=parent_id,
        ...
        post_firewall_schedule_time_range_endpoint_json_body.additional_properties = d
        return post_firewall_schedule_time_range_endpoint_json_body
