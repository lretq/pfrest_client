...
T = TypeVar("T", bound="PostServicesBINDViewEndpointResponse405")


@_attrs_define
class PostServicesBINDViewEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_bind_view_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_services_bind_view_endpoint_response_405.additional_properties = d
        return post_services_bind_view_endpoint_response_405
