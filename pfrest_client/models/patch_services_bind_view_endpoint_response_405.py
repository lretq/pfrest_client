...
T = TypeVar("T", bound="PatchServicesBINDViewEndpointResponse405")


@_attrs_define
class PatchServicesBINDViewEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_bind_view_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_services_bind_view_endpoint_response_405.additional_properties = d
        return patch_services_bind_view_endpoint_response_405
