...
T = TypeVar("T", bound="DeleteServicesDNSResolverHostOverridesEndpointResponse405")


@_attrs_define
class DeleteServicesDNSResolverHostOverridesEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_dns_resolver_host_overrides_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_services_dns_resolver_host_overrides_endpoint_response_405.additional_properties = d
        return delete_services_dns_resolver_host_overrides_endpoint_response_405
