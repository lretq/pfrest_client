...
T = TypeVar("T", bound="PutVPNIPsecPhase1SEndpointDataBodyItem")


@_attrs_define
class PutVPNIPsecPhase1SEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_vpni_psec_phase_1s_endpoint_data_body_item = cls(
            iketype=iketype,
            mode=mode,
            protocol=protocol,
            interface=interface,
        ...
        put_vpni_psec_phase_1s_endpoint_data_body_item.additional_properties = d
        return put_vpni_psec_phase_1s_endpoint_data_body_item
