...
T = TypeVar("T", bound="PatchInterfaceBridgeEndpointJsonBody")


@_attrs_define
class PatchInterfaceBridgeEndpointJsonBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        members (list[str] | Unset): The member interfaces to include in this bridge.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_bridge_endpoint_json_body = cls(
            id=id,
            members=members,
            descr=descr,
            bridgeif=bridgeif,
        ...
        patch_interface_bridge_endpoint_json_body.additional_properties = d
        return patch_interface_bridge_endpoint_json_body
