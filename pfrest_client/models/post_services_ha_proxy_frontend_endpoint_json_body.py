...
T = TypeVar("T", bound="PostServicesHAProxyFrontendEndpointJsonBody")


@_attrs_define
class PostServicesHAProxyFrontendEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_frontend_endpoint_json_body = cls(
            name=name,
            type_=type_,
            descr=descr,
            status=status,
        ...
        post_services_ha_proxy_frontend_endpoint_json_body.additional_properties = d
        return post_services_ha_proxy_frontend_endpoint_json_body
