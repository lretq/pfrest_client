...
T = TypeVar("T", bound="PostVPNIPsecPhase1EncryptionEndpointDataBody")


@_attrs_define
class PostVPNIPsecPhase1EncryptionEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpni_psec_phase_1_encryption_endpoint_data_body = cls(
            encryption_algorithm_name=encryption_algorithm_name,
            encryption_algorithm_keylen=encryption_algorithm_keylen,
            hash_algorithm=hash_algorithm,
            dhgroup=dhgroup,
        ...
        post_vpni_psec_phase_1_encryption_endpoint_data_body.additional_properties = d
        return post_vpni_psec_phase_1_encryption_endpoint_data_body
