...
T = TypeVar("T", bound="PostVPNWireGuardPeerAllowedIPEndpointResponse405")


@_attrs_define
class PostVPNWireGuardPeerAllowedIPEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_wire_guard_peer_allowed_ip_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_vpn_wire_guard_peer_allowed_ip_endpoint_response_405.additional_properties = d
        return post_vpn_wire_guard_peer_allowed_ip_endpoint_response_405
