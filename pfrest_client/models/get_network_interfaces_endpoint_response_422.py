...
T = TypeVar("T", bound="GetNetworkInterfacesEndpointResponse422")


@_attrs_define
class GetNetworkInterfacesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_network_interfaces_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_network_interfaces_endpoint_response_422.additional_properties = d
        return get_network_interfaces_endpoint_response_422
