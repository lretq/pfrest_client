...
T = TypeVar("T", bound="PatchNetworkInterfaceEndpointResponse406")


@_attrs_define
class PatchNetworkInterfaceEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_network_interface_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_network_interface_endpoint_response_406.additional_properties = d
        return patch_network_interface_endpoint_response_406
