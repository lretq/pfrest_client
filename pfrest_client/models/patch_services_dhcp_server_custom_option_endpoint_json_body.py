...
T = TypeVar("T", bound="PatchServicesDHCPServerCustomOptionEndpointJsonBody")


@_attrs_define
class PatchServicesDHCPServerCustomOptionEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_custom_option_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            number=number,
            type_=type_,
        ...
        patch_services_dhcp_server_custom_option_endpoint_json_body.additional_properties = d
        return patch_services_dhcp_server_custom_option_endpoint_json_body
