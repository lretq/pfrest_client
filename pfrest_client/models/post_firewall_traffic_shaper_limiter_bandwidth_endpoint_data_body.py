...
T = TypeVar("T", bound="PostFirewallTrafficShaperLimiterBandwidthEndpointDataBody")


@_attrs_define
class PostFirewallTrafficShaperLimiterBandwidthEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_limiter_bandwidth_endpoint_data_body = cls(
            bw=bw,
            bwscale=bwscale,
            parent_id=parent_id,
            bwsched=bwsched,
        ...
        post_firewall_traffic_shaper_limiter_bandwidth_endpoint_data_body.additional_properties = d
        return post_firewall_traffic_shaper_limiter_bandwidth_endpoint_data_body
