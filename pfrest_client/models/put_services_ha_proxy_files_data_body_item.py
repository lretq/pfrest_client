...
T = TypeVar("T", bound="PutServicesHAProxyFilesDataBodyItem")


@_attrs_define
class PutServicesHAProxyFilesDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_ha_proxy_files_data_body_item = cls(
            name=name,
            content=content,
            type_=type_,
        )

        put_services_ha_proxy_files_data_body_item.additional_properties = d
        return put_services_ha_proxy_files_data_body_item
