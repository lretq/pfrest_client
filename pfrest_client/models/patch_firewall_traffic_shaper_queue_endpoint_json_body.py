...
T = TypeVar("T", bound="PatchFirewallTrafficShaperQueueEndpointJsonBody")


@_attrs_define
class PatchFirewallTrafficShaperQueueEndpointJsonBody:
    """
    Attributes:
        ...
        name (str | Unset): The name to assign this traffic shaper queue.<br>
        priority (int | Unset): The priority level for this traffic shaper queue.<br><br>This field is only available
            ...
            Default: 1.
        qlimit (int | Unset): The number of packets that can be held in a queue waiting to be transmitted by the
            shaper.<br>
        ...
        bandwidth (int | Unset): The total bandwidth amount allowed by this traffic shaper.<br><br>This field is only
            available when the following conditions are met:<br>- Parent field `scheduler` must be one of [ FAIRQ, CBQ, HFSC
            ]<br>
        ...
        upperlimit_m2 (str | Unset): The normal bandwidth limit for this traffic shaper queue. If `upperlimit_m1` is not
        ...
        realtime_m2 (str | Unset): The maximum bandwidth this traffic shaper queue is allowed to use. Note: This value
            should not exceed 30% of parent queue's maximum bandwidth.<br><br>This field is only available when the
            following conditions are met:<br>- `realtime` must be equal to `true`<br>
        ...
        linkshare_m2 (str | Unset): The maximum bandwidth this traffic shaper queue is allowed to use. Note: This
            behaves exactly the same as the `bandwidth` field. If this field is set, it will override whatever value is
            current assigned to the `bandwidth` field.<br><br>This field is only available when the following conditions are
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_traffic_shaper_queue_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            interface=interface,
            enabled=enabled,
        ...
        patch_firewall_traffic_shaper_queue_endpoint_json_body.additional_properties = d
        return patch_firewall_traffic_shaper_queue_endpoint_json_body
