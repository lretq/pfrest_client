...
T = TypeVar("T", bound="GetUserAuthServersEndpointResponse422")


@_attrs_define
class GetUserAuthServersEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_auth_servers_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_user_auth_servers_endpoint_response_422.additional_properties = d
        return get_user_auth_servers_endpoint_response_422
