...
T = TypeVar("T", bound="DeleteAuthKeyEndpointResponse422")


@_attrs_define
class DeleteAuthKeyEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_auth_key_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_auth_key_endpoint_response_422.additional_properties = d
        return delete_auth_key_endpoint_response_422
