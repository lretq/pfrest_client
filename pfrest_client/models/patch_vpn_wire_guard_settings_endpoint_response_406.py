...
T = TypeVar("T", bound="PatchVPNWireGuardSettingsEndpointResponse406")


@_attrs_define
class PatchVPNWireGuardSettingsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_wire_guard_settings_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_vpn_wire_guard_settings_endpoint_response_406.additional_properties = d
        return patch_vpn_wire_guard_settings_endpoint_response_406
