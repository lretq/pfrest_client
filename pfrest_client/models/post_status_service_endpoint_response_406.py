...
T = TypeVar("T", bound="PostStatusServiceEndpointResponse406")


@_attrs_define
class PostStatusServiceEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_status_service_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_status_service_endpoint_response_406.additional_properties = d
        return post_status_service_endpoint_response_406
