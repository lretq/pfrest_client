...
T = TypeVar("T", bound="PostServicesFreeRADIUSMACEndpointResponse406")


@_attrs_define
class PostServicesFreeRADIUSMACEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_free_radiusmac_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_services_free_radiusmac_endpoint_response_406.additional_properties = d
        return post_services_free_radiusmac_endpoint_response_406
