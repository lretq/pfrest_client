...
T = TypeVar("T", bound="PostFirewallVirtualIPEndpointJsonBody")


@_attrs_define
class PostFirewallVirtualIPEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_virtual_ip_endpoint_json_body = cls(
            mode=mode,
            interface=interface,
            subnet=subnet,
            subnet_bits=subnet_bits,
        ...
        post_firewall_virtual_ip_endpoint_json_body.additional_properties = d
        return post_firewall_virtual_ip_endpoint_json_body
