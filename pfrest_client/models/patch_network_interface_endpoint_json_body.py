...
T = TypeVar("T", bound="PatchNetworkInterfaceEndpointJsonBody")


@_attrs_define
class PatchNetworkInterfaceEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_network_interface_endpoint_json_body = cls(
            id=id,
            if_=if_,
            enable=enable,
            descr=descr,
        ...
        patch_network_interface_endpoint_json_body.additional_properties = d
        return patch_network_interface_endpoint_json_body
