...
T = TypeVar("T", bound="GetFirewallScheduleTimeRangesEndpointResponse405")


@_attrs_define
class GetFirewallScheduleTimeRangesEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_schedule_time_ranges_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_firewall_schedule_time_ranges_endpoint_response_405.additional_properties = d
        return get_firewall_schedule_time_ranges_endpoint_response_405
