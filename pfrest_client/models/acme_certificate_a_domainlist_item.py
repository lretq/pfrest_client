...
T = TypeVar("T", bound="ACMECertificateADomainlistItem")


@_attrs_define
class ACMECertificateADomainlistItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        acme_certificate_a_domainlist_item = cls(
            name=name,
            method=method,
            status=status,
        ...
        acme_certificate_a_domainlist_item.additional_properties = d
        return acme_certificate_a_domainlist_item
