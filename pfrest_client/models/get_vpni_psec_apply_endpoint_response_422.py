...
T = TypeVar("T", bound="GetVPNIPsecApplyEndpointResponse422")


@_attrs_define
class GetVPNIPsecApplyEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpni_psec_apply_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_vpni_psec_apply_endpoint_response_422.additional_properties = d
        return get_vpni_psec_apply_endpoint_response_422
