...
T = TypeVar("T", bound="PutServicesFreeRADIUSInterfacesEndpointResponse406")


@_attrs_define
class PutServicesFreeRADIUSInterfacesEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_free_radius_interfaces_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        put_services_free_radius_interfaces_endpoint_response_406.additional_properties = d
        return put_services_free_radius_interfaces_endpoint_response_406
