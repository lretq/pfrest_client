...
T = TypeVar("T", bound="TrafficShaperQueueItem")


@_attrs_define
class TrafficShaperQueueItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        traffic_shaper_queue_item.additional_properties = d
        return traffic_shaper_queue_item
