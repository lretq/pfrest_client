...
T = TypeVar("T", bound="PostServicesHAProxyBackendServerEndpointDataBody")


@_attrs_define
class PostServicesHAProxyBackendServerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_backend_server_endpoint_data_body = cls(
            name=name,
            address=address,
            port=port,
            parent_id=parent_id,
        ...
        post_services_ha_proxy_backend_server_endpoint_data_body.additional_properties = d
        return post_services_ha_proxy_backend_server_endpoint_data_body
