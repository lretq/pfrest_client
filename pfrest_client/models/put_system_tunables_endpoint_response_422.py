...
T = TypeVar("T", bound="PutSystemTunablesEndpointResponse422")


@_attrs_define
class PutSystemTunablesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_system_tunables_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_system_tunables_endpoint_response_422.additional_properties = d
        return put_system_tunables_endpoint_response_422
