...
T = TypeVar("T", bound="PostVPNIPsecPhase2EncryptionEndpointResponse405")


@_attrs_define
class PostVPNIPsecPhase2EncryptionEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpni_psec_phase_2_encryption_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_vpni_psec_phase_2_encryption_endpoint_response_405.additional_properties = d
        return post_vpni_psec_phase_2_encryption_endpoint_response_405
