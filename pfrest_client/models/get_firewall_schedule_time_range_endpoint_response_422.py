...
T = TypeVar("T", bound="GetFirewallScheduleTimeRangeEndpointResponse422")


@_attrs_define
class GetFirewallScheduleTimeRangeEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_schedule_time_range_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_firewall_schedule_time_range_endpoint_response_422.additional_properties = d
        return get_firewall_schedule_time_range_endpoint_response_422
