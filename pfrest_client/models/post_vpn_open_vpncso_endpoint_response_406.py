...
T = TypeVar("T", bound="PostVPNOpenVPNCSOEndpointResponse406")


@_attrs_define
class PostVPNOpenVPNCSOEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_open_vpncso_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_vpn_open_vpncso_endpoint_response_406.additional_properties = d
        return post_vpn_open_vpncso_endpoint_response_406
