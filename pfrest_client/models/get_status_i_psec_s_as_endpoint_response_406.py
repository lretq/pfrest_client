...
T = TypeVar("T", bound="GetStatusIPsecSAsEndpointResponse406")


@_attrs_define
class GetStatusIPsecSAsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_status_i_psec_s_as_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_status_i_psec_s_as_endpoint_response_406.additional_properties = d
        return get_status_i_psec_s_as_endpoint_response_406
