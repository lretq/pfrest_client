...
T = TypeVar("T", bound="PatchServicesNTPSettingsEndpointDataBody")


@_attrs_define
class PatchServicesNTPSettingsEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ntp_settings_endpoint_data_body = cls(
            serverauthkey=serverauthkey,
            enable=enable,
            interface=interface,
        ...
        patch_services_ntp_settings_endpoint_data_body.additional_properties = d
        return patch_services_ntp_settings_endpoint_data_body
