...
T = TypeVar("T", bound="PutServicesBINDSyncRemoteHostsEndpointResponse422")


@_attrs_define
class PutServicesBINDSyncRemoteHostsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_bind_sync_remote_hosts_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_services_bind_sync_remote_hosts_endpoint_response_422.additional_properties = d
        return put_services_bind_sync_remote_hosts_endpoint_response_422
