...
T = TypeVar("T", bound="PatchVPNWireGuardTunnelEndpointDataBody")


@_attrs_define
class PatchVPNWireGuardTunnelEndpointDataBody:
    """
    Attributes:
        ...
        privatekey (str | Unset): The private key for this tunnel.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_wire_guard_tunnel_endpoint_data_body = cls(
            id=id,
            name=name,
            enabled=enabled,
            descr=descr,
        ...
        patch_vpn_wire_guard_tunnel_endpoint_data_body.additional_properties = d
        return patch_vpn_wire_guard_tunnel_endpoint_data_body
