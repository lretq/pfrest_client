...
T = TypeVar("T", bound="GetServicesFreeRADIUSInterfaceEndpointResponse405")


@_attrs_define
class GetServicesFreeRADIUSInterfaceEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_free_radius_interface_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_services_free_radius_interface_endpoint_response_405.additional_properties = d
        return get_services_free_radius_interface_endpoint_response_405
