...
T = TypeVar("T", bound="PostInterfaceBridgeEndpointJsonBody")


@_attrs_define
class PostInterfaceBridgeEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_interface_bridge_endpoint_json_body = cls(
            members=members,
            descr=descr,
            bridgeif=bridgeif,
        )

        post_interface_bridge_endpoint_json_body.additional_properties = d
        return post_interface_bridge_endpoint_json_body
