...
T = TypeVar("T", bound="PatchVPNIPsecPhase2EndpointResponse422")


@_attrs_define
class PatchVPNIPsecPhase2EndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpni_psec_phase_2_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_vpni_psec_phase_2_endpoint_response_422.additional_properties = d
        return patch_vpni_psec_phase_2_endpoint_response_422
