...
T = TypeVar("T", bound="PostServicesNTPTimeServerEndpointDataBody")


@_attrs_define
class PostServicesNTPTimeServerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ntp_time_server_endpoint_data_body = cls(
            timeserver=timeserver,
            type_=type_,
            prefer=prefer,
            noselect=noselect,
        ...
        post_services_ntp_time_server_endpoint_data_body.additional_properties = d
        return post_services_ntp_time_server_endpoint_data_body
