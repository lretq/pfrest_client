...
T = TypeVar("T", bound="BINDSettings")
...
class BINDSettings:
    ...
    Attributes:
        ...
        bind_forwarder_ips (list[str] | Unset): The IP addresses of the DNS servers to forward queries to.<br><br>This
            field is only available when the following conditions are met:<br>- `bind_forwarder` must be equal to `true`<br>
    ...
    bind_forwarder_ips: list[str] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        bind_forwarder_ips: list[str] | Unset = UNSET
        if not isinstance(self.bind_forwarder_ips, Unset):
        ...
        if bind_forwarder_ips is not UNSET:
            field_dict["bind_forwarder_ips"] = bind_forwarder_ips
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bind_forwarder_ips = cast(list[str], d.pop("bind_forwarder_ips", UNSET))
        ...
        bind_settings.additional_properties = d
