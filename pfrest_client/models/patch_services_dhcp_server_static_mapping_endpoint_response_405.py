...
T = TypeVar("T", bound="PatchServicesDHCPServerStaticMappingEndpointResponse405")


@_attrs_define
class PatchServicesDHCPServerStaticMappingEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_static_mapping_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_services_dhcp_server_static_mapping_endpoint_response_405.additional_properties = d
        return patch_services_dhcp_server_static_mapping_endpoint_response_405
