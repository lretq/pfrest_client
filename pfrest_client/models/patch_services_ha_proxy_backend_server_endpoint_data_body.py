...
T = TypeVar("T", bound="PatchServicesHAProxyBackendServerEndpointDataBody")


@_attrs_define
class PatchServicesHAProxyBackendServerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_backend_server_endpoint_data_body = cls(
            parent_id=parent_id,
            id=id,
            name=name,
            status=status,
        ...
        patch_services_ha_proxy_backend_server_endpoint_data_body.additional_properties = d
        return patch_services_ha_proxy_backend_server_endpoint_data_body
