...
T = TypeVar("T", bound="PatchServicesServiceWatchdogEndpointJsonBody")


@_attrs_define
class PatchServicesServiceWatchdogEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_service_watchdog_endpoint_json_body = cls(
            id=id,
            name=name,
        ...
        patch_services_service_watchdog_endpoint_json_body.additional_properties = d
        return patch_services_service_watchdog_endpoint_json_body
