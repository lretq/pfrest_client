...
T = TypeVar("T", bound="PutServicesServiceWatchdogsEndpointDataBodyItem")


@_attrs_define
class PutServicesServiceWatchdogsEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_service_watchdogs_endpoint_data_body_item = cls(
            name=name,
        ...
        put_services_service_watchdogs_endpoint_data_body_item.additional_properties = d
        return put_services_service_watchdogs_endpoint_data_body_item
