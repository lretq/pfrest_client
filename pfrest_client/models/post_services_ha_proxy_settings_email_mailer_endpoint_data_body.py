...
T = TypeVar("T", bound="PostServicesHAProxySettingsEmailMailerEndpointDataBody")


@_attrs_define
class PostServicesHAProxySettingsEmailMailerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_settings_email_mailer_endpoint_data_body = cls(
            name=name,
            mailserver=mailserver,
            mailserverport=mailserverport,
        )

        post_services_ha_proxy_settings_email_mailer_endpoint_data_body.additional_properties = d
        return post_services_ha_proxy_settings_email_mailer_endpoint_data_body
