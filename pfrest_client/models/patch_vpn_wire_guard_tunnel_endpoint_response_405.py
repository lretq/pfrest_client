...
T = TypeVar("T", bound="PatchVPNWireGuardTunnelEndpointResponse405")


@_attrs_define
class PatchVPNWireGuardTunnelEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_wire_guard_tunnel_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_vpn_wire_guard_tunnel_endpoint_response_405.additional_properties = d
        return patch_vpn_wire_guard_tunnel_endpoint_response_405
