...
T = TypeVar("T", bound="GetInterfaceVLANsEndpointResponse406")


@_attrs_define
class GetInterfaceVLANsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_interface_vla_ns_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_interface_vla_ns_endpoint_response_406.additional_properties = d
        return get_interface_vla_ns_endpoint_response_406
