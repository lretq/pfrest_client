...
T = TypeVar("T", bound="PatchSystemTunableEndpointDataBody")


@_attrs_define
class PatchSystemTunableEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_tunable_endpoint_data_body = cls(
            id=id,
            tunable=tunable,
            value=value,
            descr=descr,
        ...
        patch_system_tunable_endpoint_data_body.additional_properties = d
        return patch_system_tunable_endpoint_data_body
