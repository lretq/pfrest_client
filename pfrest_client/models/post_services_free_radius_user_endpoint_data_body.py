...
T = TypeVar("T", bound="PostServicesFreeRADIUSUserEndpointDataBody")


@_attrs_define
class PostServicesFreeRADIUSUserEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_free_radius_user_endpoint_data_body = cls(
            username=username,
            password=password,
            motp_secret=motp_secret,
            motp_pin=motp_pin,
        ...
        post_services_free_radius_user_endpoint_data_body.additional_properties = d
        return post_services_free_radius_user_endpoint_data_body
