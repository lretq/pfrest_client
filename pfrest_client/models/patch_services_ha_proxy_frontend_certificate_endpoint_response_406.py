...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendCertificateEndpointResponse406")


@_attrs_define
class PatchServicesHAProxyFrontendCertificateEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_frontend_certificate_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_services_ha_proxy_frontend_certificate_endpoint_response_406.additional_properties = d
        return patch_services_ha_proxy_frontend_certificate_endpoint_response_406
