...
T = TypeVar("T", bound="PatchUserEndpointResponse406")


@_attrs_define
class PatchUserEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_user_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_user_endpoint_response_406.additional_properties = d
        return patch_user_endpoint_response_406
