...
T = TypeVar("T", bound="PutServicesNTPTimeServersEndpointJsonBodyItem")


@_attrs_define
class PutServicesNTPTimeServersEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_ntp_time_servers_endpoint_json_body_item = cls(
            timeserver=timeserver,
            type_=type_,
            prefer=prefer,
            noselect=noselect,
        ...
        put_services_ntp_time_servers_endpoint_json_body_item.additional_properties = d
        return put_services_ntp_time_servers_endpoint_json_body_item
