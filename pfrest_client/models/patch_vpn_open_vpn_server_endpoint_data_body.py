...
T = TypeVar("T", bound="PatchVPNOpenVPNServerEndpointDataBody")


@_attrs_define
class PatchVPNOpenVPNServerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_open_vpn_server_endpoint_data_body = cls(
            id=id,
            vpnid=vpnid,
            vpnif=vpnif,
        ...
        patch_vpn_open_vpn_server_endpoint_data_body.additional_properties = d
        return patch_vpn_open_vpn_server_endpoint_data_body
