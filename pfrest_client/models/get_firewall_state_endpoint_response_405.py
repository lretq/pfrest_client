...
T = TypeVar("T", bound="GetFirewallStateEndpointResponse405")


@_attrs_define
class GetFirewallStateEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_state_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_firewall_state_endpoint_response_405.additional_properties = d
        return get_firewall_state_endpoint_response_405
