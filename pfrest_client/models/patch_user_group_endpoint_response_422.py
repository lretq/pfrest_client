...
T = TypeVar("T", bound="PatchUserGroupEndpointResponse422")


@_attrs_define
class PatchUserGroupEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_user_group_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_user_group_endpoint_response_422.additional_properties = d
        return patch_user_group_endpoint_response_422
