...
T = TypeVar("T", bound="PostFirewallTrafficShaperQueueEndpointResponse422")


@_attrs_define
class PostFirewallTrafficShaperQueueEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_queue_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_firewall_traffic_shaper_queue_endpoint_response_422.additional_properties = d
        return post_firewall_traffic_shaper_queue_endpoint_response_422
