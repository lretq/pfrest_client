...
T = TypeVar("T", bound="PostServicesFreeRADIUSClientEndpointJsonBody")


@_attrs_define
class PostServicesFreeRADIUSClientEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_free_radius_client_endpoint_json_body = cls(
            addr=addr,
            shortname=shortname,
            secret=secret,
        ...
        post_services_free_radius_client_endpoint_json_body.additional_properties = d
        return post_services_free_radius_client_endpoint_json_body
