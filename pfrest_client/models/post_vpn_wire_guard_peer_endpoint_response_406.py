...
T = TypeVar("T", bound="PostVPNWireGuardPeerEndpointResponse406")


@_attrs_define
class PostVPNWireGuardPeerEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_wire_guard_peer_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_vpn_wire_guard_peer_endpoint_response_406.additional_properties = d
        return post_vpn_wire_guard_peer_endpoint_response_406
