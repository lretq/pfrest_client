...
T = TypeVar("T", bound="PostRoutingGatewayEndpointJsonBody")


@_attrs_define
class PostRoutingGatewayEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routing_gateway_endpoint_json_body = cls(
            name=name,
            ipprotocol=ipprotocol,
            interface=interface,
            gateway=gateway,
        ...
        post_routing_gateway_endpoint_json_body.additional_properties = d
        return post_routing_gateway_endpoint_json_body
