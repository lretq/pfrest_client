...
T = TypeVar("T", bound="DeleteDiagnosticsConfigHistoryRevisionsEndpointResponse405")


@_attrs_define
class DeleteDiagnosticsConfigHistoryRevisionsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_diagnostics_config_history_revisions_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_diagnostics_config_history_revisions_endpoint_response_405.additional_properties = d
        return delete_diagnostics_config_history_revisions_endpoint_response_405
