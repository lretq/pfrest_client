...
T = TypeVar("T", bound="PostFirewallAliasEndpointResponse406")


@_attrs_define
class PostFirewallAliasEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_alias_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_firewall_alias_endpoint_response_406.additional_properties = d
        return post_firewall_alias_endpoint_response_406
