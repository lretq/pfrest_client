...
T = TypeVar("T", bound="PostVPNIPsecPhase2EndpointResponse422")


@_attrs_define
class PostVPNIPsecPhase2EndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpni_psec_phase_2_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_vpni_psec_phase_2_endpoint_response_422.additional_properties = d
        return post_vpni_psec_phase_2_endpoint_response_422
