...
T = TypeVar("T", bound="DeleteDiagnosticsARPTableEntryEndpointResponse405")


@_attrs_define
class DeleteDiagnosticsARPTableEntryEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_diagnostics_arp_table_entry_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_diagnostics_arp_table_entry_endpoint_response_405.additional_properties = d
        return delete_diagnostics_arp_table_entry_endpoint_response_405
