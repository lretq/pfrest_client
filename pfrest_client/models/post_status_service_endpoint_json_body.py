...
T = TypeVar("T", bound="PostStatusServiceEndpointJsonBody")


@_attrs_define
class PostStatusServiceEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_status_service_endpoint_json_body = cls(
            id=id,
            name=name,
            action=action,
        ...
        post_status_service_endpoint_json_body.additional_properties = d
        return post_status_service_endpoint_json_body
