...
T = TypeVar("T", bound="PatchServicesDNSResolverAccessListEndpointDataBody")


@_attrs_define
class PatchServicesDNSResolverAccessListEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dns_resolver_access_list_endpoint_data_body = cls(
            id=id,
            name=name,
            action=action,
        ...
        patch_services_dns_resolver_access_list_endpoint_data_body.additional_properties = d
        return patch_services_dns_resolver_access_list_endpoint_data_body
