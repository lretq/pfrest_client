...
T = TypeVar("T", bound="PatchServicesHAProxyFileEndpointJsonBody")


@_attrs_define
class PatchServicesHAProxyFileEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_file_endpoint_json_body = cls(
            id=id,
            name=name,
            type_=type_,
            content=content,
        ...
        patch_services_ha_proxy_file_endpoint_json_body.additional_properties = d
        return patch_services_ha_proxy_file_endpoint_json_body
