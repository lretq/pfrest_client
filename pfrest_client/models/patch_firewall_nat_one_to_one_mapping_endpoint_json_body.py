...
T = TypeVar("T", bound="PatchFirewallNATOneToOneMappingEndpointJsonBody")


@_attrs_define
class PatchFirewallNATOneToOneMappingEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_nat_one_to_one_mapping_endpoint_json_body = cls(
            id=id,
            interface=interface,
            disabled=disabled,
            nobinat=nobinat,
        ...
        patch_firewall_nat_one_to_one_mapping_endpoint_json_body.additional_properties = d
        return patch_firewall_nat_one_to_one_mapping_endpoint_json_body
