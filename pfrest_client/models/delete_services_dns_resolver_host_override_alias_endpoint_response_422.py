...
T = TypeVar("T", bound="DeleteServicesDNSResolverHostOverrideAliasEndpointResponse422")


@_attrs_define
class DeleteServicesDNSResolverHostOverrideAliasEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_dns_resolver_host_override_alias_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_services_dns_resolver_host_override_alias_endpoint_response_422.additional_properties = d
        return delete_services_dns_resolver_host_override_alias_endpoint_response_422
