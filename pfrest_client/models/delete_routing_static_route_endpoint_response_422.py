...
T = TypeVar("T", bound="DeleteRoutingStaticRouteEndpointResponse422")


@_attrs_define
class DeleteRoutingStaticRouteEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_routing_static_route_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_routing_static_route_endpoint_response_422.additional_properties = d
        return delete_routing_static_route_endpoint_response_422
