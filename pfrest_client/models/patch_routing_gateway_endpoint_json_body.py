...
T = TypeVar("T", bound="PatchRoutingGatewayEndpointJsonBody")


@_attrs_define
class PatchRoutingGatewayEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_routing_gateway_endpoint_json_body = cls(
            id=id,
            name=name,
            descr=descr,
            disabled=disabled,
        ...
        patch_routing_gateway_endpoint_json_body.additional_properties = d
        return patch_routing_gateway_endpoint_json_body
