...
T = TypeVar("T", bound="PatchFirewallNATPortForwardEndpointJsonBody")


@_attrs_define
class PatchFirewallNATPortForwardEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_nat_port_forward_endpoint_json_body = cls(
            id=id,
            interface=interface,
        ...
        patch_firewall_nat_port_forward_endpoint_json_body.additional_properties = d
        return patch_firewall_nat_port_forward_endpoint_json_body
