...
T = TypeVar("T", bound="PutServicesBINDSyncRemoteHostsEndpointDataBodyItem")


@_attrs_define
class PutServicesBINDSyncRemoteHostsEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_bind_sync_remote_hosts_endpoint_data_body_item = cls(
            syncprotocol=syncprotocol,
            ipaddress=ipaddress,
            syncport=syncport,
            username=username,
        ...
        put_services_bind_sync_remote_hosts_endpoint_data_body_item.additional_properties = d
        return put_services_bind_sync_remote_hosts_endpoint_data_body_item
