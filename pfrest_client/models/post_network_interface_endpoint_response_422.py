...
T = TypeVar("T", bound="PostNetworkInterfaceEndpointResponse422")


@_attrs_define
class PostNetworkInterfaceEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_network_interface_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_network_interface_endpoint_response_422.additional_properties = d
        return post_network_interface_endpoint_response_422
