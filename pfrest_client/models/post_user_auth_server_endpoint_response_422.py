...
T = TypeVar("T", bound="PostUserAuthServerEndpointResponse422")


@_attrs_define
class PostUserAuthServerEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_user_auth_server_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_user_auth_server_endpoint_response_422.additional_properties = d
        return post_user_auth_server_endpoint_response_422
