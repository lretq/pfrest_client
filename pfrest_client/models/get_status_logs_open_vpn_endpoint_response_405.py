...
T = TypeVar("T", bound="GetStatusLogsOpenVPNEndpointResponse405")


@_attrs_define
class GetStatusLogsOpenVPNEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_status_logs_open_vpn_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_status_logs_open_vpn_endpoint_response_405.additional_properties = d
        return get_status_logs_open_vpn_endpoint_response_405
