...
T = TypeVar("T", bound="DeleteInterfaceLAGGsEndpointResponse406")


@_attrs_define
class DeleteInterfaceLAGGsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_interface_lag_gs_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_interface_lag_gs_endpoint_response_406.additional_properties = d
        return delete_interface_lag_gs_endpoint_response_406
