...
T = TypeVar("T", bound="GetSystemRESTAPISettingsEndpointResponse405")


@_attrs_define
class GetSystemRESTAPISettingsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_restapi_settings_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_system_restapi_settings_endpoint_response_405.additional_properties = d
        return get_system_restapi_settings_endpoint_response_405
