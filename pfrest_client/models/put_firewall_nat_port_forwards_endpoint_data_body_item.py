...
T = TypeVar("T", bound="PutFirewallNATPortForwardsEndpointDataBodyItem")


@_attrs_define
class PutFirewallNATPortForwardsEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_nat_port_forwards_endpoint_data_body_item = cls(
            interface=interface,
            protocol=protocol,
            source=source,
            destination=destination,
        ...
        put_firewall_nat_port_forwards_endpoint_data_body_item.additional_properties = d
        return put_firewall_nat_port_forwards_endpoint_data_body_item
