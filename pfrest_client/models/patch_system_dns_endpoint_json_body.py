...
T = TypeVar("T", bound="PatchSystemDNSEndpointJsonBody")


@_attrs_define
class PatchSystemDNSEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_dns_endpoint_json_body = cls(
            dnsallowoverride=dnsallowoverride,
            dnslocalhost=dnslocalhost,
            dnsserver=dnsserver,
        )

        patch_system_dns_endpoint_json_body.additional_properties = d
        return patch_system_dns_endpoint_json_body
