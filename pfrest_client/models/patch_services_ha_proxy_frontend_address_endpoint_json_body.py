...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendAddressEndpointJsonBody")


@_attrs_define
class PatchServicesHAProxyFrontendAddressEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_frontend_address_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            extaddr=extaddr,
        ...
        patch_services_ha_proxy_frontend_address_endpoint_json_body.additional_properties = d
        return patch_services_ha_proxy_frontend_address_endpoint_json_body
