...
T = TypeVar("T", bound="PostServicesDNSResolverHostOverrideAliasEndpointResponse422")


@_attrs_define
class PostServicesDNSResolverHostOverrideAliasEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_dns_resolver_host_override_alias_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_services_dns_resolver_host_override_alias_endpoint_response_422.additional_properties = d
        return post_services_dns_resolver_host_override_alias_endpoint_response_422
