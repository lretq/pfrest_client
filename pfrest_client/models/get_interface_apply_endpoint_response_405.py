...
T = TypeVar("T", bound="GetInterfaceApplyEndpointResponse405")


@_attrs_define
class GetInterfaceApplyEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_interface_apply_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_interface_apply_endpoint_response_405.additional_properties = d
        return get_interface_apply_endpoint_response_405
