...
T = TypeVar("T", bound="PostServicesACMECertificateDomainEndpointDataBody")


@_attrs_define
class PostServicesACMECertificateDomainEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_acme_certificate_domain_endpoint_data_body = cls(
            name=name,
            method=method,
            parent_id=parent_id,
            status=status,
        ...
        post_services_acme_certificate_domain_endpoint_data_body.additional_properties = d
        return post_services_acme_certificate_domain_endpoint_data_body
