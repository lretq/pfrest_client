...
T = TypeVar("T", bound="DeleteDiagnosticsConfigHistoryRevisionsEndpointResponse406")


@_attrs_define
class DeleteDiagnosticsConfigHistoryRevisionsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_diagnostics_config_history_revisions_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_diagnostics_config_history_revisions_endpoint_response_406.additional_properties = d
        return delete_diagnostics_config_history_revisions_endpoint_response_406
