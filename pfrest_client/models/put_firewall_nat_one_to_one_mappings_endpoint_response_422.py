...
T = TypeVar("T", bound="PutFirewallNATOneToOneMappingsEndpointResponse422")


@_attrs_define
class PutFirewallNATOneToOneMappingsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_nat_one_to_one_mappings_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_firewall_nat_one_to_one_mappings_endpoint_response_422.additional_properties = d
        return put_firewall_nat_one_to_one_mappings_endpoint_response_422
