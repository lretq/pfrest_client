...
T = TypeVar("T", bound="PatchInterfaceLAGGEndpointResponse406")


@_attrs_define
class PatchInterfaceLAGGEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_lagg_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_interface_lagg_endpoint_response_406.additional_properties = d
        return patch_interface_lagg_endpoint_response_406
