...
T = TypeVar("T", bound="PostServicesFreeRADIUSInterfaceEndpointResponse405")


@_attrs_define
class PostServicesFreeRADIUSInterfaceEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_free_radius_interface_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_services_free_radius_interface_endpoint_response_405.additional_properties = d
        return post_services_free_radius_interface_endpoint_response_405
