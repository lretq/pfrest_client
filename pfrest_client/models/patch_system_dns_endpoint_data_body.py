...
T = TypeVar("T", bound="PatchSystemDNSEndpointDataBody")


@_attrs_define
class PatchSystemDNSEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_dns_endpoint_data_body = cls(
            dnsallowoverride=dnsallowoverride,
            dnslocalhost=dnslocalhost,
            dnsserver=dnsserver,
        )

        patch_system_dns_endpoint_data_body.additional_properties = d
        return patch_system_dns_endpoint_data_body
