...
T = TypeVar("T", bound="PostAuthKeyEndpointResponse406")


@_attrs_define
class PostAuthKeyEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_auth_key_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_auth_key_endpoint_response_406.additional_properties = d
        return post_auth_key_endpoint_response_406
