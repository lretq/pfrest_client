...
T = TypeVar("T", bound="PostFirewallTrafficShaperEndpointDataBody")


@_attrs_define
class PostFirewallTrafficShaperEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_endpoint_data_body = cls(
            interface=interface,
            scheduler=scheduler,
            bandwidthtype=bandwidthtype,
            bandwidth=bandwidth,
        ...
        post_firewall_traffic_shaper_endpoint_data_body.additional_properties = d
        return post_firewall_traffic_shaper_endpoint_data_body
