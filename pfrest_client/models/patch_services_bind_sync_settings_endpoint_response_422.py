...
T = TypeVar("T", bound="PatchServicesBINDSyncSettingsEndpointResponse422")


@_attrs_define
class PatchServicesBINDSyncSettingsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_bind_sync_settings_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_services_bind_sync_settings_endpoint_response_422.additional_properties = d
        return patch_services_bind_sync_settings_endpoint_response_422
