...
T = TypeVar("T", bound="PutServicesDNSResolverHostOverridesEndpointResponse405")


@_attrs_define
class PutServicesDNSResolverHostOverridesEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_dns_resolver_host_overrides_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        put_services_dns_resolver_host_overrides_endpoint_response_405.additional_properties = d
        return put_services_dns_resolver_host_overrides_endpoint_response_405
