...
T = TypeVar("T", bound="GetUserAuthServerEndpointResponse405")


@_attrs_define
class GetUserAuthServerEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_auth_server_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_user_auth_server_endpoint_response_405.additional_properties = d
        return get_user_auth_server_endpoint_response_405
