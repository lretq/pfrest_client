...
T = TypeVar("T", bound="GetStatusOpenVPNServersEndpointResponse405")


@_attrs_define
class GetStatusOpenVPNServersEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_status_open_vpn_servers_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_status_open_vpn_servers_endpoint_response_405.additional_properties = d
        return get_status_open_vpn_servers_endpoint_response_405
