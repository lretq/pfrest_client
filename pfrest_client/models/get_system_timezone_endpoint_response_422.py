...
T = TypeVar("T", bound="GetSystemTimezoneEndpointResponse422")


@_attrs_define
class GetSystemTimezoneEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_timezone_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_system_timezone_endpoint_response_422.additional_properties = d
        return get_system_timezone_endpoint_response_422
