...
T = TypeVar("T", bound="PutServicesBINDViewsEndpointResponse422")


@_attrs_define
class PutServicesBINDViewsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_bind_views_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_services_bind_views_endpoint_response_422.additional_properties = d
        return put_services_bind_views_endpoint_response_422
