...
T = TypeVar("T", bound="PostRoutingStaticRouteEndpointResponse422")


@_attrs_define
class PostRoutingStaticRouteEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routing_static_route_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_routing_static_route_endpoint_response_422.additional_properties = d
        return post_routing_static_route_endpoint_response_422
