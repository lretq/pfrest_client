...
T = TypeVar("T", bound="GetDiagnosticsARPTableEndpointResponse405")


@_attrs_define
class GetDiagnosticsARPTableEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_diagnostics_arp_table_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_diagnostics_arp_table_endpoint_response_405.additional_properties = d
        return get_diagnostics_arp_table_endpoint_response_405
