...
T = TypeVar("T", bound="PatchNetworkInterfaceEndpointResponse422")


@_attrs_define
class PatchNetworkInterfaceEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_network_interface_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_network_interface_endpoint_response_422.additional_properties = d
        return patch_network_interface_endpoint_response_422
