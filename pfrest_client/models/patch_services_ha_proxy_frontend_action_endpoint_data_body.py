...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendActionEndpointDataBody")


@_attrs_define
class PatchServicesHAProxyFrontendActionEndpointDataBody:
    """
    Attributes:
        parent_id (int): The ID of the parent this object is nested under.
        id (int): The ID of the object or resource to interact with.
        action (HAProxyFrontendActionAction | Unset): The action to take when an ACL match is found.<br>
        acl (str | Unset): The name of the frontend ACL this action is associated with.<br>
        backend (str | Unset): The backend to use when an ACL match is found.<br><br>This field is only available when
            the following conditions are met:<br>- `action` must be equal to `'use_backend'`<br>
    ...
    parent_id: int
    id: int
    action: HAProxyFrontendActionAction | Unset = UNSET
    acl: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        action: HAProxyFrontendActionAction | Unset
        if isinstance(_action, Unset):
            action = UNSET
        else:
            action = HAProxyFrontendActionAction(_action)
        ...
        patch_services_ha_proxy_frontend_action_endpoint_data_body = cls(
            parent_id=parent_id,
            id=id,
            action=action,
            acl=acl,
        ...
        patch_services_ha_proxy_frontend_action_endpoint_data_body.additional_properties = d
        return patch_services_ha_proxy_frontend_action_endpoint_data_body
