...
T = TypeVar("T", bound="PutFirewallRulesEndpointResponse422")


@_attrs_define
class PutFirewallRulesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_rules_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_firewall_rules_endpoint_response_422.additional_properties = d
        return put_firewall_rules_endpoint_response_422
