...
T = TypeVar("T", bound="PatchInterfaceGREEndpointDataBody")


@_attrs_define
class PatchInterfaceGREEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_gre_endpoint_data_body = cls(
            id=id,
            if_=if_,
            greif=greif,
            descr=descr,
        ...
        patch_interface_gre_endpoint_data_body.additional_properties = d
        return patch_interface_gre_endpoint_data_body
