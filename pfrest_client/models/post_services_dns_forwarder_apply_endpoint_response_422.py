...
T = TypeVar("T", bound="PostServicesDNSForwarderApplyEndpointResponse422")


@_attrs_define
class PostServicesDNSForwarderApplyEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_dns_forwarder_apply_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_services_dns_forwarder_apply_endpoint_response_422.additional_properties = d
        return post_services_dns_forwarder_apply_endpoint_response_422
