...
T = TypeVar("T", bound="PatchVPNOpenVPNServerEndpointResponse405")


@_attrs_define
class PatchVPNOpenVPNServerEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_open_vpn_server_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_vpn_open_vpn_server_endpoint_response_405.additional_properties = d
        return patch_vpn_open_vpn_server_endpoint_response_405
