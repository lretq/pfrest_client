...
T = TypeVar("T", bound="PatchFirewallNATOutboundMappingEndpointResponse406")


@_attrs_define
class PatchFirewallNATOutboundMappingEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_nat_outbound_mapping_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_firewall_nat_outbound_mapping_endpoint_response_406.additional_properties = d
        return patch_firewall_nat_outbound_mapping_endpoint_response_406
