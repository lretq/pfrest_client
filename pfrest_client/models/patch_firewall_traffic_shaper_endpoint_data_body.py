...
T = TypeVar("T", bound="PatchFirewallTrafficShaperEndpointDataBody")


@_attrs_define
class PatchFirewallTrafficShaperEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_traffic_shaper_endpoint_data_body = cls(
            id=id,
            enabled=enabled,
            interface=interface,
            name=name,
        ...
        patch_firewall_traffic_shaper_endpoint_data_body.additional_properties = d
        return patch_firewall_traffic_shaper_endpoint_data_body
