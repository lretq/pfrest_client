...
T = TypeVar("T", bound="PatchServicesDHCPServerEndpointJsonBody")


@_attrs_define
class PatchServicesDHCPServerEndpointJsonBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        interface (str | Unset): The interface to configure the DHCP server for. This field is only necessary when you
            wantto change the interface (ID) of an existing DHCP server, or you are replacing all DHCP server objects with a
            new configuration. Note that specifying an interface in this field will update the ID of the DHCP server to
            match the interface specified here. Leaving this field empty will retain the existing interface.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_endpoint_json_body = cls(
            id=id,
            interface=interface,
            enable=enable,
        ...
        patch_services_dhcp_server_endpoint_json_body.additional_properties = d
        return patch_services_dhcp_server_endpoint_json_body
