...
T = TypeVar("T", bound="GetFirewallTrafficShaperLimiterBandwidthsEndpointResponse406")


@_attrs_define
class GetFirewallTrafficShaperLimiterBandwidthsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_traffic_shaper_limiter_bandwidths_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_firewall_traffic_shaper_limiter_bandwidths_endpoint_response_406.additional_properties = d
        return get_firewall_traffic_shaper_limiter_bandwidths_endpoint_response_406
