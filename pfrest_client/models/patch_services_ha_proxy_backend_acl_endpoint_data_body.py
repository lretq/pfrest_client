...
T = TypeVar("T", bound="PatchServicesHAProxyBackendACLEndpointDataBody")


@_attrs_define
class PatchServicesHAProxyBackendACLEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_backend_acl_endpoint_data_body = cls(
            parent_id=parent_id,
            id=id,
            name=name,
        ...
        patch_services_ha_proxy_backend_acl_endpoint_data_body.additional_properties = d
        return patch_services_ha_proxy_backend_acl_endpoint_data_body
