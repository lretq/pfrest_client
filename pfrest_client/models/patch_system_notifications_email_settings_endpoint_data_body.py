...
T = TypeVar("T", bound="PatchSystemNotificationsEmailSettingsEndpointDataBody")


@_attrs_define
class PatchSystemNotificationsEmailSettingsEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_notifications_email_settings_endpoint_data_body = cls(
            username=username,
            password=password,
            disable=disable,
            ipaddress=ipaddress,
        ...
        patch_system_notifications_email_settings_endpoint_data_body.additional_properties = d
        return patch_system_notifications_email_settings_endpoint_data_body
