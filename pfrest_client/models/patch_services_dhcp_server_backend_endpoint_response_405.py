...
T = TypeVar("T", bound="PatchServicesDHCPServerBackendEndpointResponse405")


@_attrs_define
class PatchServicesDHCPServerBackendEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_backend_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_services_dhcp_server_backend_endpoint_response_405.additional_properties = d
        return patch_services_dhcp_server_backend_endpoint_response_405
