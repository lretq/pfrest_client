...
T = TypeVar("T", bound="GetDiagnosticsConfigHistoryRevisionsEndpointResponse422")


@_attrs_define
class GetDiagnosticsConfigHistoryRevisionsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_diagnostics_config_history_revisions_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_diagnostics_config_history_revisions_endpoint_response_422.additional_properties = d
        return get_diagnostics_config_history_revisions_endpoint_response_422
