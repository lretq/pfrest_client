...
T = TypeVar("T", bound="GetVPNOpenVPNClientExportConfigsEndpointResponse406")


@_attrs_define
class GetVPNOpenVPNClientExportConfigsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpn_open_vpn_client_export_configs_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_vpn_open_vpn_client_export_configs_endpoint_response_406.additional_properties = d
        return get_vpn_open_vpn_client_export_configs_endpoint_response_406
