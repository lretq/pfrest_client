...
T = TypeVar("T", bound="PatchServicesDHCPServerStaticMappingEndpointJsonBody")


@_attrs_define
class PatchServicesDHCPServerStaticMappingEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_static_mapping_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            mac=mac,
            ipaddr=ipaddr,
        ...
        patch_services_dhcp_server_static_mapping_endpoint_json_body.additional_properties = d
        return patch_services_dhcp_server_static_mapping_endpoint_json_body
