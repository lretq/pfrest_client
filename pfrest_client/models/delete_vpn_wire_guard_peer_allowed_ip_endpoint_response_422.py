...
T = TypeVar("T", bound="DeleteVPNWireGuardPeerAllowedIPEndpointResponse422")


@_attrs_define
class DeleteVPNWireGuardPeerAllowedIPEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpn_wire_guard_peer_allowed_ip_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_vpn_wire_guard_peer_allowed_ip_endpoint_response_422.additional_properties = d
        return delete_vpn_wire_guard_peer_allowed_ip_endpoint_response_422
