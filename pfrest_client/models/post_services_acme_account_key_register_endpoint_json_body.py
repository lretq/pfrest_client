...
T = TypeVar("T", bound="PostServicesACMEAccountKeyRegisterEndpointJsonBody")


@_attrs_define
class PostServicesACMEAccountKeyRegisterEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_acme_account_key_register_endpoint_json_body = cls(
            name=name,
            status=status,
        )

        post_services_acme_account_key_register_endpoint_json_body.additional_properties = d
        return post_services_acme_account_key_register_endpoint_json_body
