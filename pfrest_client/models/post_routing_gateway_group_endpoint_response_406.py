...
T = TypeVar("T", bound="PostRoutingGatewayGroupEndpointResponse406")


@_attrs_define
class PostRoutingGatewayGroupEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routing_gateway_group_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_routing_gateway_group_endpoint_response_406.additional_properties = d
        return post_routing_gateway_group_endpoint_response_406
