...
T = TypeVar("T", bound="UnprocessableContentError")
...
class UnprocessableContentError:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        unprocessable_content_error = cls(
            code=code,
            status=status,
        ...
        unprocessable_content_error.additional_properties = d
        return unprocessable_content_error
