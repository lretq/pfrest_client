...
T = TypeVar("T", bound="PatchSystemCertificateAuthorityEndpointResponse422")


@_attrs_define
class PatchSystemCertificateAuthorityEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_certificate_authority_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_system_certificate_authority_endpoint_response_422.additional_properties = d
        return patch_system_certificate_authority_endpoint_response_422
