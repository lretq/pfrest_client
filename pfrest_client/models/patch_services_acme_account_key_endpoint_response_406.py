...
T = TypeVar("T", bound="PatchServicesACMEAccountKeyEndpointResponse406")


@_attrs_define
class PatchServicesACMEAccountKeyEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_acme_account_key_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_services_acme_account_key_endpoint_response_406.additional_properties = d
        return patch_services_acme_account_key_endpoint_response_406
