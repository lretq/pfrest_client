...
T = TypeVar("T", bound="GetStatusSystemEndpointResponse405")


@_attrs_define
class GetStatusSystemEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_status_system_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_status_system_endpoint_response_405.additional_properties = d
        return get_status_system_endpoint_response_405
