...
T = TypeVar("T", bound="DeleteRoutingGatewayGroupEndpointResponse405")


@_attrs_define
class DeleteRoutingGatewayGroupEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_routing_gateway_group_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_routing_gateway_group_endpoint_response_405.additional_properties = d
        return delete_routing_gateway_group_endpoint_response_405
