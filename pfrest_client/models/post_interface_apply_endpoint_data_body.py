...
T = TypeVar("T", bound="PostInterfaceApplyEndpointDataBody")


@_attrs_define
class PostInterfaceApplyEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_interface_apply_endpoint_data_body = cls(
            applied=applied,
            pending_interfaces=pending_interfaces,
        )

        post_interface_apply_endpoint_data_body.additional_properties = d
        return post_interface_apply_endpoint_data_body
