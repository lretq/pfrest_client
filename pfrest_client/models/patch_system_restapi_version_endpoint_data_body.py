...
T = TypeVar("T", bound="PatchSystemRESTAPIVersionEndpointDataBody")


@_attrs_define
class PatchSystemRESTAPIVersionEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_restapi_version_endpoint_data_body = cls(
        ...
        patch_system_restapi_version_endpoint_data_body.additional_properties = d
        return patch_system_restapi_version_endpoint_data_body
