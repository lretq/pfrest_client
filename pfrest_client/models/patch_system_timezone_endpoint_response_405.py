...
T = TypeVar("T", bound="PatchSystemTimezoneEndpointResponse405")


@_attrs_define
class PatchSystemTimezoneEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_timezone_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_system_timezone_endpoint_response_405.additional_properties = d
        return patch_system_timezone_endpoint_response_405
