...
T = TypeVar("T", bound="HAProxyDNSResolver")


@_attrs_define
class HAProxyDNSResolver:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_dns_resolver = cls(
            name=name,
            server=server,
            port=port,
        )

        ha_proxy_dns_resolver.additional_properties = d
        return ha_proxy_dns_resolver
