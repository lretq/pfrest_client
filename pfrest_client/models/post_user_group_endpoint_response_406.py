...
T = TypeVar("T", bound="PostUserGroupEndpointResponse406")


@_attrs_define
class PostUserGroupEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_user_group_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_user_group_endpoint_response_406.additional_properties = d
        return post_user_group_endpoint_response_406
