...
T = TypeVar("T", bound="PatchInterfaceGroupEndpointResponse405")


@_attrs_define
class PatchInterfaceGroupEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_group_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_interface_group_endpoint_response_405.additional_properties = d
        return patch_interface_group_endpoint_response_405
