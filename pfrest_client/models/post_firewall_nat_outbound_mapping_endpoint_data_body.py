...
T = TypeVar("T", bound="PostFirewallNATOutboundMappingEndpointDataBody")


@_attrs_define
class PostFirewallNATOutboundMappingEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_nat_outbound_mapping_endpoint_data_body = cls(
            interface=interface,
            source=source,
            destination=destination,
            target=target,
        ...
        post_firewall_nat_outbound_mapping_endpoint_data_body.additional_properties = d
        return post_firewall_nat_outbound_mapping_endpoint_data_body
