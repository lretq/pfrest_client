...
T = TypeVar("T", bound="GetNetworkInterfaceEndpointResponse422")


@_attrs_define
class GetNetworkInterfaceEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_network_interface_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_network_interface_endpoint_response_422.additional_properties = d
        return get_network_interface_endpoint_response_422
