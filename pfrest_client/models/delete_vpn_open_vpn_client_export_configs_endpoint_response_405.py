...
T = TypeVar("T", bound="DeleteVPNOpenVPNClientExportConfigsEndpointResponse405")


@_attrs_define
class DeleteVPNOpenVPNClientExportConfigsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpn_open_vpn_client_export_configs_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_vpn_open_vpn_client_export_configs_endpoint_response_405.additional_properties = d
        return delete_vpn_open_vpn_client_export_configs_endpoint_response_405
