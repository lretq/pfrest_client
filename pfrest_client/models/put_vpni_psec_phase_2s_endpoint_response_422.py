...
T = TypeVar("T", bound="PutVPNIPsecPhase2SEndpointResponse422")


@_attrs_define
class PutVPNIPsecPhase2SEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_vpni_psec_phase_2s_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_vpni_psec_phase_2s_endpoint_response_422.additional_properties = d
        return put_vpni_psec_phase_2s_endpoint_response_422
