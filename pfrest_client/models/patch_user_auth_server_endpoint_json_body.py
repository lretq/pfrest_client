...
T = TypeVar("T", bound="PatchUserAuthServerEndpointJsonBody")


@_attrs_define
class PatchUserAuthServerEndpointJsonBody:
    """
    Attributes:
        ...
        type_ (AuthServerType | Unset): The type of this authentication server.<br>
        name (str | Unset): The descriptive name for this authentication server.<br>
        host (str | Unset): The remote IP address or hostname of the authentication server.<br>
        ldap_port (str | Unset): The LDAP port to connect to on this LDAP authentication server. Valid options are: a
            TCP/UDP port number<br><br>This field is only available when the following conditions are met:<br>- `type` must
            be equal to `'ldap'`<br>
        ldap_urltype (AuthServerLdapUrltype | Unset): The encryption mode to use when connecting to this authentication
            server. Use `Standard TCP` for unencrypted LDAP connections, use `STARTTLS Encrypt` to start an encrypted
            connection via STARTTLS if it's available, or `SSL/TLS Encrypted` to only use LDAPS encrypted
            connections.<br><br>This field is only available when the following conditions are met:<br>- `type` must be
            equal to `'ldap'`<br>
        ...
        ldap_scope (AuthServerLdapScope | Unset): The LDAP search scope. Use `one` to limit the scope to a single level,
            or `subtree` to allow the entire subtree to be searched.<br><br>This field is only available when the following
        ...
        ldap_binddn (None | str | Unset): The DN to use when binding to this authentication server. Set to `null` to
            ...
            equal to `'ldap'`<br>
        ldap_bindpw (str | Unset): The password to use when binding to this authentication server.<br><br>This field is
            only available when the following conditions are met:<br>- `type` must be equal to `'ldap'`<br>- `ldap_binddn`
        ...
        radius_secret (str | Unset): The shared secret to use when authenticating to this RADIUS server.<br><br>This
        ...
        radius_timeout (int | Unset): The timeout (in seconds) for connections to this RADIUS authentication
            server.<br><br>This field is only available when the following conditions are met:<br>- `type` must be equal to
            `'radius'`<br> Default: 5.
        radius_nasip_attribute (str | Unset): The interface whose IP will be used as the 'NAS-IP-Address' attribute
            during RADIUS Access-Requests. This choice will not change the interface used for contacting the RADIUS
            server.<br><br>This field is only available when the following conditions are met:<br>- `type` must be equal to
            `'radius'`<br>
    """
    ...
    type_: AuthServerType | Unset = UNSET
    name: str | Unset = UNSET
    host: str | Unset = UNSET
    ldap_port: str | Unset = UNSET
    ldap_urltype: AuthServerLdapUrltype | Unset = UNSET
    ...
    ldap_scope: AuthServerLdapScope | Unset = UNSET
    ...
    radius_nasip_attribute: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        ldap_urltype: str | Unset = UNSET
        if not isinstance(self.ldap_urltype, Unset):
        ...
        ldap_scope: str | Unset = UNSET
        if not isinstance(self.ldap_scope, Unset):
        ...
        if ldap_port is not UNSET:
            field_dict["ldap_port"] = ldap_port
        if ldap_urltype is not UNSET:
            field_dict["ldap_urltype"] = ldap_urltype
        ...
        if ldap_scope is not UNSET:
            field_dict["ldap_scope"] = ldap_scope
        ...
        if ldap_bindpw is not UNSET:
            field_dict["ldap_bindpw"] = ldap_bindpw
        ...
        if radius_secret is not UNSET:
            field_dict["radius_secret"] = radius_secret
        ...
        if radius_nasip_attribute is not UNSET:
            field_dict["radius_nasip_attribute"] = radius_nasip_attribute
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: AuthServerType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = AuthServerType(_type_)

        name = d.pop("name", UNSET)

        host = d.pop("host", UNSET)

        ldap_port = d.pop("ldap_port", UNSET)

        _ldap_urltype = d.pop("ldap_urltype", UNSET)
        ldap_urltype: AuthServerLdapUrltype | Unset
        if isinstance(_ldap_urltype, Unset):
            ldap_urltype = UNSET
        else:
            ldap_urltype = AuthServerLdapUrltype(_ldap_urltype)
        ...
        _ldap_scope = d.pop("ldap_scope", UNSET)
        ldap_scope: AuthServerLdapScope | Unset
        if isinstance(_ldap_scope, Unset):
            ldap_scope = UNSET
        else:
            ldap_scope = AuthServerLdapScope(_ldap_scope)
        ...
        ldap_bindpw = d.pop("ldap_bindpw", UNSET)
        ...
        radius_secret = d.pop("radius_secret", UNSET)
        ...
        radius_nasip_attribute = d.pop("radius_nasip_attribute", UNSET)

        patch_user_auth_server_endpoint_json_body = cls(
            id=id,
            refid=refid,
            type_=type_,
            name=name,
        ...
        patch_user_auth_server_endpoint_json_body.additional_properties = d
        return patch_user_auth_server_endpoint_json_body
