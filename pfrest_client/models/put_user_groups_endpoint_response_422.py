...
T = TypeVar("T", bound="PutUserGroupsEndpointResponse422")


@_attrs_define
class PutUserGroupsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_user_groups_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_user_groups_endpoint_response_422.additional_properties = d
        return put_user_groups_endpoint_response_422
