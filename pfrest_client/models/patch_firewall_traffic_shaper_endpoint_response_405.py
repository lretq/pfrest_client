...
T = TypeVar("T", bound="PatchFirewallTrafficShaperEndpointResponse405")


@_attrs_define
class PatchFirewallTrafficShaperEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_traffic_shaper_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_firewall_traffic_shaper_endpoint_response_405.additional_properties = d
        return patch_firewall_traffic_shaper_endpoint_response_405
