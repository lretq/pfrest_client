...
T = TypeVar("T", bound="DeleteFirewallNATOutboundMappingEndpointResponse406")


@_attrs_define
class DeleteFirewallNATOutboundMappingEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_firewall_nat_outbound_mapping_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_firewall_nat_outbound_mapping_endpoint_response_406.additional_properties = d
        return delete_firewall_nat_outbound_mapping_endpoint_response_406
