...
T = TypeVar("T", bound="GetVPNWireGuardTunnelAddressesEndpointResponse405")


@_attrs_define
class GetVPNWireGuardTunnelAddressesEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpn_wire_guard_tunnel_addresses_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_vpn_wire_guard_tunnel_addresses_endpoint_response_405.additional_properties = d
        return get_vpn_wire_guard_tunnel_addresses_endpoint_response_405
