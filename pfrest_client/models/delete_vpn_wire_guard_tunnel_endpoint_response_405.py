...
T = TypeVar("T", bound="DeleteVPNWireGuardTunnelEndpointResponse405")


@_attrs_define
class DeleteVPNWireGuardTunnelEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpn_wire_guard_tunnel_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_vpn_wire_guard_tunnel_endpoint_response_405.additional_properties = d
        return delete_vpn_wire_guard_tunnel_endpoint_response_405
