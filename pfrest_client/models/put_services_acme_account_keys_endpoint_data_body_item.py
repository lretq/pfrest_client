...
T = TypeVar("T", bound="PutServicesACMEAccountKeysEndpointDataBodyItem")


@_attrs_define
class PutServicesACMEAccountKeysEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_acme_account_keys_endpoint_data_body_item = cls(
            name=name,
            acmeserver=acmeserver,
            descr=descr,
            email=email,
        ...
        put_services_acme_account_keys_endpoint_data_body_item.additional_properties = d
        return put_services_acme_account_keys_endpoint_data_body_item
