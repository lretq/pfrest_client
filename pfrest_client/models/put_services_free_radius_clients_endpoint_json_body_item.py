...
T = TypeVar("T", bound="PutServicesFreeRADIUSClientsEndpointJsonBodyItem")


@_attrs_define
class PutServicesFreeRADIUSClientsEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_free_radius_clients_endpoint_json_body_item = cls(
            addr=addr,
            shortname=shortname,
            secret=secret,
        ...
        put_services_free_radius_clients_endpoint_json_body_item.additional_properties = d
        return put_services_free_radius_clients_endpoint_json_body_item
