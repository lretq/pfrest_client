...
T = TypeVar("T", bound="PostServicesHAProxyBackendActionEndpointDataBody")


@_attrs_define
class PostServicesHAProxyBackendActionEndpointDataBody:
    """
    Attributes:
        action (HAProxyBackendActionAction): The action to take when an ACL match is found.<br>
        acl (str): The name of the backend ACL this action is associated with.<br>
        server (str): The backend server to use when an ACL match is found.<br><br>This field is only available when the
            following conditions are met:<br>- `action` must be equal to `'use_server'`<br>
    ...
    action: HAProxyBackendActionAction
    acl: str
    server: str
    customaction: str
    deny_status: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        action = HAProxyBackendActionAction(d.pop("action"))
        ...
        post_services_ha_proxy_backend_action_endpoint_data_body = cls(
            action=action,
            acl=acl,
            server=server,
            customaction=customaction,
        ...
        post_services_ha_proxy_backend_action_endpoint_data_body.additional_properties = d
        return post_services_ha_proxy_backend_action_endpoint_data_body
