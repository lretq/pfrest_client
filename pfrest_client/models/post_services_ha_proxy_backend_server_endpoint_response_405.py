...
T = TypeVar("T", bound="PostServicesHAProxyBackendServerEndpointResponse405")


@_attrs_define
class PostServicesHAProxyBackendServerEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_backend_server_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_services_ha_proxy_backend_server_endpoint_response_405.additional_properties = d
        return post_services_ha_proxy_backend_server_endpoint_response_405
