...
T = TypeVar("T", bound="PostFirewallRuleEndpointDataBody")


@_attrs_define
class PostFirewallRuleEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_rule_endpoint_data_body = cls(
            type_=type_,
            interface=interface,
            ipprotocol=ipprotocol,
            source=source,
        ...
        post_firewall_rule_endpoint_data_body.additional_properties = d
        return post_firewall_rule_endpoint_data_body
