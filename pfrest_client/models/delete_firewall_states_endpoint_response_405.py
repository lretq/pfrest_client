...
T = TypeVar("T", bound="DeleteFirewallStatesEndpointResponse405")


@_attrs_define
class DeleteFirewallStatesEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_firewall_states_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_firewall_states_endpoint_response_405.additional_properties = d
        return delete_firewall_states_endpoint_response_405
