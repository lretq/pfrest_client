...
T = TypeVar("T", bound="DeleteSystemCRLRevokedCertificateEndpointResponse405")


@_attrs_define
class DeleteSystemCRLRevokedCertificateEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_system_crl_revoked_certificate_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_system_crl_revoked_certificate_endpoint_response_405.additional_properties = d
        return delete_system_crl_revoked_certificate_endpoint_response_405
