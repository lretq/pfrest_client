...
T = TypeVar("T", bound="PatchSystemRESTAPIAccessListEntryEndpointDataBody")


@_attrs_define
class PatchSystemRESTAPIAccessListEntryEndpointDataBody:
    """
    Attributes:
        ...
        network (str | Unset): The network (in CIDR notation) that this entry applies to. Clients interacting with the
            REST API from this network will be affected by this entry.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_restapi_access_list_entry_endpoint_data_body = cls(
            id=id,
            type_=type_,
            weight=weight,
            network=network,
        ...
        patch_system_restapi_access_list_entry_endpoint_data_body.additional_properties = d
        return patch_system_restapi_access_list_entry_endpoint_data_body
