...
T = TypeVar("T", bound="DeleteFirewallTrafficShaperLimiterBandwidthEndpointResponse405")


@_attrs_define
class DeleteFirewallTrafficShaperLimiterBandwidthEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_firewall_traffic_shaper_limiter_bandwidth_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_firewall_traffic_shaper_limiter_bandwidth_endpoint_response_405.additional_properties = d
        return delete_firewall_traffic_shaper_limiter_bandwidth_endpoint_response_405
