...
T = TypeVar("T", bound="PostUserEndpointJsonBody")


@_attrs_define
class PostUserEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_user_endpoint_json_body = cls(
            name=name,
            password=password,
            uid=uid,
            scope=scope,
        ...
        post_user_endpoint_json_body.additional_properties = d
        return post_user_endpoint_json_body
