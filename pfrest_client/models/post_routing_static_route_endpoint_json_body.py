...
T = TypeVar("T", bound="PostRoutingStaticRouteEndpointJsonBody")


@_attrs_define
class PostRoutingStaticRouteEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routing_static_route_endpoint_json_body = cls(
            network=network,
            gateway=gateway,
            descr=descr,
            disabled=disabled,
        ...
        post_routing_static_route_endpoint_json_body.additional_properties = d
        return post_routing_static_route_endpoint_json_body
