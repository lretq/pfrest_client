...
T = TypeVar("T", bound="PostServicesDHCPServerAddressPoolEndpointJsonBody")


@_attrs_define
class PostServicesDHCPServerAddressPoolEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_dhcp_server_address_pool_endpoint_json_body = cls(
            range_from=range_from,
            range_to=range_to,
            parent_id=parent_id,
            domain=domain,
        ...
        post_services_dhcp_server_address_pool_endpoint_json_body.additional_properties = d
        return post_services_dhcp_server_address_pool_endpoint_json_body
