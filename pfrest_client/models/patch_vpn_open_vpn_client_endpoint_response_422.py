...
T = TypeVar("T", bound="PatchVPNOpenVPNClientEndpointResponse422")


@_attrs_define
class PatchVPNOpenVPNClientEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_open_vpn_client_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_vpn_open_vpn_client_endpoint_response_422.additional_properties = d
        return patch_vpn_open_vpn_client_endpoint_response_422
