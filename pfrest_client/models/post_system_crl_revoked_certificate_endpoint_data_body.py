...
T = TypeVar("T", bound="PostSystemCRLRevokedCertificateEndpointDataBody")


@_attrs_define
class PostSystemCRLRevokedCertificateEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_crl_revoked_certificate_endpoint_data_body = cls(
            certref=certref,
            revoke_time=revoke_time,
            parent_id=parent_id,
            serial=serial,
        ...
        post_system_crl_revoked_certificate_endpoint_data_body.additional_properties = d
        return post_system_crl_revoked_certificate_endpoint_data_body
