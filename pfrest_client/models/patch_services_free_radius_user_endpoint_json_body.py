...
T = TypeVar("T", bound="PatchServicesFreeRADIUSUserEndpointJsonBody")


@_attrs_define
class PatchServicesFreeRADIUSUserEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_free_radius_user_endpoint_json_body = cls(
            id=id,
            username=username,
            password=password,
        ...
        patch_services_free_radius_user_endpoint_json_body.additional_properties = d
        return patch_services_free_radius_user_endpoint_json_body
