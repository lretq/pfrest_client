...
T = TypeVar("T", bound="GetUserAuthServersEndpointResponse406")


@_attrs_define
class GetUserAuthServersEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_auth_servers_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_user_auth_servers_endpoint_response_406.additional_properties = d
        return get_user_auth_servers_endpoint_response_406
