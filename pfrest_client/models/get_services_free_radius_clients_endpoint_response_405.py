...
T = TypeVar("T", bound="GetServicesFreeRADIUSClientsEndpointResponse405")


@_attrs_define
class GetServicesFreeRADIUSClientsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_free_radius_clients_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_services_free_radius_clients_endpoint_response_405.additional_properties = d
        return get_services_free_radius_clients_endpoint_response_405
