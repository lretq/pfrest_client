...
T = TypeVar("T", bound="GetServicesFreeRADIUSUserEndpointResponse405")


@_attrs_define
class GetServicesFreeRADIUSUserEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_free_radius_user_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_services_free_radius_user_endpoint_response_405.additional_properties = d
        return get_services_free_radius_user_endpoint_response_405
