...
T = TypeVar("T", bound="DeleteUsersEndpointResponse422")


@_attrs_define
class DeleteUsersEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_users_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_users_endpoint_response_422.additional_properties = d
        return delete_users_endpoint_response_422
