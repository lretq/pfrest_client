...
T = TypeVar("T", bound="PostFirewallTrafficShaperQueueEndpointResponse406")


@_attrs_define
class PostFirewallTrafficShaperQueueEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_queue_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_firewall_traffic_shaper_queue_endpoint_response_406.additional_properties = d
        return post_firewall_traffic_shaper_queue_endpoint_response_406
