...
T = TypeVar("T", bound="PostAuthJWTEndpointResponse422")


@_attrs_define
class PostAuthJWTEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_auth_jwt_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_auth_jwt_endpoint_response_422.additional_properties = d
        return post_auth_jwt_endpoint_response_422
