...
T = TypeVar("T", bound="PatchServicesFreeRADIUSLDAPEndpointDataBody")


@_attrs_define
class PatchServicesFreeRADIUSLDAPEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_free_radiusldap_endpoint_data_body = cls(
        ...
        patch_services_free_radiusldap_endpoint_data_body.additional_properties = d
        return patch_services_free_radiusldap_endpoint_data_body
