...
T = TypeVar("T", bound="PutServicesCronJobsEndpointDataBodyItem")


@_attrs_define
class PutServicesCronJobsEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_cron_jobs_endpoint_data_body_item = cls(
            minute=minute,
            hour=hour,
            mday=mday,
            month=month,
        ...
        put_services_cron_jobs_endpoint_data_body_item.additional_properties = d
        return put_services_cron_jobs_endpoint_data_body_item
