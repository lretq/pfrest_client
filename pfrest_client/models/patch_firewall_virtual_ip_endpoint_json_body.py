...
T = TypeVar("T", bound="PatchFirewallVirtualIPEndpointJsonBody")


@_attrs_define
class PatchFirewallVirtualIPEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_virtual_ip_endpoint_json_body = cls(
            id=id,
            uniqid=uniqid,
            mode=mode,
            interface=interface,
        ...
        patch_firewall_virtual_ip_endpoint_json_body.additional_properties = d
        return patch_firewall_virtual_ip_endpoint_json_body
