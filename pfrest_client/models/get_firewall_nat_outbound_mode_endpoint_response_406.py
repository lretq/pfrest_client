...
T = TypeVar("T", bound="GetFirewallNATOutboundModeEndpointResponse406")


@_attrs_define
class GetFirewallNATOutboundModeEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_nat_outbound_mode_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_firewall_nat_outbound_mode_endpoint_response_406.additional_properties = d
        return get_firewall_nat_outbound_mode_endpoint_response_406
