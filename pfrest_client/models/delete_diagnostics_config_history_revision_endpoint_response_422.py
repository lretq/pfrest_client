...
T = TypeVar("T", bound="DeleteDiagnosticsConfigHistoryRevisionEndpointResponse422")


@_attrs_define
class DeleteDiagnosticsConfigHistoryRevisionEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_diagnostics_config_history_revision_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_diagnostics_config_history_revision_endpoint_response_422.additional_properties = d
        return delete_diagnostics_config_history_revision_endpoint_response_422
