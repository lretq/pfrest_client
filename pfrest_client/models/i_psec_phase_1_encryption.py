...
T = TypeVar("T", bound="IPsecPhase1Encryption")


@_attrs_define
class IPsecPhase1Encryption:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        i_psec_phase_1_encryption.additional_properties = d
        return i_psec_phase_1_encryption
