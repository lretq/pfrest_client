...
T = TypeVar("T", bound="HAProxyBackendActionsItem")


@_attrs_define
class HAProxyBackendActionsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_backend_actions_item = cls(
            action=action,
            acl=acl,
            server=server,
            customaction=customaction,
        ...
        ha_proxy_backend_actions_item.additional_properties = d
        return ha_proxy_backend_actions_item
