...
T = TypeVar("T", bound="PatchVPNWireGuardPeerEndpointDataBody")


@_attrs_define
class PatchVPNWireGuardPeerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_wire_guard_peer_endpoint_data_body = cls(
            id=id,
            enabled=enabled,
            tun=tun,
            endpoint=endpoint,
        ...
        patch_vpn_wire_guard_peer_endpoint_data_body.additional_properties = d
        return patch_vpn_wire_guard_peer_endpoint_data_body
