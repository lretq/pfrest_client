...
T = TypeVar("T", bound="CertificateAuthorityRenew")


@_attrs_define
class CertificateAuthorityRenew:
    """
    Attributes:
        caref (str | Unset): The Certificate Authority to renew.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        certificate_authority_renew = cls(
            caref=caref,
            reusekey=reusekey,
        ...
        certificate_authority_renew.additional_properties = d
        return certificate_authority_renew
