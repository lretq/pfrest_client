...
T = TypeVar("T", bound="PatchFirewallNATOutboundMappingEndpointJsonBody")


@_attrs_define
class PatchFirewallNATOutboundMappingEndpointJsonBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        interface (str | Unset): The interface on which traffic is matched as it exits the firewall. In most cases this
            is a WAN-type or another externally-connected interface.<br>
        ...
        source (str | Unset): The source network this rule should match. Valid value options are: an existing interface,
            a subnet CIDR, an existing alias, `any`, `(self)`, `pppoe`. The context of this address can be inverted by
        ...
        destination (str | Unset): The destination network this rule should match. Valid value options are: an existing
        ...
        target (str | Unset): The target network traffic matching this rule should be translated to. Valid value options
            are: an IP address, an existing alias. For interface values, the `:ip`  modifier can be appended to the value to
            use the interface's IP address instead of its entire subnet.<br><br>This field is only available when the
            following conditions are met:<br>- `nonat` must be equal to `false`<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_nat_outbound_mapping_endpoint_json_body = cls(
            id=id,
            interface=interface,
            protocol=protocol,
            disabled=disabled,
        ...
        patch_firewall_nat_outbound_mapping_endpoint_json_body.additional_properties = d
        return patch_firewall_nat_outbound_mapping_endpoint_json_body
