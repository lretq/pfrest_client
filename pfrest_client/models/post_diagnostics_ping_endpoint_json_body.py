...
T = TypeVar("T", bound="PostDiagnosticsPingEndpointJsonBody")


@_attrs_define
class PostDiagnosticsPingEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_diagnostics_ping_endpoint_json_body = cls(
            host=host,
            count=count,
        ...
        post_diagnostics_ping_endpoint_json_body.additional_properties = d
        return post_diagnostics_ping_endpoint_json_body
