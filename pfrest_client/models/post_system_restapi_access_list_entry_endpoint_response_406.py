...
T = TypeVar("T", bound="PostSystemRESTAPIAccessListEntryEndpointResponse406")


@_attrs_define
class PostSystemRESTAPIAccessListEntryEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_restapi_access_list_entry_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_system_restapi_access_list_entry_endpoint_response_406.additional_properties = d
        return post_system_restapi_access_list_entry_endpoint_response_406
