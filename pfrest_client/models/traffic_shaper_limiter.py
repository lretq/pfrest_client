...
T = TypeVar("T", bound="TrafficShaperLimiter")


@_attrs_define
class TrafficShaperLimiter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        traffic_shaper_limiter.additional_properties = d
        return traffic_shaper_limiter
