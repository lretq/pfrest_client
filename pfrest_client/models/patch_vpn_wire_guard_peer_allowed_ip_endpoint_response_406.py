...
T = TypeVar("T", bound="PatchVPNWireGuardPeerAllowedIPEndpointResponse406")


@_attrs_define
class PatchVPNWireGuardPeerAllowedIPEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_wire_guard_peer_allowed_ip_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_vpn_wire_guard_peer_allowed_ip_endpoint_response_406.additional_properties = d
        return patch_vpn_wire_guard_peer_allowed_ip_endpoint_response_406
