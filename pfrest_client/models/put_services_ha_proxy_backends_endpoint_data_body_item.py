...
T = TypeVar("T", bound="PutServicesHAProxyBackendsEndpointDataBodyItem")


@_attrs_define
class PutServicesHAProxyBackendsEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_ha_proxy_backends_endpoint_data_body_item = cls(
            name=name,
            agent_port=agent_port,
            persist_cookie_name=persist_cookie_name,
            servers=servers,
        ...
        put_services_ha_proxy_backends_endpoint_data_body_item.additional_properties = d
        return put_services_ha_proxy_backends_endpoint_data_body_item
