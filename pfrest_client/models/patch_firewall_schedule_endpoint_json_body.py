...
T = TypeVar("T", bound="PatchFirewallScheduleEndpointJsonBody")


@_attrs_define
class PatchFirewallScheduleEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_schedule_endpoint_json_body = cls(
            id=id,
        ...
        patch_firewall_schedule_endpoint_json_body.additional_properties = d
        return patch_firewall_schedule_endpoint_json_body
