...
T = TypeVar("T", bound="PutVPNWireGuardTunnelsEndpointJsonBodyItem")


@_attrs_define
class PutVPNWireGuardTunnelsEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_vpn_wire_guard_tunnels_endpoint_json_body_item = cls(
            privatekey=privatekey,
            name=name,
            enabled=enabled,
            descr=descr,
        ...
        put_vpn_wire_guard_tunnels_endpoint_json_body_item.additional_properties = d
        return put_vpn_wire_guard_tunnels_endpoint_json_body_item
