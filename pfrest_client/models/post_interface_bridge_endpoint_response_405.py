...
T = TypeVar("T", bound="PostInterfaceBridgeEndpointResponse405")


@_attrs_define
class PostInterfaceBridgeEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_interface_bridge_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_interface_bridge_endpoint_response_405.additional_properties = d
        return post_interface_bridge_endpoint_response_405
