...
T = TypeVar("T", bound="PostServicesDHCPServerCustomOptionEndpointResponse406")


@_attrs_define
class PostServicesDHCPServerCustomOptionEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_dhcp_server_custom_option_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_services_dhcp_server_custom_option_endpoint_response_406.additional_properties = d
        return post_services_dhcp_server_custom_option_endpoint_response_406
