...
T = TypeVar("T", bound="PostFirewallTrafficShaperLimiterEndpointJsonBody")


@_attrs_define
class PostFirewallTrafficShaperLimiterEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_limiter_endpoint_json_body = cls(
            name=name,
            aqm=aqm,
            sched=sched,
            number=number,
        ...
        post_firewall_traffic_shaper_limiter_endpoint_json_body.additional_properties = d
        return post_firewall_traffic_shaper_limiter_endpoint_json_body
