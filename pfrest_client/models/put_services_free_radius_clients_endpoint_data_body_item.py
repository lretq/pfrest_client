...
T = TypeVar("T", bound="PutServicesFreeRADIUSClientsEndpointDataBodyItem")


@_attrs_define
class PutServicesFreeRADIUSClientsEndpointDataBodyItem:
    """
    Attributes:
        addr (str): The IP address or network of the RADIUS client(s) in CIDR notation. This is the IP of the NAS
            (switch, access point, firewall, router, etc.)<br>
        shortname (str): A short name for the client. This is generally the hostname of the NAS.<br>
        secret (str): This is the shared secret (password) which the NAS (switch, accesspoint, etc.) needs to
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_free_radius_clients_endpoint_data_body_item = cls(
            addr=addr,
            shortname=shortname,
            secret=secret,
        ...
        put_services_free_radius_clients_endpoint_data_body_item.additional_properties = d
        return put_services_free_radius_clients_endpoint_data_body_item
