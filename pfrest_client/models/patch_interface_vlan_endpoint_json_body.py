...
T = TypeVar("T", bound="PatchInterfaceVLANEndpointJsonBody")


@_attrs_define
class PatchInterfaceVLANEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_vlan_endpoint_json_body = cls(
            id=id,
            if_=if_,
            tag=tag,
            vlanif=vlanif,
        ...
        patch_interface_vlan_endpoint_json_body.additional_properties = d
        return patch_interface_vlan_endpoint_json_body
