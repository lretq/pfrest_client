...
T = TypeVar("T", bound="PatchServicesBINDSettingsEndpointDataBody")


@_attrs_define
class PatchServicesBINDSettingsEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_bind_settings_endpoint_data_body = cls(
            bind_forwarder_ips=bind_forwarder_ips,
        ...
        patch_services_bind_settings_endpoint_data_body.additional_properties = d
        return patch_services_bind_settings_endpoint_data_body
