...
T = TypeVar("T", bound="PutVPNIPsecPhase2SEndpointDataBodyItem")


@_attrs_define
class PutVPNIPsecPhase2SEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_vpni_psec_phase_2s_endpoint_data_body_item = cls(
            ikeid=ikeid,
            mode=mode,
            localid_type=localid_type,
            localid_address=localid_address,
        ...
        put_vpni_psec_phase_2s_endpoint_data_body_item.additional_properties = d
        return put_vpni_psec_phase_2s_endpoint_data_body_item
