...
T = TypeVar("T", bound="DeleteVPNIPsecPhase2EncryptionEndpointResponse406")


@_attrs_define
class DeleteVPNIPsecPhase2EncryptionEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpni_psec_phase_2_encryption_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_vpni_psec_phase_2_encryption_endpoint_response_406.additional_properties = d
        return delete_vpni_psec_phase_2_encryption_endpoint_response_406
