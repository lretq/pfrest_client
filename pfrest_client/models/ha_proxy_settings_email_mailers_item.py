...
T = TypeVar("T", bound="HAProxySettingsEmailMailersItem")


@_attrs_define
class HAProxySettingsEmailMailersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_settings_email_mailers_item = cls(
            name=name,
            mailserver=mailserver,
            mailserverport=mailserverport,
        )

        ha_proxy_settings_email_mailers_item.additional_properties = d
        return ha_proxy_settings_email_mailers_item
