...
T = TypeVar("T", bound="PutVPNIPsecPhase2SEndpointResponse406")


@_attrs_define
class PutVPNIPsecPhase2SEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_vpni_psec_phase_2s_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        put_vpni_psec_phase_2s_endpoint_response_406.additional_properties = d
        return put_vpni_psec_phase_2s_endpoint_response_406
