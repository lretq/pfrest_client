...
T = TypeVar("T", bound="PostServicesFreeRADIUSMACEndpointDataBody")


@_attrs_define
class PostServicesFreeRADIUSMACEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_free_radiusmac_endpoint_data_body = cls(
            mac=mac,
        ...
        post_services_free_radiusmac_endpoint_data_body.additional_properties = d
        return post_services_free_radiusmac_endpoint_data_body
