...
T = TypeVar("T", bound="PostRoutingGatewayGroupPriorityEndpointJsonBody")


@_attrs_define
class PostRoutingGatewayGroupPriorityEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routing_gateway_group_priority_endpoint_json_body = cls(
            gateway=gateway,
            tier=tier,
            parent_id=parent_id,
        ...
        post_routing_gateway_group_priority_endpoint_json_body.additional_properties = d
        return post_routing_gateway_group_priority_endpoint_json_body
