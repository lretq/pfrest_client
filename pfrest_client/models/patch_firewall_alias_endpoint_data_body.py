...
T = TypeVar("T", bound="PatchFirewallAliasEndpointDataBody")


@_attrs_define
class PatchFirewallAliasEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_alias_endpoint_data_body = cls(
            id=id,
            name=name,
            type_=type_,
            descr=descr,
        ...
        patch_firewall_alias_endpoint_data_body.additional_properties = d
        return patch_firewall_alias_endpoint_data_body
