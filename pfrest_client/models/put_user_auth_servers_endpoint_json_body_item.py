...
T = TypeVar("T", bound="PutUserAuthServersEndpointJsonBodyItem")


@_attrs_define
class PutUserAuthServersEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_user_auth_servers_endpoint_json_body_item = cls(
            type_=type_,
            name=name,
            host=host,
            ldap_port=ldap_port,
        ...
        put_user_auth_servers_endpoint_json_body_item.additional_properties = d
        return put_user_auth_servers_endpoint_json_body_item
