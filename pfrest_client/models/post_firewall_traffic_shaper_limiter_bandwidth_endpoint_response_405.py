...
T = TypeVar("T", bound="PostFirewallTrafficShaperLimiterBandwidthEndpointResponse405")


@_attrs_define
class PostFirewallTrafficShaperLimiterBandwidthEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_limiter_bandwidth_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_firewall_traffic_shaper_limiter_bandwidth_endpoint_response_405.additional_properties = d
        return post_firewall_traffic_shaper_limiter_bandwidth_endpoint_response_405
