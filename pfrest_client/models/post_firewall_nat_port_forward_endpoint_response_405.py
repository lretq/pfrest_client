...
T = TypeVar("T", bound="PostFirewallNATPortForwardEndpointResponse405")


@_attrs_define
class PostFirewallNATPortForwardEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_nat_port_forward_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_firewall_nat_port_forward_endpoint_response_405.additional_properties = d
        return post_firewall_nat_port_forward_endpoint_response_405
