...
T = TypeVar("T", bound="PatchSystemRESTAPISettingsEndpointDataBody")


@_attrs_define
class PatchSystemRESTAPISettingsEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_restapi_settings_endpoint_data_body = cls(
            enabled=enabled,
            read_only=read_only,
        ...
        patch_system_restapi_settings_endpoint_data_body.additional_properties = d
        return patch_system_restapi_settings_endpoint_data_body
