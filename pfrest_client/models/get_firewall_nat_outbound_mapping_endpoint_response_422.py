...
T = TypeVar("T", bound="GetFirewallNATOutboundMappingEndpointResponse422")


@_attrs_define
class GetFirewallNATOutboundMappingEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_nat_outbound_mapping_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_firewall_nat_outbound_mapping_endpoint_response_422.additional_properties = d
        return get_firewall_nat_outbound_mapping_endpoint_response_422
