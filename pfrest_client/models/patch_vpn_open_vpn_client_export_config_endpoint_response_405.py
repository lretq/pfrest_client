...
T = TypeVar("T", bound="PatchVPNOpenVPNClientExportConfigEndpointResponse405")


@_attrs_define
class PatchVPNOpenVPNClientExportConfigEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_open_vpn_client_export_config_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_vpn_open_vpn_client_export_config_endpoint_response_405.additional_properties = d
        return patch_vpn_open_vpn_client_export_config_endpoint_response_405
