...
T = TypeVar("T", bound="PutVPNWireGuardPeersEndpointJsonBodyItem")


@_attrs_define
class PutVPNWireGuardPeersEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_vpn_wire_guard_peers_endpoint_json_body_item = cls(
            publickey=publickey,
            enabled=enabled,
            tun=tun,
            endpoint=endpoint,
        ...
        put_vpn_wire_guard_peers_endpoint_json_body_item.additional_properties = d
        return put_vpn_wire_guard_peers_endpoint_json_body_item
