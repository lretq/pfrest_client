...
T = TypeVar("T", bound="PostServicesHAProxySettingsDNSResolverEndpointResponse422")


@_attrs_define
class PostServicesHAProxySettingsDNSResolverEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_settings_dns_resolver_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_services_ha_proxy_settings_dns_resolver_endpoint_response_422.additional_properties = d
        return post_services_ha_proxy_settings_dns_resolver_endpoint_response_422
