...
T = TypeVar("T", bound="PutServicesFreeRADIUSMACsEndpointDataBodyItem")


@_attrs_define
class PutServicesFreeRADIUSMACsEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_free_radiusma_cs_endpoint_data_body_item = cls(
            mac=mac,
        ...
        put_services_free_radiusma_cs_endpoint_data_body_item.additional_properties = d
        return put_services_free_radiusma_cs_endpoint_data_body_item
