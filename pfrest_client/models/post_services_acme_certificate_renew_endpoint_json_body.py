...
T = TypeVar("T", bound="PostServicesACMECertificateRenewEndpointJsonBody")


@_attrs_define
class PostServicesACMECertificateRenewEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_acme_certificate_renew_endpoint_json_body = cls(
            certificate=certificate,
            status=status,
        ...
        post_services_acme_certificate_renew_endpoint_json_body.additional_properties = d
        return post_services_acme_certificate_renew_endpoint_json_body
