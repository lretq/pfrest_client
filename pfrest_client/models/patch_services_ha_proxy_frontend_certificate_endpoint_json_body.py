...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendCertificateEndpointJsonBody")


@_attrs_define
class PatchServicesHAProxyFrontendCertificateEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_frontend_certificate_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            ssl_certificate=ssl_certificate,
        )

        patch_services_ha_proxy_frontend_certificate_endpoint_json_body.additional_properties = d
        return patch_services_ha_proxy_frontend_certificate_endpoint_json_body
