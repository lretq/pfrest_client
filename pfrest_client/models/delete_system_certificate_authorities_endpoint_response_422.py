...
T = TypeVar("T", bound="DeleteSystemCertificateAuthoritiesEndpointResponse422")


@_attrs_define
class DeleteSystemCertificateAuthoritiesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_system_certificate_authorities_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_system_certificate_authorities_endpoint_response_422.additional_properties = d
        return delete_system_certificate_authorities_endpoint_response_422
