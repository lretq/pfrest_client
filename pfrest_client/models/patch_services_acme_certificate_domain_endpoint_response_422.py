...
T = TypeVar("T", bound="PatchServicesACMECertificateDomainEndpointResponse422")


@_attrs_define
class PatchServicesACMECertificateDomainEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_acme_certificate_domain_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_services_acme_certificate_domain_endpoint_response_422.additional_properties = d
        return patch_services_acme_certificate_domain_endpoint_response_422
