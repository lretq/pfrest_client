...
T = TypeVar("T", bound="DeleteServicesDHCPServerCustomOptionsEndpointResponse406")


@_attrs_define
class DeleteServicesDHCPServerCustomOptionsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_dhcp_server_custom_options_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_services_dhcp_server_custom_options_endpoint_response_406.additional_properties = d
        return delete_services_dhcp_server_custom_options_endpoint_response_406
