...
T = TypeVar("T", bound="PatchRoutingStaticRouteEndpointResponse422")


@_attrs_define
class PatchRoutingStaticRouteEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_routing_static_route_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_routing_static_route_endpoint_response_422.additional_properties = d
        return patch_routing_static_route_endpoint_response_422
