...
T = TypeVar("T", bound="PutFirewallRulesEndpointDataBodyItem")


@_attrs_define
class PutFirewallRulesEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_rules_endpoint_data_body_item = cls(
            type_=type_,
            interface=interface,
            ipprotocol=ipprotocol,
            source=source,
        ...
        put_firewall_rules_endpoint_data_body_item.additional_properties = d
        return put_firewall_rules_endpoint_data_body_item
