...
T = TypeVar("T", bound="PostFirewallRuleEndpointResponse406")


@_attrs_define
class PostFirewallRuleEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_rule_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_firewall_rule_endpoint_response_406.additional_properties = d
        return post_firewall_rule_endpoint_response_406
