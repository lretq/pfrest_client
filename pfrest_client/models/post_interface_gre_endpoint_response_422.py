...
T = TypeVar("T", bound="PostInterfaceGREEndpointResponse422")


@_attrs_define
class PostInterfaceGREEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_interface_gre_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_interface_gre_endpoint_response_422.additional_properties = d
        return post_interface_gre_endpoint_response_422
