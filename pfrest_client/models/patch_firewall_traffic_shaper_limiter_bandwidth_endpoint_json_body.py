...
T = TypeVar("T", bound="PatchFirewallTrafficShaperLimiterBandwidthEndpointJsonBody")


@_attrs_define
class PatchFirewallTrafficShaperLimiterBandwidthEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_traffic_shaper_limiter_bandwidth_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            bw=bw,
            bwscale=bwscale,
        ...
        patch_firewall_traffic_shaper_limiter_bandwidth_endpoint_json_body.additional_properties = d
        return patch_firewall_traffic_shaper_limiter_bandwidth_endpoint_json_body
