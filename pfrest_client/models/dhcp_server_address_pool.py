...
T = TypeVar("T", bound="DHCPServerAddressPool")


@_attrs_define
class DHCPServerAddressPool:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dhcp_server_address_pool.additional_properties = d
        return dhcp_server_address_pool
