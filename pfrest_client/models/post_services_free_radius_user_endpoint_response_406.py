...
T = TypeVar("T", bound="PostServicesFreeRADIUSUserEndpointResponse406")


@_attrs_define
class PostServicesFreeRADIUSUserEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_free_radius_user_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_services_free_radius_user_endpoint_response_406.additional_properties = d
        return post_services_free_radius_user_endpoint_response_406
