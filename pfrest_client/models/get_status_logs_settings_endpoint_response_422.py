...
T = TypeVar("T", bound="GetStatusLogsSettingsEndpointResponse422")


@_attrs_define
class GetStatusLogsSettingsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_status_logs_settings_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_status_logs_settings_endpoint_response_422.additional_properties = d
        return get_status_logs_settings_endpoint_response_422
