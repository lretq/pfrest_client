...
T = TypeVar("T", bound="PatchFirewallNATOutboundModeEndpointJsonBody")


@_attrs_define
class PatchFirewallNATOutboundModeEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_nat_outbound_mode_endpoint_json_body = cls(
            mode=mode,
        )

        patch_firewall_nat_outbound_mode_endpoint_json_body.additional_properties = d
        return patch_firewall_nat_outbound_mode_endpoint_json_body
