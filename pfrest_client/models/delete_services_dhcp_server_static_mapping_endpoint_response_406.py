...
T = TypeVar("T", bound="DeleteServicesDHCPServerStaticMappingEndpointResponse406")


@_attrs_define
class DeleteServicesDHCPServerStaticMappingEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_dhcp_server_static_mapping_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_services_dhcp_server_static_mapping_endpoint_response_406.additional_properties = d
        return delete_services_dhcp_server_static_mapping_endpoint_response_406
