...
T = TypeVar("T", bound="PostServicesHAProxyFileEndpointJsonBody")


@_attrs_define
class PostServicesHAProxyFileEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_file_endpoint_json_body = cls(
            name=name,
            content=content,
            type_=type_,
        )

        post_services_ha_proxy_file_endpoint_json_body.additional_properties = d
        return post_services_ha_proxy_file_endpoint_json_body
