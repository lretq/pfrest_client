...
T = TypeVar("T", bound="IPsecPhase1EncryptionItem")


@_attrs_define
class IPsecPhase1EncryptionItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        i_psec_phase_1_encryption_item = cls(
            encryption_algorithm_name=encryption_algorithm_name,
            encryption_algorithm_keylen=encryption_algorithm_keylen,
            hash_algorithm=hash_algorithm,
            dhgroup=dhgroup,
        ...
        i_psec_phase_1_encryption_item.additional_properties = d
        return i_psec_phase_1_encryption_item
