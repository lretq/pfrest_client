...
T = TypeVar("T", bound="PostFirewallTrafficShaperLimiterQueueEndpointJsonBody")


@_attrs_define
class PostFirewallTrafficShaperLimiterQueueEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_limiter_queue_endpoint_json_body = cls(
            name=name,
            aqm=aqm,
            parent_id=parent_id,
            number=number,
        ...
        post_firewall_traffic_shaper_limiter_queue_endpoint_json_body.additional_properties = d
        return post_firewall_traffic_shaper_limiter_queue_endpoint_json_body
