...
T = TypeVar("T", bound="PatchServicesBINDZoneEndpointDataBody")


@_attrs_define
class PatchServicesBINDZoneEndpointDataBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        disabled (bool | Unset): Disable this BIND zone.<br>
        name (str | Unset): The name of this BIND zone.<br>
        ...
        forwarders (list[str] | Unset): The forwarders for this BIND zone.<br><br>This field is only available when the
        ...
        ttl (int | None | Unset): The default TTL interval (in seconds) for records within this BIND zone without a
            ...
            equal to `'master'`<br>
        baseip (str | Unset): The IP address of the base domain for this zone. This sets an A record for the base
            domain.<br><br>This field is only available when the following conditions are met:<br>- `type` must be equal to
            `'master'`<br>
        nameserver (str | Unset): The SOA nameserver for this zone.<br><br>This field is only available when the
            following conditions are met:<br>- `type` must be one of [ master, redirect ]<br>
        mail (str | Unset): The SOA email address (RNAME) for this zone. This must be in an FQDN format.<br><br>This
            field is only available when the following conditions are met:<br>- `type` must be one of [ master, redirect
            ]<br>
        serial (int | Unset): The SOA serial number for this zone.<br><br>This field is only available when the
            following conditions are met:<br>- `type` must be one of [ master, redirect ]<br>
    ...
    forwarders: list[str] | Unset = UNSET
    ttl: int | None | Unset = UNSET
    baseip: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        forwarders: list[str] | Unset = UNSET
        if not isinstance(self.forwarders, Unset):
        ...
        if forwarders is not UNSET:
            field_dict["forwarders"] = forwarders
        if ttl is not UNSET:
            field_dict["ttl"] = ttl
        if baseip is not UNSET:
            field_dict["baseip"] = baseip
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        forwarders = cast(list[str], d.pop("forwarders", UNSET))
        ...
        patch_services_bind_zone_endpoint_data_body = cls(
            id=id,
            disabled=disabled,
            name=name,
        ...
        patch_services_bind_zone_endpoint_data_body.additional_properties = d
        return patch_services_bind_zone_endpoint_data_body
