...
T = TypeVar("T", bound="GetServicesHAProxySettingsEndpointResponse405")


@_attrs_define
class GetServicesHAProxySettingsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_ha_proxy_settings_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_services_ha_proxy_settings_endpoint_response_405.additional_properties = d
        return get_services_ha_proxy_settings_endpoint_response_405
