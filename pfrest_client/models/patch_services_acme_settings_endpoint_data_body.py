...
T = TypeVar("T", bound="PatchServicesACMESettingsEndpointDataBody")


@_attrs_define
class PatchServicesACMESettingsEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_acme_settings_endpoint_data_body = cls(
            enable=enable,
            writecerts=writecerts,
        )

        patch_services_acme_settings_endpoint_data_body.additional_properties = d
        return patch_services_acme_settings_endpoint_data_body
