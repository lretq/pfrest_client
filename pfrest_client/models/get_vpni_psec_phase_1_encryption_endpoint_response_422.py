...
T = TypeVar("T", bound="GetVPNIPsecPhase1EncryptionEndpointResponse422")


@_attrs_define
class GetVPNIPsecPhase1EncryptionEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpni_psec_phase_1_encryption_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_vpni_psec_phase_1_encryption_endpoint_response_422.additional_properties = d
        return get_vpni_psec_phase_1_encryption_endpoint_response_422
