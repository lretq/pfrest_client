...
T = TypeVar("T", bound="PostFirewallTrafficShaperLimiterQueueEndpointDataBody")


@_attrs_define
class PostFirewallTrafficShaperLimiterQueueEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_limiter_queue_endpoint_data_body = cls(
            name=name,
            aqm=aqm,
            parent_id=parent_id,
            number=number,
        ...
        post_firewall_traffic_shaper_limiter_queue_endpoint_data_body.additional_properties = d
        return post_firewall_traffic_shaper_limiter_queue_endpoint_data_body
