...
T = TypeVar("T", bound="PostVPNOpenVPNServerEndpointDataBody")


@_attrs_define
class PostVPNOpenVPNServerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_open_vpn_server_endpoint_data_body = cls(
            mode=mode,
            dev_mode=dev_mode,
            protocol=protocol,
            interface=interface,
        ...
        post_vpn_open_vpn_server_endpoint_data_body.additional_properties = d
        return post_vpn_open_vpn_server_endpoint_data_body
