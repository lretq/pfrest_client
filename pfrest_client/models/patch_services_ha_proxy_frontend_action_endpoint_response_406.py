...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendActionEndpointResponse406")


@_attrs_define
class PatchServicesHAProxyFrontendActionEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_frontend_action_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_services_ha_proxy_frontend_action_endpoint_response_406.additional_properties = d
        return patch_services_ha_proxy_frontend_action_endpoint_response_406
