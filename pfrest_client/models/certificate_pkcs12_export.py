...
T = TypeVar("T", bound="CertificatePKCS12Export")


@_attrs_define
class CertificatePKCS12Export:
    """
    Attributes:
        certref (str | Unset): The Certificate to export as a PKCS12 file.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        certificate_pkcs12_export.additional_properties = d
        return certificate_pkcs12_export
