...
T = TypeVar("T", bound="DeleteServicesHAProxySettingsDNSResolversEndpointResponse405")


@_attrs_define
class DeleteServicesHAProxySettingsDNSResolversEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_ha_proxy_settings_dns_resolvers_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_services_ha_proxy_settings_dns_resolvers_endpoint_response_405.additional_properties = d
        return delete_services_ha_proxy_settings_dns_resolvers_endpoint_response_405
