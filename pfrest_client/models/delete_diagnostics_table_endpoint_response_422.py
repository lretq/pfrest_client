...
T = TypeVar("T", bound="DeleteDiagnosticsTableEndpointResponse422")


@_attrs_define
class DeleteDiagnosticsTableEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_diagnostics_table_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_diagnostics_table_endpoint_response_422.additional_properties = d
        return delete_diagnostics_table_endpoint_response_422
