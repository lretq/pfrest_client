...
T = TypeVar("T", bound="DNSResolverDomainOverride")


@_attrs_define
class DNSResolverDomainOverride:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dns_resolver_domain_override = cls(
            domain=domain,
            ip=ip,
            descr=descr,
        ...
        dns_resolver_domain_override.additional_properties = d
        return dns_resolver_domain_override
