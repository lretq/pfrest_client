...
T = TypeVar("T", bound="PutServicesBINDAccessListsEndpointJsonBodyItem")


@_attrs_define
class PutServicesBINDAccessListsEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_bind_access_lists_endpoint_json_body_item = cls(
            name=name,
            entries=entries,
            description=description,
        )

        put_services_bind_access_lists_endpoint_json_body_item.additional_properties = d
        return put_services_bind_access_lists_endpoint_json_body_item
