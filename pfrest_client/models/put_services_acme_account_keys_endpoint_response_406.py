...
T = TypeVar("T", bound="PutServicesACMEAccountKeysEndpointResponse406")


@_attrs_define
class PutServicesACMEAccountKeysEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_acme_account_keys_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        put_services_acme_account_keys_endpoint_response_406.additional_properties = d
        return put_services_acme_account_keys_endpoint_response_406
