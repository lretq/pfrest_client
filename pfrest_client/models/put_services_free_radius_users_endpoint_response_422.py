...
T = TypeVar("T", bound="PutServicesFreeRADIUSUsersEndpointResponse422")


@_attrs_define
class PutServicesFreeRADIUSUsersEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_free_radius_users_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_services_free_radius_users_endpoint_response_422.additional_properties = d
        return put_services_free_radius_users_endpoint_response_422
