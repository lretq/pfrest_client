...
T = TypeVar("T", bound="PatchServicesDNSResolverDomainOverrideEndpointResponse422")


@_attrs_define
class PatchServicesDNSResolverDomainOverrideEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dns_resolver_domain_override_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_services_dns_resolver_domain_override_endpoint_response_422.additional_properties = d
        return patch_services_dns_resolver_domain_override_endpoint_response_422
