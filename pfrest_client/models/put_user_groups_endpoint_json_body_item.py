...
T = TypeVar("T", bound="PutUserGroupsEndpointJsonBodyItem")


@_attrs_define
class PutUserGroupsEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_user_groups_endpoint_json_body_item = cls(
            name=name,
            gid=gid,
            scope=scope,
        ...
        put_user_groups_endpoint_json_body_item.additional_properties = d
        return put_user_groups_endpoint_json_body_item
