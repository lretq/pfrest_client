...
T = TypeVar("T", bound="HAProxyFrontendCertificate")


@_attrs_define
class HAProxyFrontendCertificate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_frontend_certificate = cls(
            ssl_certificate=ssl_certificate,
        )

        ha_proxy_frontend_certificate.additional_properties = d
        return ha_proxy_frontend_certificate
