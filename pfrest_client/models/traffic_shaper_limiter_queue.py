...
T = TypeVar("T", bound="TrafficShaperLimiterQueue")


@_attrs_define
class TrafficShaperLimiterQueue:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        traffic_shaper_limiter_queue = cls(
            name=name,
            number=number,
            enabled=enabled,
            mask=mask,
        ...
        traffic_shaper_limiter_queue.additional_properties = d
        return traffic_shaper_limiter_queue
