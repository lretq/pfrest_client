...
T = TypeVar("T", bound="PatchServicesACMECertificateActionEndpointJsonBody")


@_attrs_define
class PatchServicesACMECertificateActionEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_acme_certificate_action_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            status=status,
            command=command,
        ...
        patch_services_acme_certificate_action_endpoint_json_body.additional_properties = d
        return patch_services_acme_certificate_action_endpoint_json_body
