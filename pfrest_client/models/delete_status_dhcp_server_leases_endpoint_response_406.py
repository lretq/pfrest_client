...
T = TypeVar("T", bound="DeleteStatusDHCPServerLeasesEndpointResponse406")


@_attrs_define
class DeleteStatusDHCPServerLeasesEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_status_dhcp_server_leases_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_status_dhcp_server_leases_endpoint_response_406.additional_properties = d
        return delete_status_dhcp_server_leases_endpoint_response_406
