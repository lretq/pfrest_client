...
T = TypeVar("T", bound="PatchServicesBINDViewEndpointJsonBody")


@_attrs_define
class PatchServicesBINDViewEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_bind_view_endpoint_json_body = cls(
            id=id,
            name=name,
            descr=descr,
            recursion=recursion,
        ...
        patch_services_bind_view_endpoint_json_body.additional_properties = d
        return patch_services_bind_view_endpoint_json_body
