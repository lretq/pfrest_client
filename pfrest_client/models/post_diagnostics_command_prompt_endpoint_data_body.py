...
T = TypeVar("T", bound="PostDiagnosticsCommandPromptEndpointDataBody")


@_attrs_define
class PostDiagnosticsCommandPromptEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_diagnostics_command_prompt_endpoint_data_body = cls(
            command=command,
            output=output,
            result_code=result_code,
        )

        post_diagnostics_command_prompt_endpoint_data_body.additional_properties = d
        return post_diagnostics_command_prompt_endpoint_data_body
