...
T = TypeVar("T", bound="PatchFirewallNATOutboundModeEndpointResponse405")


@_attrs_define
class PatchFirewallNATOutboundModeEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_nat_outbound_mode_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_firewall_nat_outbound_mode_endpoint_response_405.additional_properties = d
        return patch_firewall_nat_outbound_mode_endpoint_response_405
