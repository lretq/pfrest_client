...
T = TypeVar("T", bound="PatchSystemHostnameEndpointResponse422")


@_attrs_define
class PatchSystemHostnameEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_hostname_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_system_hostname_endpoint_response_422.additional_properties = d
        return patch_system_hostname_endpoint_response_422
