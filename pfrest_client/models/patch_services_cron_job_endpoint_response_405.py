...
T = TypeVar("T", bound="PatchServicesCronJobEndpointResponse405")


@_attrs_define
class PatchServicesCronJobEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_cron_job_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_services_cron_job_endpoint_response_405.additional_properties = d
        return patch_services_cron_job_endpoint_response_405
