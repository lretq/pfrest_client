...
T = TypeVar("T", bound="IPsecSAStatusChildSasType0Item")


@_attrs_define
class IPsecSAStatusChildSasType0Item:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        i_psec_sa_status_child_sas_type_0_item = cls(
            name=name,
            uniqueid=uniqueid,
            reqid=reqid,
            state=state,
        ...
        i_psec_sa_status_child_sas_type_0_item.additional_properties = d
        return i_psec_sa_status_child_sas_type_0_item
