...
T = TypeVar("T", bound="PutServicesDNSForwarderHostOverridesEndpointResponse422")


@_attrs_define
class PutServicesDNSForwarderHostOverridesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_dns_forwarder_host_overrides_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_services_dns_forwarder_host_overrides_endpoint_response_422.additional_properties = d
        return put_services_dns_forwarder_host_overrides_endpoint_response_422
