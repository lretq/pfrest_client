...
T = TypeVar("T", bound="DeleteServicesHAProxyFrontendCertificatesEndpointResponse422")


@_attrs_define
class DeleteServicesHAProxyFrontendCertificatesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_ha_proxy_frontend_certificates_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_services_ha_proxy_frontend_certificates_endpoint_response_422.additional_properties = d
        return delete_services_ha_proxy_frontend_certificates_endpoint_response_422
