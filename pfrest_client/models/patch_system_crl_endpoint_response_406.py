...
T = TypeVar("T", bound="PatchSystemCRLEndpointResponse406")


@_attrs_define
class PatchSystemCRLEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_crl_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_system_crl_endpoint_response_406.additional_properties = d
        return patch_system_crl_endpoint_response_406
