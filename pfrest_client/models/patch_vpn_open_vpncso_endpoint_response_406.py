...
T = TypeVar("T", bound="PatchVPNOpenVPNCSOEndpointResponse406")


@_attrs_define
class PatchVPNOpenVPNCSOEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_open_vpncso_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_vpn_open_vpncso_endpoint_response_406.additional_properties = d
        return patch_vpn_open_vpncso_endpoint_response_406
