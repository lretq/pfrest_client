...
T = TypeVar("T", bound="PatchVPNIPsecPhase1EndpointJsonBody")


@_attrs_define
class PatchVPNIPsecPhase1EndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpni_psec_phase_1_endpoint_json_body = cls(
            id=id,
            ikeid=ikeid,
            descr=descr,
            disabled=disabled,
        ...
        patch_vpni_psec_phase_1_endpoint_json_body.additional_properties = d
        return patch_vpni_psec_phase_1_endpoint_json_body
