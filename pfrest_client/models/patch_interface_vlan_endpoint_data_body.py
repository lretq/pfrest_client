...
T = TypeVar("T", bound="PatchInterfaceVLANEndpointDataBody")


@_attrs_define
class PatchInterfaceVLANEndpointDataBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        if_ (str | Unset): The real parent interface this VLAN will be applied to.<br>
        tag (int | Unset): The VLAN ID tag to use. This must be unique from all other VLANs on the parent interface.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_interface_vlan_endpoint_data_body = cls(
            id=id,
            if_=if_,
            tag=tag,
            vlanif=vlanif,
        ...
        patch_interface_vlan_endpoint_data_body.additional_properties = d
        return patch_interface_vlan_endpoint_data_body
