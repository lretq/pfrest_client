...
T = TypeVar("T", bound="PostInterfaceGroupEndpointJsonBody")


@_attrs_define
class PostInterfaceGroupEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_interface_group_endpoint_json_body = cls(
            ifname=ifname,
            members=members,
            descr=descr,
        )

        post_interface_group_endpoint_json_body.additional_properties = d
        return post_interface_group_endpoint_json_body
