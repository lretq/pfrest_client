...
T = TypeVar("T", bound="PatchRoutingGatewayGroupPriorityEndpointResponse405")


@_attrs_define
class PatchRoutingGatewayGroupPriorityEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_routing_gateway_group_priority_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_routing_gateway_group_priority_endpoint_response_405.additional_properties = d
        return patch_routing_gateway_group_priority_endpoint_response_405
