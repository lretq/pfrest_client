...
T = TypeVar("T", bound="PatchServicesBINDAccessListEndpointJsonBody")


@_attrs_define
class PatchServicesBINDAccessListEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_bind_access_list_endpoint_json_body = cls(
            id=id,
            name=name,
        ...
        patch_services_bind_access_list_endpoint_json_body.additional_properties = d
        return patch_services_bind_access_list_endpoint_json_body
