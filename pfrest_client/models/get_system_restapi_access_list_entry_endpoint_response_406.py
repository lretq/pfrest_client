...
T = TypeVar("T", bound="GetSystemRESTAPIAccessListEntryEndpointResponse406")


@_attrs_define
class GetSystemRESTAPIAccessListEntryEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_restapi_access_list_entry_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_system_restapi_access_list_entry_endpoint_response_406.additional_properties = d
        return get_system_restapi_access_list_entry_endpoint_response_406
