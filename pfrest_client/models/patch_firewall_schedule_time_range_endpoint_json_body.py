...
T = TypeVar("T", bound="PatchFirewallScheduleTimeRangeEndpointJsonBody")


@_attrs_define
class PatchFirewallScheduleTimeRangeEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_schedule_time_range_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            position=position,
            month=month,
        ...
        patch_firewall_schedule_time_range_endpoint_json_body.additional_properties = d
        return patch_firewall_schedule_time_range_endpoint_json_body
