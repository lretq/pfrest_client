...
T = TypeVar("T", bound="PostAuthKeyEndpointJsonBody")


@_attrs_define
class PostAuthKeyEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_auth_key_endpoint_json_body = cls(
            descr=descr,
            username=username,
            hash_algo=hash_algo,
        ...
        post_auth_key_endpoint_json_body.additional_properties = d
        return post_auth_key_endpoint_json_body
