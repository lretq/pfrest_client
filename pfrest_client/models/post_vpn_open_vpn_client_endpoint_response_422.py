...
T = TypeVar("T", bound="PostVPNOpenVPNClientEndpointResponse422")


@_attrs_define
class PostVPNOpenVPNClientEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_open_vpn_client_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_vpn_open_vpn_client_endpoint_response_422.additional_properties = d
        return post_vpn_open_vpn_client_endpoint_response_422
