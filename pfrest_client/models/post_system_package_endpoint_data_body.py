...
T = TypeVar("T", bound="PostSystemPackageEndpointDataBody")


@_attrs_define
class PostSystemPackageEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_package_endpoint_data_body = cls(
            name=name,
            shortname=shortname,
            descr=descr,
        ...
        post_system_package_endpoint_data_body.additional_properties = d
        return post_system_package_endpoint_data_body
