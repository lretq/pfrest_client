...
T = TypeVar("T", bound="PatchUserGroupEndpointDataBody")


@_attrs_define
class PatchUserGroupEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_user_group_endpoint_data_body = cls(
            id=id,
            name=name,
            gid=gid,
            scope=scope,
        ...
        patch_user_group_endpoint_data_body.additional_properties = d
        return patch_user_group_endpoint_data_body
