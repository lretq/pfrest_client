...
T = TypeVar("T", bound="PostUserGroupEndpointDataBody")


@_attrs_define
class PostUserGroupEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_user_group_endpoint_data_body = cls(
            name=name,
            gid=gid,
            scope=scope,
        ...
        post_user_group_endpoint_data_body.additional_properties = d
        return post_user_group_endpoint_data_body
