...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendActionEndpointJsonBody")


@_attrs_define
class PatchServicesHAProxyFrontendActionEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_frontend_action_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            action=action,
            acl=acl,
        ...
        patch_services_ha_proxy_frontend_action_endpoint_json_body.additional_properties = d
        return patch_services_ha_proxy_frontend_action_endpoint_json_body
