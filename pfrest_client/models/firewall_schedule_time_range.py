...
T = TypeVar("T", bound="FirewallScheduleTimeRange")


@_attrs_define
class FirewallScheduleTimeRange:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        firewall_schedule_time_range = cls(
            position=position,
            month=month,
            day=day,
            hour=hour,
        ...
        firewall_schedule_time_range.additional_properties = d
        return firewall_schedule_time_range
