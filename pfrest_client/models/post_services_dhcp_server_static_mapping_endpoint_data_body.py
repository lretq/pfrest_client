...
T = TypeVar("T", bound="PostServicesDHCPServerStaticMappingEndpointDataBody")


@_attrs_define
class PostServicesDHCPServerStaticMappingEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_dhcp_server_static_mapping_endpoint_data_body = cls(
            mac=mac,
            parent_id=parent_id,
            ipaddr=ipaddr,
            cid=cid,
        ...
        post_services_dhcp_server_static_mapping_endpoint_data_body.additional_properties = d
        return post_services_dhcp_server_static_mapping_endpoint_data_body
