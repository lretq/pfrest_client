...
T = TypeVar("T", bound="GetServicesFreeRADIUSLDAPEndpointResponse422")


@_attrs_define
class GetServicesFreeRADIUSLDAPEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_free_radiusldap_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_services_free_radiusldap_endpoint_response_422.additional_properties = d
        return get_services_free_radiusldap_endpoint_response_422
