...
T = TypeVar("T", bound="PatchRoutingGatewayGroupPriorityEndpointJsonBody")


@_attrs_define
class PatchRoutingGatewayGroupPriorityEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_routing_gateway_group_priority_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            gateway=gateway,
            tier=tier,
        ...
        patch_routing_gateway_group_priority_endpoint_json_body.additional_properties = d
        return patch_routing_gateway_group_priority_endpoint_json_body
