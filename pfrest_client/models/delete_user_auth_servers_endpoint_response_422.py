...
T = TypeVar("T", bound="DeleteUserAuthServersEndpointResponse422")


@_attrs_define
class DeleteUserAuthServersEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_user_auth_servers_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_user_auth_servers_endpoint_response_422.additional_properties = d
        return delete_user_auth_servers_endpoint_response_422
