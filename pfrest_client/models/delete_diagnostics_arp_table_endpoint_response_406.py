...
T = TypeVar("T", bound="DeleteDiagnosticsARPTableEndpointResponse406")


@_attrs_define
class DeleteDiagnosticsARPTableEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_diagnostics_arp_table_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_diagnostics_arp_table_endpoint_response_406.additional_properties = d
        return delete_diagnostics_arp_table_endpoint_response_406
