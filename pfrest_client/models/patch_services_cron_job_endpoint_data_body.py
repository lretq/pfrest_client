...
T = TypeVar("T", bound="PatchServicesCronJobEndpointDataBody")


@_attrs_define
class PatchServicesCronJobEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_cron_job_endpoint_data_body = cls(
            id=id,
            minute=minute,
            hour=hour,
            mday=mday,
        ...
        patch_services_cron_job_endpoint_data_body.additional_properties = d
        return patch_services_cron_job_endpoint_data_body
