...
T = TypeVar("T", bound="PostServicesBINDViewEndpointJsonBody")


@_attrs_define
class PostServicesBINDViewEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_bind_view_endpoint_json_body = cls(
            name=name,
            descr=descr,
            recursion=recursion,
        ...
        post_services_bind_view_endpoint_json_body.additional_properties = d
        return post_services_bind_view_endpoint_json_body
