...
T = TypeVar("T", bound="PatchServicesSSHEndpointDataBody")


@_attrs_define
class PatchServicesSSHEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ssh_endpoint_data_body = cls(
            enable=enable,
            port=port,
        ...
        patch_services_ssh_endpoint_data_body.additional_properties = d
        return patch_services_ssh_endpoint_data_body
