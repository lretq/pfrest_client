...
T = TypeVar("T", bound="PostUserAuthServerEndpointDataBody")


@_attrs_define
class PostUserAuthServerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_user_auth_server_endpoint_data_body = cls(
            type_=type_,
            name=name,
            host=host,
            ldap_port=ldap_port,
        ...
        post_user_auth_server_endpoint_data_body.additional_properties = d
        return post_user_auth_server_endpoint_data_body
