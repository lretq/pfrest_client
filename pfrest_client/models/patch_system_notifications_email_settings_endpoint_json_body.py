...
T = TypeVar("T", bound="PatchSystemNotificationsEmailSettingsEndpointJsonBody")


@_attrs_define
class PatchSystemNotificationsEmailSettingsEndpointJsonBody:
    """
    Attributes:
        username (str): The username to use for SMTP authentication.<br><br>This field is only available when the
            following conditions are met:<br>- `authentication_mechanism` must be equal to `'LOGIN'`<br>
        password (str): The password to use for SMTP authentication.<br><br>This field is only available when the
            following conditions are met:<br>- `authentication_mechanism` must be equal to `'LOGIN'`<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_notifications_email_settings_endpoint_json_body = cls(
            username=username,
            password=password,
            disable=disable,
            ipaddress=ipaddress,
        ...
        patch_system_notifications_email_settings_endpoint_json_body.additional_properties = d
        return patch_system_notifications_email_settings_endpoint_json_body
