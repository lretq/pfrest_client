...
T = TypeVar("T", bound="PostSystemPackageEndpointResponse422")


@_attrs_define
class PostSystemPackageEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_package_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_system_package_endpoint_response_422.additional_properties = d
        return post_system_package_endpoint_response_422
