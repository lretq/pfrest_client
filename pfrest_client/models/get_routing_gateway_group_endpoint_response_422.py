...
T = TypeVar("T", bound="GetRoutingGatewayGroupEndpointResponse422")


@_attrs_define
class GetRoutingGatewayGroupEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_routing_gateway_group_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_routing_gateway_group_endpoint_response_422.additional_properties = d
        return get_routing_gateway_group_endpoint_response_422
