...
T = TypeVar("T", bound="GetInterfaceVLANEndpointResponse422")


@_attrs_define
class GetInterfaceVLANEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_interface_vlan_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_interface_vlan_endpoint_response_422.additional_properties = d
        return get_interface_vlan_endpoint_response_422
