...
T = TypeVar("T", bound="PatchVPNWireGuardPeerEndpointJsonBody")


@_attrs_define
class PatchVPNWireGuardPeerEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_wire_guard_peer_endpoint_json_body = cls(
            id=id,
            enabled=enabled,
            tun=tun,
            endpoint=endpoint,
        ...
        patch_vpn_wire_guard_peer_endpoint_json_body.additional_properties = d
        return patch_vpn_wire_guard_peer_endpoint_json_body
