...
T = TypeVar("T", bound="PatchSystemCertificateAuthorityEndpointResponse406")


@_attrs_define
class PatchSystemCertificateAuthorityEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_certificate_authority_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_system_certificate_authority_endpoint_response_406.additional_properties = d
        return patch_system_certificate_authority_endpoint_response_406
