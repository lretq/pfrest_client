...
T = TypeVar("T", bound="FirewallScheduleTimerangeItem")


@_attrs_define
class FirewallScheduleTimerangeItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        firewall_schedule_timerange_item = cls(
            month=month,
            day=day,
            hour=hour,
            position=position,
        ...
        firewall_schedule_timerange_item.additional_properties = d
        return firewall_schedule_timerange_item
