...
T = TypeVar("T", bound="GetRoutingGatewaysEndpointResponse406")


@_attrs_define
class GetRoutingGatewaysEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_routing_gateways_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_routing_gateways_endpoint_response_406.additional_properties = d
        return get_routing_gateways_endpoint_response_406
