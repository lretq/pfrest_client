...
T = TypeVar("T", bound="PatchFirewallTrafficShaperLimiterEndpointJsonBody")


@_attrs_define
class PatchFirewallTrafficShaperLimiterEndpointJsonBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        name (str | Unset): The unique name for this limiter.<br>
        ...
        aqm (TrafficShaperLimiterAqm | Unset): The Active Queue Management (AQM) algorithm to use for this limiter. AQM
            is the intelligent drop of network packets inside the limiter, when it becomes full or gets close to becoming
            full, with the goal of reducing network congestion.<br>
        sched (TrafficShaperLimiterSched | Unset): The scheduler to use for this limiter. The scheduler manages the
            sequence of network packets in the limiter's queue.<br>
    ...
    aqm: TrafficShaperLimiterAqm | Unset = UNSET
    sched: TrafficShaperLimiterSched | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        aqm: TrafficShaperLimiterAqm | Unset
        if isinstance(_aqm, Unset):
            aqm = UNSET
        else:
            aqm = TrafficShaperLimiterAqm(_aqm)

        _sched = d.pop("sched", UNSET)
        sched: TrafficShaperLimiterSched | Unset
        if isinstance(_sched, Unset):
            sched = UNSET
        else:
            sched = TrafficShaperLimiterSched(_sched)
        ...
        patch_firewall_traffic_shaper_limiter_endpoint_json_body = cls(
            id=id,
            name=name,
            number=number,
            enabled=enabled,
        ...
        patch_firewall_traffic_shaper_limiter_endpoint_json_body.additional_properties = d
        return patch_firewall_traffic_shaper_limiter_endpoint_json_body
