...
T = TypeVar("T", bound="HAProxyFrontendAActionitemsItem")


@_attrs_define
class HAProxyFrontendAActionitemsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_frontend_a_actionitems_item = cls(
            action=action,
            acl=acl,
            backend=backend,
            customaction=customaction,
        ...
        ha_proxy_frontend_a_actionitems_item.additional_properties = d
        return ha_proxy_frontend_a_actionitems_item
