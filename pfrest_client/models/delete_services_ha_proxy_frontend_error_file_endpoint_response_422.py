...
T = TypeVar("T", bound="DeleteServicesHAProxyFrontendErrorFileEndpointResponse422")


@_attrs_define
class DeleteServicesHAProxyFrontendErrorFileEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_ha_proxy_frontend_error_file_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_services_ha_proxy_frontend_error_file_endpoint_response_422.additional_properties = d
        return delete_services_ha_proxy_frontend_error_file_endpoint_response_422
