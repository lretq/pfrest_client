...
T = TypeVar("T", bound="PatchFirewallVirtualIPEndpointResponse422")


@_attrs_define
class PatchFirewallVirtualIPEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_virtual_ip_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_firewall_virtual_ip_endpoint_response_422.additional_properties = d
        return patch_firewall_virtual_ip_endpoint_response_422
