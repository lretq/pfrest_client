...
T = TypeVar("T", bound="DeleteRoutingStaticRoutesEndpointResponse406")


@_attrs_define
class DeleteRoutingStaticRoutesEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_routing_static_routes_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_routing_static_routes_endpoint_response_406.additional_properties = d
        return delete_routing_static_routes_endpoint_response_406
