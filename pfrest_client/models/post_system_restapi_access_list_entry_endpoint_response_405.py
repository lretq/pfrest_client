...
T = TypeVar("T", bound="PostSystemRESTAPIAccessListEntryEndpointResponse405")


@_attrs_define
class PostSystemRESTAPIAccessListEntryEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_restapi_access_list_entry_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_system_restapi_access_list_entry_endpoint_response_405.additional_properties = d
        return post_system_restapi_access_list_entry_endpoint_response_405
