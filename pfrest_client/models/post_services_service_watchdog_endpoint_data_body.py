...
T = TypeVar("T", bound="PostServicesServiceWatchdogEndpointDataBody")


@_attrs_define
class PostServicesServiceWatchdogEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_service_watchdog_endpoint_data_body = cls(
            name=name,
        ...
        post_services_service_watchdog_endpoint_data_body.additional_properties = d
        return post_services_service_watchdog_endpoint_data_body
