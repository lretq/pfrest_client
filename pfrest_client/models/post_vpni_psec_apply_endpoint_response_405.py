...
T = TypeVar("T", bound="PostVPNIPsecApplyEndpointResponse405")


@_attrs_define
class PostVPNIPsecApplyEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpni_psec_apply_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_vpni_psec_apply_endpoint_response_405.additional_properties = d
        return post_vpni_psec_apply_endpoint_response_405
