...
T = TypeVar("T", bound="PostVPNWireGuardPeerEndpointJsonBody")


@_attrs_define
class PostVPNWireGuardPeerEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_wire_guard_peer_endpoint_json_body = cls(
            publickey=publickey,
            enabled=enabled,
            tun=tun,
            endpoint=endpoint,
        ...
        post_vpn_wire_guard_peer_endpoint_json_body.additional_properties = d
        return post_vpn_wire_guard_peer_endpoint_json_body
