...
T = TypeVar("T", bound="PatchServicesBINDSettingsEndpointResponse405")


@_attrs_define
class PatchServicesBINDSettingsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_bind_settings_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_services_bind_settings_endpoint_response_405.additional_properties = d
        return patch_services_bind_settings_endpoint_response_405
