...
T = TypeVar("T", bound="DeleteRoutingGatewaysEndpointResponse405")


@_attrs_define
class DeleteRoutingGatewaysEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_routing_gateways_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_routing_gateways_endpoint_response_405.additional_properties = d
        return delete_routing_gateways_endpoint_response_405
