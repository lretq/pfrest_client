...
T = TypeVar("T", bound="PostRoutingGatewayGroupPriorityEndpointResponse405")


@_attrs_define
class PostRoutingGatewayGroupPriorityEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_routing_gateway_group_priority_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_routing_gateway_group_priority_endpoint_response_405.additional_properties = d
        return post_routing_gateway_group_priority_endpoint_response_405
