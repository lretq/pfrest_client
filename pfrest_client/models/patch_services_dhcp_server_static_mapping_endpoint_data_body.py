...
T = TypeVar("T", bound="PatchServicesDHCPServerStaticMappingEndpointDataBody")


@_attrs_define
class PatchServicesDHCPServerStaticMappingEndpointDataBody:
    """
    Attributes:
        parent_id (int): The ID of the parent this object is nested under.
        id (int): The ID of the object or resource to interact with.
        mac (str | Unset): The MAC address of the client this mapping is for.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_static_mapping_endpoint_data_body = cls(
            parent_id=parent_id,
            id=id,
            mac=mac,
            ipaddr=ipaddr,
        ...
        patch_services_dhcp_server_static_mapping_endpoint_data_body.additional_properties = d
        return patch_services_dhcp_server_static_mapping_endpoint_data_body
