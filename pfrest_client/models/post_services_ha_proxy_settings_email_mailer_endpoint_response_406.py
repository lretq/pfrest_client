...
T = TypeVar("T", bound="PostServicesHAProxySettingsEmailMailerEndpointResponse406")


@_attrs_define
class PostServicesHAProxySettingsEmailMailerEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_settings_email_mailer_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_services_ha_proxy_settings_email_mailer_endpoint_response_406.additional_properties = d
        return post_services_ha_proxy_settings_email_mailer_endpoint_response_406
