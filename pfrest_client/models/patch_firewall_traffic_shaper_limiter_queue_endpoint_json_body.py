...
T = TypeVar("T", bound="PatchFirewallTrafficShaperLimiterQueueEndpointJsonBody")


@_attrs_define
class PatchFirewallTrafficShaperLimiterQueueEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_traffic_shaper_limiter_queue_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            name=name,
            number=number,
        ...
        patch_firewall_traffic_shaper_limiter_queue_endpoint_json_body.additional_properties = d
        return patch_firewall_traffic_shaper_limiter_queue_endpoint_json_body
