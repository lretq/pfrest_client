...
T = TypeVar("T", bound="GetFirewallNATOneToOneMappingEndpointResponse405")


@_attrs_define
class GetFirewallNATOneToOneMappingEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_nat_one_to_one_mapping_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_firewall_nat_one_to_one_mapping_endpoint_response_405.additional_properties = d
        return get_firewall_nat_one_to_one_mapping_endpoint_response_405
