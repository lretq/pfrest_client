...
T = TypeVar("T", bound="DeleteServicesDNSResolverDomainOverridesEndpointResponse422")


@_attrs_define
class DeleteServicesDNSResolverDomainOverridesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_dns_resolver_domain_overrides_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_services_dns_resolver_domain_overrides_endpoint_response_422.additional_properties = d
        return delete_services_dns_resolver_domain_overrides_endpoint_response_422
