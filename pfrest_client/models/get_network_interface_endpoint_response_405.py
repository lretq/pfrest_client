...
T = TypeVar("T", bound="GetNetworkInterfaceEndpointResponse405")


@_attrs_define
class GetNetworkInterfaceEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_network_interface_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_network_interface_endpoint_response_405.additional_properties = d
        return get_network_interface_endpoint_response_405
