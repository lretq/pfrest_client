...
T = TypeVar("T", bound="PutVPNOpenVPNClientExportConfigsEndpointJsonBodyItem")


@_attrs_define
class PutVPNOpenVPNClientExportConfigsEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_vpn_open_vpn_client_export_configs_endpoint_json_body_item = cls(
            server=server,
            pkcs11providers=pkcs11providers,
            pkcs11id=pkcs11id,
            pass_=pass_,
        ...
        put_vpn_open_vpn_client_export_configs_endpoint_json_body_item.additional_properties = d
        return put_vpn_open_vpn_client_export_configs_endpoint_json_body_item
