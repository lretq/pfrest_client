...
T = TypeVar("T", bound="DeleteServicesACMEAccountKeyEndpointResponse422")


@_attrs_define
class DeleteServicesACMEAccountKeyEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_acme_account_key_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_services_acme_account_key_endpoint_response_422.additional_properties = d
        return delete_services_acme_account_key_endpoint_response_422
