...
T = TypeVar("T", bound="PostServicesFreeRADIUSInterfaceEndpointJsonBody")


@_attrs_define
class PostServicesFreeRADIUSInterfaceEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_free_radius_interface_endpoint_json_body = cls(
            addr=addr,
            ip_version=ip_version,
            port=port,
            type_=type_,
        ...
        post_services_free_radius_interface_endpoint_json_body.additional_properties = d
        return post_services_free_radius_interface_endpoint_json_body
