...
T = TypeVar("T", bound="FirewallStatesSize")


@_attrs_define
class FirewallStatesSize:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        firewall_states_size = cls(
            maximumstates=maximumstates,
            defaultmaximumstates=defaultmaximumstates,
            currentstates=currentstates,
        )

        firewall_states_size.additional_properties = d
        return firewall_states_size
