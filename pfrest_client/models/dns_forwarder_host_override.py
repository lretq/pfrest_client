...
T = TypeVar("T", bound="DNSForwarderHostOverride")
...
class DNSForwarderHostOverride:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dns_forwarder_host_override = cls(
            host=host,
            domain=domain,
            ip=ip,
            descr=descr,
        ...
        dns_forwarder_host_override.additional_properties = d
        return dns_forwarder_host_override
