...
T = TypeVar("T", bound="PatchServicesBINDSyncSettingsEndpointJsonBody")


@_attrs_define
class PatchServicesBINDSyncSettingsEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_bind_sync_settings_endpoint_json_body = cls(
            synconchanges=synconchanges,
            masterip=masterip,
            synctimeout=synctimeout,
        )

        patch_services_bind_sync_settings_endpoint_json_body.additional_properties = d
        return patch_services_bind_sync_settings_endpoint_json_body
