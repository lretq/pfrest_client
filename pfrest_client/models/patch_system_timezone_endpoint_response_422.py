...
T = TypeVar("T", bound="PatchSystemTimezoneEndpointResponse422")


@_attrs_define
class PatchSystemTimezoneEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_timezone_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_system_timezone_endpoint_response_422.additional_properties = d
        return patch_system_timezone_endpoint_response_422
