...
T = TypeVar("T", bound="PatchNetworkInterfaceEndpointDataBody")


@_attrs_define
class PatchNetworkInterfaceEndpointDataBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        if_ (str | Unset): The real interface this configuration will be applied to.<br>
        enable (bool | Unset): Enable or disable this interface.<br>
        descr (str | Unset): The descriptive name for this interface.<br>
        ...
        typev4 (NetworkInterfaceTypev4 | Unset): Selects the IPv4 address type to assign this interface.<br>
        ipaddr (str | Unset): Sets the IPv4 address to assign to this interface.<br><br>This field is only available
            when the following conditions are met:<br>- `typev4` must be one of [ static, dhcp ]<br>
        subnet (int | Unset): Sets the subnet bit count to assign this interface.<br><br>This field is only available
            when the following conditions are met:<br>- `typev4` must be equal to `'static'`<br>
        ...
        ipaddrv6 (str | Unset): Sets the IPv6 address to assign to this interface.<br><br>This field is only available
            when the following conditions are met:<br>- `typev6` must be one of [ staticv6, dhcp6, slaac, 6rd, track6, 6to4
            ]<br>
        subnetv6 (int | Unset): Sets the subnet bit count to assign this interface.<br><br>This field is only available
            when the following conditions are met:<br>- `typev6` must be equal to `'staticv6'`<br>
        ...
        prefix_6rd (str | Unset): Sets the 6RD IPv6 prefix assigned by the ISP for this interface.<br><br>This field is
            only available when the following conditions are met:<br>- `typev6` must be equal to `'6rd'`<br>
        gateway_6rd (str | Unset): Sets the 6RD IPv4 gateway address assigned by the ISP for this interface.<br><br>This
            field is only available when the following conditions are met:<br>- `typev6` must be equal to `'6rd'`<br>
        prefix_6rd_v4plen (int | Unset): Sets the 6RD IPv4 prefix length. Normally specified by the ISP. A value of 0
            means embed theentire IPv4 address in the 6RD prefix.<br><br>This field is only available when the following
            conditions are met:<br>- `typev6` must be equal to `'6rd'`<br>
        track6_interface (str | Unset): Sets the dynamic IPv6 WAN interface to track for configuration.<br><br>This
            field is only available when the following conditions are met:<br>- `typev6` must be equal to `'track6'`<br>
    ...
    typev4: NetworkInterfaceTypev4 | Unset = UNSET
    ...
    prefix_6rd_v4plen: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        typev4: str | Unset = UNSET
        if not isinstance(self.typev4, Unset):
        ...
        if typev4 is not UNSET:
            field_dict["typev4"] = typev4
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _typev4 = d.pop("typev4", UNSET)
        typev4: NetworkInterfaceTypev4 | Unset
        if isinstance(_typev4, Unset):
            typev4 = UNSET
        else:
            typev4 = NetworkInterfaceTypev4(_typev4)
        ...
        patch_network_interface_endpoint_data_body = cls(
            id=id,
            if_=if_,
            enable=enable,
            descr=descr,
        ...
        patch_network_interface_endpoint_data_body.additional_properties = d
        return patch_network_interface_endpoint_data_body
