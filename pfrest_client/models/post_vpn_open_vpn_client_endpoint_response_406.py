...
T = TypeVar("T", bound="PostVPNOpenVPNClientEndpointResponse406")


@_attrs_define
class PostVPNOpenVPNClientEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_open_vpn_client_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_vpn_open_vpn_client_endpoint_response_406.additional_properties = d
        return post_vpn_open_vpn_client_endpoint_response_406
