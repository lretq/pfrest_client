...
T = TypeVar("T", bound="PatchServicesHAProxySettingsEndpointDataBody")


@_attrs_define
class PatchServicesHAProxySettingsEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_settings_endpoint_data_body = cls(
            enable=enable,
            maxconn=maxconn,
            nbthread=nbthread,
        ...
        patch_services_ha_proxy_settings_endpoint_data_body.additional_properties = d
        return patch_services_ha_proxy_settings_endpoint_data_body
