...
T = TypeVar("T", bound="PostServicesWakeOnLANSendEndpointResponse406")


@_attrs_define
class PostServicesWakeOnLANSendEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_wake_on_lan_send_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_services_wake_on_lan_send_endpoint_response_406.additional_properties = d
        return post_services_wake_on_lan_send_endpoint_response_406
