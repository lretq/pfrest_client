...
T = TypeVar("T", bound="PostGraphQLEndpointJsonBody")


@_attrs_define
class PostGraphQLEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_graph_ql_endpoint_json_body = cls(
            query=query,
            variables=variables,
        )

        post_graph_ql_endpoint_json_body.additional_properties = d
        return post_graph_ql_endpoint_json_body
