...
T = TypeVar("T", bound="DeleteUsersEndpointResponse405")


@_attrs_define
class DeleteUsersEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_users_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_users_endpoint_response_405.additional_properties = d
        return delete_users_endpoint_response_405
