...
T = TypeVar("T", bound="PatchVPNIPsecPhase1EncryptionEndpointJsonBody")


@_attrs_define
class PatchVPNIPsecPhase1EncryptionEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpni_psec_phase_1_encryption_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
        ...
        patch_vpni_psec_phase_1_encryption_endpoint_json_body.additional_properties = d
        return patch_vpni_psec_phase_1_encryption_endpoint_json_body
