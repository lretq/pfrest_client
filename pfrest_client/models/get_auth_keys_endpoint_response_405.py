...
T = TypeVar("T", bound="GetAuthKeysEndpointResponse405")


@_attrs_define
class GetAuthKeysEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_auth_keys_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_auth_keys_endpoint_response_405.additional_properties = d
        return get_auth_keys_endpoint_response_405
