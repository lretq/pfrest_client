...
T = TypeVar("T", bound="TrafficShaperQueue")


@_attrs_define
class TrafficShaperQueue:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        traffic_shaper_queue.additional_properties = d
        return traffic_shaper_queue
