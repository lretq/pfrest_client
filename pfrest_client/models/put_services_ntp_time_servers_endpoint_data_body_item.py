...
T = TypeVar("T", bound="PutServicesNTPTimeServersEndpointDataBodyItem")


@_attrs_define
class PutServicesNTPTimeServersEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_ntp_time_servers_endpoint_data_body_item = cls(
            timeserver=timeserver,
            type_=type_,
            prefer=prefer,
            noselect=noselect,
        ...
        put_services_ntp_time_servers_endpoint_data_body_item.additional_properties = d
        return put_services_ntp_time_servers_endpoint_data_body_item
