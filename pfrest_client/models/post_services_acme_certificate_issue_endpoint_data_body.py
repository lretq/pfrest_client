...
T = TypeVar("T", bound="PostServicesACMECertificateIssueEndpointDataBody")


@_attrs_define
class PostServicesACMECertificateIssueEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_acme_certificate_issue_endpoint_data_body = cls(
            certificate=certificate,
            status=status,
        ...
        post_services_acme_certificate_issue_endpoint_data_body.additional_properties = d
        return post_services_acme_certificate_issue_endpoint_data_body
