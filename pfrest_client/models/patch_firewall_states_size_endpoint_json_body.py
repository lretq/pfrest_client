...
T = TypeVar("T", bound="PatchFirewallStatesSizeEndpointJsonBody")


@_attrs_define
class PatchFirewallStatesSizeEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_states_size_endpoint_json_body = cls(
            maximumstates=maximumstates,
            defaultmaximumstates=defaultmaximumstates,
            currentstates=currentstates,
        )

        patch_firewall_states_size_endpoint_json_body.additional_properties = d
        return patch_firewall_states_size_endpoint_json_body
