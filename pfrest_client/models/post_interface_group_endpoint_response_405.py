...
T = TypeVar("T", bound="PostInterfaceGroupEndpointResponse405")


@_attrs_define
class PostInterfaceGroupEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_interface_group_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_interface_group_endpoint_response_405.additional_properties = d
        return post_interface_group_endpoint_response_405
