...
T = TypeVar("T", bound="PutServicesCronJobsEndpointResponse422")


@_attrs_define
class PutServicesCronJobsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_cron_jobs_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        put_services_cron_jobs_endpoint_response_422.additional_properties = d
        return put_services_cron_jobs_endpoint_response_422
