...
T = TypeVar("T", bound="PatchVPNIPsecPhase2EndpointDataBody")


@_attrs_define
class PatchVPNIPsecPhase2EndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpni_psec_phase_2_endpoint_data_body = cls(
            id=id,
            uniqid=uniqid,
            reqid=reqid,
            ikeid=ikeid,
        ...
        patch_vpni_psec_phase_2_endpoint_data_body.additional_properties = d
        return patch_vpni_psec_phase_2_endpoint_data_body
