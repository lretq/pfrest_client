...
T = TypeVar("T", bound="GetSystemNotificationsEmailSettingsEndpointResponse422")


@_attrs_define
class GetSystemNotificationsEmailSettingsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_notifications_email_settings_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_system_notifications_email_settings_endpoint_response_422.additional_properties = d
        return get_system_notifications_email_settings_endpoint_response_422
