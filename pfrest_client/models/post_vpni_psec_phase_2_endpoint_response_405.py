...
T = TypeVar("T", bound="PostVPNIPsecPhase2EndpointResponse405")


@_attrs_define
class PostVPNIPsecPhase2EndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpni_psec_phase_2_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_vpni_psec_phase_2_endpoint_response_405.additional_properties = d
        return post_vpni_psec_phase_2_endpoint_response_405
