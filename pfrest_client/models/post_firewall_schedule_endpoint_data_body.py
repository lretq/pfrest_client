...
T = TypeVar("T", bound="PostFirewallScheduleEndpointDataBody")


@_attrs_define
class PostFirewallScheduleEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_schedule_endpoint_data_body = cls(
            name=name,
            timerange=timerange,
        ...
        post_firewall_schedule_endpoint_data_body.additional_properties = d
        return post_firewall_schedule_endpoint_data_body
