...
T = TypeVar("T", bound="PostStatusServiceEndpointResponse422")


@_attrs_define
class PostStatusServiceEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_status_service_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_status_service_endpoint_response_422.additional_properties = d
        return post_status_service_endpoint_response_422
