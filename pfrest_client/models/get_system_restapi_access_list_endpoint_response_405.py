...
T = TypeVar("T", bound="GetSystemRESTAPIAccessListEndpointResponse405")


@_attrs_define
class GetSystemRESTAPIAccessListEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_restapi_access_list_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_system_restapi_access_list_endpoint_response_405.additional_properties = d
        return get_system_restapi_access_list_endpoint_response_405
