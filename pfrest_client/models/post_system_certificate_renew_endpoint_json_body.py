...
T = TypeVar("T", bound="PostSystemCertificateRenewEndpointJsonBody")


@_attrs_define
class PostSystemCertificateRenewEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_certificate_renew_endpoint_json_body = cls(
            certref=certref,
            reusekey=reusekey,
        ...
        post_system_certificate_renew_endpoint_json_body.additional_properties = d
        return post_system_certificate_renew_endpoint_json_body
