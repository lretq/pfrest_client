...
T = TypeVar("T", bound="PatchUserAuthServerEndpointDataBody")


@_attrs_define
class PatchUserAuthServerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_user_auth_server_endpoint_data_body = cls(
            id=id,
            refid=refid,
            type_=type_,
            name=name,
        ...
        patch_user_auth_server_endpoint_data_body.additional_properties = d
        return patch_user_auth_server_endpoint_data_body
