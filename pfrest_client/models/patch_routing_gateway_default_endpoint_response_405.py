...
T = TypeVar("T", bound="PatchRoutingGatewayDefaultEndpointResponse405")


@_attrs_define
class PatchRoutingGatewayDefaultEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_routing_gateway_default_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_routing_gateway_default_endpoint_response_405.additional_properties = d
        return patch_routing_gateway_default_endpoint_response_405
