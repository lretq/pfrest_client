...
T = TypeVar("T", bound="PostServicesDHCPServerAddressPoolEndpointDataBody")


@_attrs_define
class PostServicesDHCPServerAddressPoolEndpointDataBody:
    """
    Attributes:
        range_from (str): The starting IP address for this address pool. This address must be less than or equal to the
            `range_to` field.<br>
        range_to (str): The ending IP address for the this address pool. This address must be greater than or equal to
            the `range_to` field.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        range_from = d.pop("range_from")

        range_to = d.pop("range_to")
        ...
        post_services_dhcp_server_address_pool_endpoint_data_body = cls(
            range_from=range_from,
            range_to=range_to,
            parent_id=parent_id,
            domain=domain,
        ...
        post_services_dhcp_server_address_pool_endpoint_data_body.additional_properties = d
        return post_services_dhcp_server_address_pool_endpoint_data_body
