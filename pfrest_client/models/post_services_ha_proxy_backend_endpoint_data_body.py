...
T = TypeVar("T", bound="PostServicesHAProxyBackendEndpointDataBody")


@_attrs_define
class PostServicesHAProxyBackendEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_backend_endpoint_data_body = cls(
            name=name,
            agent_port=agent_port,
            persist_cookie_name=persist_cookie_name,
            servers=servers,
        ...
        post_services_ha_proxy_backend_endpoint_data_body.additional_properties = d
        return post_services_ha_proxy_backend_endpoint_data_body
