...
T = TypeVar("T", bound="GetUsersEndpointResponse406")


@_attrs_define
class GetUsersEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_users_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_users_endpoint_response_406.additional_properties = d
        return get_users_endpoint_response_406
