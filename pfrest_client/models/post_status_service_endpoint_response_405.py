...
T = TypeVar("T", bound="PostStatusServiceEndpointResponse405")


@_attrs_define
class PostStatusServiceEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_status_service_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_status_service_endpoint_response_405.additional_properties = d
        return post_status_service_endpoint_response_405
