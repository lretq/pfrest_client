...
T = TypeVar("T", bound="PatchServicesDHCPServerAddressPoolEndpointJsonBody")


@_attrs_define
class PatchServicesDHCPServerAddressPoolEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_address_pool_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
        ...
        patch_services_dhcp_server_address_pool_endpoint_json_body.additional_properties = d
        return patch_services_dhcp_server_address_pool_endpoint_json_body
