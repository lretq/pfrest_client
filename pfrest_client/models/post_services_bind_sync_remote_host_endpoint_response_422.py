...
T = TypeVar("T", bound="PostServicesBINDSyncRemoteHostEndpointResponse422")


@_attrs_define
class PostServicesBINDSyncRemoteHostEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_bind_sync_remote_host_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_services_bind_sync_remote_host_endpoint_response_422.additional_properties = d
        return post_services_bind_sync_remote_host_endpoint_response_422
