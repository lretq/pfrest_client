...
T = TypeVar("T", bound="PutVPNWireGuardPeersEndpointResponse406")


@_attrs_define
class PutVPNWireGuardPeersEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_vpn_wire_guard_peers_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        put_vpn_wire_guard_peers_endpoint_response_406.additional_properties = d
        return put_vpn_wire_guard_peers_endpoint_response_406
