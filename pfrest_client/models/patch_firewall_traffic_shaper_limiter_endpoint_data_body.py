...
T = TypeVar("T", bound="PatchFirewallTrafficShaperLimiterEndpointDataBody")


@_attrs_define
class PatchFirewallTrafficShaperLimiterEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_traffic_shaper_limiter_endpoint_data_body = cls(
            id=id,
            name=name,
            number=number,
            enabled=enabled,
        ...
        patch_firewall_traffic_shaper_limiter_endpoint_data_body.additional_properties = d
        return patch_firewall_traffic_shaper_limiter_endpoint_data_body
