...
T = TypeVar("T", bound="PostFirewallNATPortForwardEndpointJsonBody")


@_attrs_define
class PostFirewallNATPortForwardEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_nat_port_forward_endpoint_json_body = cls(
            interface=interface,
            protocol=protocol,
            source=source,
            destination=destination,
        ...
        post_firewall_nat_port_forward_endpoint_json_body.additional_properties = d
        return post_firewall_nat_port_forward_endpoint_json_body
