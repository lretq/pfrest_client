...
T = TypeVar("T", bound="PatchServicesDNSResolverAccessListNetworkEndpointResponse406")


@_attrs_define
class PatchServicesDNSResolverAccessListNetworkEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dns_resolver_access_list_network_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_services_dns_resolver_access_list_network_endpoint_response_406.additional_properties = d
        return patch_services_dns_resolver_access_list_network_endpoint_response_406
