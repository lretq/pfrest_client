...
T = TypeVar("T", bound="PatchUserEndpointDataBody")


@_attrs_define
class PatchUserEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_user_endpoint_data_body = cls(
            id=id,
            name=name,
            password=password,
            uid=uid,
        ...
        patch_user_endpoint_data_body.additional_properties = d
        return patch_user_endpoint_data_body
