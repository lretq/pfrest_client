...
T = TypeVar("T", bound="GetFirewallNATPortForwardsEndpointResponse406")


@_attrs_define
class GetFirewallNATPortForwardsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_nat_port_forwards_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_firewall_nat_port_forwards_endpoint_response_406.additional_properties = d
        return get_firewall_nat_port_forwards_endpoint_response_406
