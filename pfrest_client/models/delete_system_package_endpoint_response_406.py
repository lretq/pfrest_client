...
T = TypeVar("T", bound="DeleteSystemPackageEndpointResponse406")


@_attrs_define
class DeleteSystemPackageEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_system_package_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_system_package_endpoint_response_406.additional_properties = d
        return delete_system_package_endpoint_response_406
