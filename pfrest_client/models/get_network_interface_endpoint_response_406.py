...
T = TypeVar("T", bound="GetNetworkInterfaceEndpointResponse406")


@_attrs_define
class GetNetworkInterfaceEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_network_interface_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_network_interface_endpoint_response_406.additional_properties = d
        return get_network_interface_endpoint_response_406
