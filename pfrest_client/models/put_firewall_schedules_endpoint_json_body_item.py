...
T = TypeVar("T", bound="PutFirewallSchedulesEndpointJsonBodyItem")


@_attrs_define
class PutFirewallSchedulesEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_schedules_endpoint_json_body_item = cls(
            name=name,
            timerange=timerange,
        ...
        put_firewall_schedules_endpoint_json_body_item.additional_properties = d
        return put_firewall_schedules_endpoint_json_body_item
