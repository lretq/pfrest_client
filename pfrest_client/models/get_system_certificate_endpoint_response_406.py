...
T = TypeVar("T", bound="GetSystemCertificateEndpointResponse406")


@_attrs_define
class GetSystemCertificateEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_certificate_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_system_certificate_endpoint_response_406.additional_properties = d
        return get_system_certificate_endpoint_response_406
