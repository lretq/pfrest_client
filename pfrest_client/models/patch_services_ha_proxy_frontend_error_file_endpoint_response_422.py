...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendErrorFileEndpointResponse422")


@_attrs_define
class PatchServicesHAProxyFrontendErrorFileEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_frontend_error_file_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_services_ha_proxy_frontend_error_file_endpoint_response_422.additional_properties = d
        return patch_services_ha_proxy_frontend_error_file_endpoint_response_422
