...
T = TypeVar("T", bound="PutServicesDNSResolverAccessListsEndpointDataBodyItem")


@_attrs_define
class PutServicesDNSResolverAccessListsEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_dns_resolver_access_lists_endpoint_data_body_item = cls(
            name=name,
            action=action,
            networks=networks,
        ...
        put_services_dns_resolver_access_lists_endpoint_data_body_item.additional_properties = d
        return put_services_dns_resolver_access_lists_endpoint_data_body_item
