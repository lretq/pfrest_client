...
T = TypeVar("T", bound="GetFirewallTrafficShaperQueueEndpointResponse406")


@_attrs_define
class GetFirewallTrafficShaperQueueEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_traffic_shaper_queue_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_firewall_traffic_shaper_queue_endpoint_response_406.additional_properties = d
        return get_firewall_traffic_shaper_queue_endpoint_response_406
