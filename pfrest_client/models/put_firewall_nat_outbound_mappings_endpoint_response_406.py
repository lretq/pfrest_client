...
T = TypeVar("T", bound="PutFirewallNATOutboundMappingsEndpointResponse406")


@_attrs_define
class PutFirewallNATOutboundMappingsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_nat_outbound_mappings_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        put_firewall_nat_outbound_mappings_endpoint_response_406.additional_properties = d
        return put_firewall_nat_outbound_mappings_endpoint_response_406
