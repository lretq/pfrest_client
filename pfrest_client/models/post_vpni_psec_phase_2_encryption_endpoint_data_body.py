...
T = TypeVar("T", bound="PostVPNIPsecPhase2EncryptionEndpointDataBody")


@_attrs_define
class PostVPNIPsecPhase2EncryptionEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpni_psec_phase_2_encryption_endpoint_data_body = cls(
            name=name,
            keylen=keylen,
            parent_id=parent_id,
        )

        post_vpni_psec_phase_2_encryption_endpoint_data_body.additional_properties = d
        return post_vpni_psec_phase_2_encryption_endpoint_data_body
