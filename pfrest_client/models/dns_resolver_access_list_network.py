...
T = TypeVar("T", bound="DNSResolverAccessListNetwork")


@_attrs_define
class DNSResolverAccessListNetwork:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dns_resolver_access_list_network = cls(
            network=network,
            mask=mask,
            description=description,
        )

        dns_resolver_access_list_network.additional_properties = d
        return dns_resolver_access_list_network
