...
T = TypeVar("T", bound="PatchFirewallRuleEndpointJsonBody")


@_attrs_define
class PatchFirewallRuleEndpointJsonBody:
    """
    Attributes:
        id (int): The ID of the object or resource to interact with.
        type_ (FirewallRuleType | Unset): The action to take against traffic that matches this rule.<br>
        interface (list[str] | Unset): The interface where packets must originate to match this rule.<br>
        ipprotocol (FirewallRuleIpprotocol | Unset): The IP version(s) this rule applies to.<br>
        ...
        source (str | Unset): The source address this rule applies to. Valid value options are: an existing interface,
    ...
    id: int
    type_: FirewallRuleType | Unset = UNSET
    interface: list[str] | Unset = UNSET
    ipprotocol: FirewallRuleIpprotocol | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: FirewallRuleType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = FirewallRuleType(_type_)

        interface = cast(list[str], d.pop("interface", UNSET))

        _ipprotocol = d.pop("ipprotocol", UNSET)
        ipprotocol: FirewallRuleIpprotocol | Unset
        if isinstance(_ipprotocol, Unset):
            ipprotocol = UNSET
        else:
            ipprotocol = FirewallRuleIpprotocol(_ipprotocol)
        ...
        patch_firewall_rule_endpoint_json_body = cls(
            id=id,
            type_=type_,
            interface=interface,
        ...
        patch_firewall_rule_endpoint_json_body.additional_properties = d
        return patch_firewall_rule_endpoint_json_body
