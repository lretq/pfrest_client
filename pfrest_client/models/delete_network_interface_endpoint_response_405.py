...
T = TypeVar("T", bound="DeleteNetworkInterfaceEndpointResponse405")


@_attrs_define
class DeleteNetworkInterfaceEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_network_interface_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_network_interface_endpoint_response_405.additional_properties = d
        return delete_network_interface_endpoint_response_405
