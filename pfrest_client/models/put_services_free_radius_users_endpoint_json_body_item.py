...
T = TypeVar("T", bound="PutServicesFreeRADIUSUsersEndpointJsonBodyItem")


@_attrs_define
class PutServicesFreeRADIUSUsersEndpointJsonBodyItem:
    """
    Attributes:
        username (str): The username for this user.<br>
        password (str): The password for this username.<br><br>This field is only available when the following
            conditions are met:<br>- `motp_enable` must be equal to `false`<br>
        motp_secret (str): The secret for the Mobile One-Time Password (MOTP).<br><br>This field is only available when
            the following conditions are met:<br>- `motp_enable` must be equal to `true`<br>
        motp_pin (str): The PIN for the Mobile One-Time Password (MOTP). It must be exactly 4 digits.<br><br>This field
            is only available when the following conditions are met:<br>- `motp_enable` must be equal to `true`<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        motp_secret = d.pop("motp_secret")

        motp_pin = d.pop("motp_pin")
        ...
        put_services_free_radius_users_endpoint_json_body_item = cls(
            username=username,
            password=password,
            motp_secret=motp_secret,
            motp_pin=motp_pin,
        ...
        put_services_free_radius_users_endpoint_json_body_item.additional_properties = d
        return put_services_free_radius_users_endpoint_json_body_item
