...
T = TypeVar("T", bound="PostServicesDNSResolverDomainOverrideEndpointDataBody")


@_attrs_define
class PostServicesDNSResolverDomainOverrideEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_dns_resolver_domain_override_endpoint_data_body = cls(
            domain=domain,
            ip=ip,
            descr=descr,
        ...
        post_services_dns_resolver_domain_override_endpoint_data_body.additional_properties = d
        return post_services_dns_resolver_domain_override_endpoint_data_body
