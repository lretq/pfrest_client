...
T = TypeVar("T", bound="PatchFirewallRuleEndpointDataBody")


@_attrs_define
class PatchFirewallRuleEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_firewall_rule_endpoint_data_body = cls(
            id=id,
            type_=type_,
            interface=interface,
        ...
        patch_firewall_rule_endpoint_data_body.additional_properties = d
        return patch_firewall_rule_endpoint_data_body
