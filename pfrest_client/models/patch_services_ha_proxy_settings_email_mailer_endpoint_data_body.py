...
T = TypeVar("T", bound="PatchServicesHAProxySettingsEmailMailerEndpointDataBody")


@_attrs_define
class PatchServicesHAProxySettingsEmailMailerEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_settings_email_mailer_endpoint_data_body = cls(
            id=id,
            name=name,
        ...
        patch_services_ha_proxy_settings_email_mailer_endpoint_data_body.additional_properties = d
        return patch_services_ha_proxy_settings_email_mailer_endpoint_data_body
