...
T = TypeVar("T", bound="DeleteVPNOpenVPNCSOsEndpointResponse422")


@_attrs_define
class DeleteVPNOpenVPNCSOsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpn_open_vpncs_os_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_vpn_open_vpncs_os_endpoint_response_422.additional_properties = d
        return delete_vpn_open_vpncs_os_endpoint_response_422
