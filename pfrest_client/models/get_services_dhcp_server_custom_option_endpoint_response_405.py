...
T = TypeVar("T", bound="GetServicesDHCPServerCustomOptionEndpointResponse405")


@_attrs_define
class GetServicesDHCPServerCustomOptionEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_dhcp_server_custom_option_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_services_dhcp_server_custom_option_endpoint_response_405.additional_properties = d
        return get_services_dhcp_server_custom_option_endpoint_response_405
