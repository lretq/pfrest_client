...
T = TypeVar("T", bound="PatchServicesFreeRADIUSClientEndpointJsonBody")


@_attrs_define
class PatchServicesFreeRADIUSClientEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_free_radius_client_endpoint_json_body = cls(
            id=id,
            addr=addr,
        ...
        patch_services_free_radius_client_endpoint_json_body.additional_properties = d
        return patch_services_free_radius_client_endpoint_json_body
