...
T = TypeVar("T", bound="PatchServicesDNSResolverHostOverrideEndpointJsonBody")


@_attrs_define
class PatchServicesDNSResolverHostOverrideEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dns_resolver_host_override_endpoint_json_body = cls(
            id=id,
            host=host,
            domain=domain,
            ip=ip,
        ...
        patch_services_dns_resolver_host_override_endpoint_json_body.additional_properties = d
        return patch_services_dns_resolver_host_override_endpoint_json_body
