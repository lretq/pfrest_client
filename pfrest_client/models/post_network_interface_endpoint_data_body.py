...
T = TypeVar("T", bound="PostNetworkInterfaceEndpointDataBody")


@_attrs_define
class PostNetworkInterfaceEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_network_interface_endpoint_data_body = cls(
            if_=if_,
            descr=descr,
            typev4=typev4,
            ipaddr=ipaddr,
        ...
        post_network_interface_endpoint_data_body.additional_properties = d
        return post_network_interface_endpoint_data_body
