...
T = TypeVar("T", bound="FreeRADIUSInterface")


@_attrs_define
class FreeRADIUSInterface:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        free_radius_interface.additional_properties = d
        return free_radius_interface
