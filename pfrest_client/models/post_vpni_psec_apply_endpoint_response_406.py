...
T = TypeVar("T", bound="PostVPNIPsecApplyEndpointResponse406")


@_attrs_define
class PostVPNIPsecApplyEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpni_psec_apply_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_vpni_psec_apply_endpoint_response_406.additional_properties = d
        return post_vpni_psec_apply_endpoint_response_406
