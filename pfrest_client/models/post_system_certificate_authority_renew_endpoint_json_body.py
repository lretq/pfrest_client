...
T = TypeVar("T", bound="PostSystemCertificateAuthorityRenewEndpointJsonBody")


@_attrs_define
class PostSystemCertificateAuthorityRenewEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_certificate_authority_renew_endpoint_json_body = cls(
            caref=caref,
            reusekey=reusekey,
        ...
        post_system_certificate_authority_renew_endpoint_json_body.additional_properties = d
        return post_system_certificate_authority_renew_endpoint_json_body
