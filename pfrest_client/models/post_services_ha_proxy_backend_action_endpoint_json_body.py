...
T = TypeVar("T", bound="PostServicesHAProxyBackendActionEndpointJsonBody")


@_attrs_define
class PostServicesHAProxyBackendActionEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_backend_action_endpoint_json_body = cls(
            action=action,
            acl=acl,
            server=server,
            customaction=customaction,
        ...
        post_services_ha_proxy_backend_action_endpoint_json_body.additional_properties = d
        return post_services_ha_proxy_backend_action_endpoint_json_body
