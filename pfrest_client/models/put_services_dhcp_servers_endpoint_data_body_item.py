...
T = TypeVar("T", bound="PutServicesDHCPServersEndpointDataBodyItem")


@_attrs_define
class PutServicesDHCPServersEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_dhcp_servers_endpoint_data_body_item = cls(
            interface=interface,
            enable=enable,
        ...
        put_services_dhcp_servers_endpoint_data_body_item.additional_properties = d
        return put_services_dhcp_servers_endpoint_data_body_item
