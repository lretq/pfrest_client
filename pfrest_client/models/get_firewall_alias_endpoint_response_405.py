...
T = TypeVar("T", bound="GetFirewallAliasEndpointResponse405")


@_attrs_define
class GetFirewallAliasEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_alias_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_firewall_alias_endpoint_response_405.additional_properties = d
        return get_firewall_alias_endpoint_response_405
