...
T = TypeVar("T", bound="PostSystemEnumEndpointResponse406")


@_attrs_define
class PostSystemEnumEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_enum_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        post_system_enum_endpoint_response_406.additional_properties = d
        return post_system_enum_endpoint_response_406
