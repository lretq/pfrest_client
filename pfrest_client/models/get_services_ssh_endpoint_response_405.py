...
T = TypeVar("T", bound="GetServicesSSHEndpointResponse405")


@_attrs_define
class GetServicesSSHEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_ssh_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_services_ssh_endpoint_response_405.additional_properties = d
        return get_services_ssh_endpoint_response_405
