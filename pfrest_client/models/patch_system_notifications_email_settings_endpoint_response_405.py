...
T = TypeVar("T", bound="PatchSystemNotificationsEmailSettingsEndpointResponse405")


@_attrs_define
class PatchSystemNotificationsEmailSettingsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_notifications_email_settings_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_system_notifications_email_settings_endpoint_response_405.additional_properties = d
        return patch_system_notifications_email_settings_endpoint_response_405
