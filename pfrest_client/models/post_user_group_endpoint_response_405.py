...
T = TypeVar("T", bound="PostUserGroupEndpointResponse405")


@_attrs_define
class PostUserGroupEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_user_group_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_user_group_endpoint_response_405.additional_properties = d
        return post_user_group_endpoint_response_405
