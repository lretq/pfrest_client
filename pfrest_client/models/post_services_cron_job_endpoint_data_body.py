...
T = TypeVar("T", bound="PostServicesCronJobEndpointDataBody")


@_attrs_define
class PostServicesCronJobEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_cron_job_endpoint_data_body = cls(
            minute=minute,
            hour=hour,
            mday=mday,
            month=month,
        ...
        post_services_cron_job_endpoint_data_body.additional_properties = d
        return post_services_cron_job_endpoint_data_body
