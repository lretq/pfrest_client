...
T = TypeVar("T", bound="DeleteVPNOpenVPNCSOsEndpointResponse405")


@_attrs_define
class DeleteVPNOpenVPNCSOsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpn_open_vpncs_os_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_vpn_open_vpncs_os_endpoint_response_405.additional_properties = d
        return delete_vpn_open_vpncs_os_endpoint_response_405
