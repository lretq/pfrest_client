...
T = TypeVar("T", bound="PutServicesHAProxyFrontendsEndpointResponse405")


@_attrs_define
class PutServicesHAProxyFrontendsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_ha_proxy_frontends_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        put_services_ha_proxy_frontends_endpoint_response_405.additional_properties = d
        return put_services_ha_proxy_frontends_endpoint_response_405
