...
T = TypeVar("T", bound="WireGuardTunnelAddress")


@_attrs_define
class WireGuardTunnelAddress:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        wire_guard_tunnel_address = cls(
            address=address,
            mask=mask,
            descr=descr,
        )

        wire_guard_tunnel_address.additional_properties = d
        return wire_guard_tunnel_address
