...
T = TypeVar("T", bound="PatchServicesACMECertificateActionEndpointResponse405")


@_attrs_define
class PatchServicesACMECertificateActionEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_acme_certificate_action_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_services_acme_certificate_action_endpoint_response_405.additional_properties = d
        return patch_services_acme_certificate_action_endpoint_response_405
