...
T = TypeVar("T", bound="PatchServicesBINDZoneEndpointJsonBody")


@_attrs_define
class PatchServicesBINDZoneEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_bind_zone_endpoint_json_body = cls(
            id=id,
            disabled=disabled,
            name=name,
        ...
        patch_services_bind_zone_endpoint_json_body.additional_properties = d
        return patch_services_bind_zone_endpoint_json_body
