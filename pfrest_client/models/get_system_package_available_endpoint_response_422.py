...
T = TypeVar("T", bound="GetSystemPackageAvailableEndpointResponse422")


@_attrs_define
class GetSystemPackageAvailableEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_package_available_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_system_package_available_endpoint_response_422.additional_properties = d
        return get_system_package_available_endpoint_response_422
