...
T = TypeVar("T", bound="DeleteRoutingStaticRouteEndpointResponse406")


@_attrs_define
class DeleteRoutingStaticRouteEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_routing_static_route_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_routing_static_route_endpoint_response_406.additional_properties = d
        return delete_routing_static_route_endpoint_response_406
