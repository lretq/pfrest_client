...
T = TypeVar("T", bound="PatchVPNOpenVPNClientExportConfigEndpointJsonBody")


@_attrs_define
class PatchVPNOpenVPNClientExportConfigEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_open_vpn_client_export_config_endpoint_json_body = cls(
            id=id,
            server=server,
            useaddr=useaddr,
        ...
        patch_vpn_open_vpn_client_export_config_endpoint_json_body.additional_properties = d
        return patch_vpn_open_vpn_client_export_config_endpoint_json_body
