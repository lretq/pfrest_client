...
T = TypeVar("T", bound="PatchServicesDHCPServerBackendEndpointJsonBody")


@_attrs_define
class PatchServicesDHCPServerBackendEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_backend_endpoint_json_body = cls(
            dhcpbackend=dhcpbackend,
        )

        patch_services_dhcp_server_backend_endpoint_json_body.additional_properties = d
        return patch_services_dhcp_server_backend_endpoint_json_body
