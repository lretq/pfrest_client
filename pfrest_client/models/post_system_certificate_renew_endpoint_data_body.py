...
T = TypeVar("T", bound="PostSystemCertificateRenewEndpointDataBody")


@_attrs_define
class PostSystemCertificateRenewEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_certificate_renew_endpoint_data_body = cls(
            certref=certref,
            reusekey=reusekey,
        ...
        post_system_certificate_renew_endpoint_data_body.additional_properties = d
        return post_system_certificate_renew_endpoint_data_body
