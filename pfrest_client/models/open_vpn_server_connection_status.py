...
T = TypeVar("T", bound="OpenVPNServerConnectionStatus")


@_attrs_define
class OpenVPNServerConnectionStatus:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_vpn_server_connection_status = cls(
        ...
        open_vpn_server_connection_status.additional_properties = d
        return open_vpn_server_connection_status
