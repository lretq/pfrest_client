...
T = TypeVar("T", bound="PostDiagnosticsHaltSystemEndpointResponse405")


@_attrs_define
class PostDiagnosticsHaltSystemEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_diagnostics_halt_system_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_diagnostics_halt_system_endpoint_response_405.additional_properties = d
        return post_diagnostics_halt_system_endpoint_response_405
