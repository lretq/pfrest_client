...
T = TypeVar("T", bound="PatchVPNOpenVPNClientExportConfigEndpointResponse406")


@_attrs_define
class PatchVPNOpenVPNClientExportConfigEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vpn_open_vpn_client_export_config_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_vpn_open_vpn_client_export_config_endpoint_response_406.additional_properties = d
        return patch_vpn_open_vpn_client_export_config_endpoint_response_406
