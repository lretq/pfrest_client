...
T = TypeVar("T", bound="OutboundNATMapping")


@_attrs_define
class OutboundNATMapping:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        outbound_nat_mapping.additional_properties = d
        return outbound_nat_mapping
