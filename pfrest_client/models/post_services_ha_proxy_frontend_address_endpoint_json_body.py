...
T = TypeVar("T", bound="PostServicesHAProxyFrontendAddressEndpointJsonBody")


@_attrs_define
class PostServicesHAProxyFrontendAddressEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_ha_proxy_frontend_address_endpoint_json_body = cls(
            extaddr=extaddr,
            extaddr_custom=extaddr_custom,
            parent_id=parent_id,
        ...
        post_services_ha_proxy_frontend_address_endpoint_json_body.additional_properties = d
        return post_services_ha_proxy_frontend_address_endpoint_json_body
