...
T = TypeVar("T", bound="GetServicesACMESettingsEndpointResponse405")


@_attrs_define
class GetServicesACMESettingsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_acme_settings_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_services_acme_settings_endpoint_response_405.additional_properties = d
        return get_services_acme_settings_endpoint_response_405
