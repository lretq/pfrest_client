...
T = TypeVar("T", bound="PatchSystemWebGUISettingsEndpointResponse422")


@_attrs_define
class PatchSystemWebGUISettingsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_web_gui_settings_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_system_web_gui_settings_endpoint_response_422.additional_properties = d
        return patch_system_web_gui_settings_endpoint_response_422
