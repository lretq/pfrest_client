...
T = TypeVar("T", bound="GetVPNOpenVPNCSOsEndpointResponse422")


@_attrs_define
class GetVPNOpenVPNCSOsEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpn_open_vpncs_os_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_vpn_open_vpncs_os_endpoint_response_422.additional_properties = d
        return get_vpn_open_vpncs_os_endpoint_response_422
