...
T = TypeVar("T", bound="PutServicesFreeRADIUSInterfacesEndpointDataBodyItem")


@_attrs_define
class PutServicesFreeRADIUSInterfacesEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_free_radius_interfaces_endpoint_data_body_item = cls(
            addr=addr,
            ip_version=ip_version,
            port=port,
            type_=type_,
        ...
        put_services_free_radius_interfaces_endpoint_data_body_item.additional_properties = d
        return put_services_free_radius_interfaces_endpoint_data_body_item
