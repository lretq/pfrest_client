...
T = TypeVar("T", bound="GetServicesDNSResolverApplyEndpointResponse406")


@_attrs_define
class GetServicesDNSResolverApplyEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_dns_resolver_apply_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_services_dns_resolver_apply_endpoint_response_406.additional_properties = d
        return get_services_dns_resolver_apply_endpoint_response_406
