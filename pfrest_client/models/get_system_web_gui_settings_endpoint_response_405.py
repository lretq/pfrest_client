...
T = TypeVar("T", bound="GetSystemWebGUISettingsEndpointResponse405")


@_attrs_define
class GetSystemWebGUISettingsEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_web_gui_settings_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_system_web_gui_settings_endpoint_response_405.additional_properties = d
        return get_system_web_gui_settings_endpoint_response_405
