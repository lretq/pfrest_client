...
T = TypeVar("T", bound="DeleteServicesBINDViewEndpointResponse422")


@_attrs_define
class DeleteServicesBINDViewEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_services_bind_view_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_services_bind_view_endpoint_response_422.additional_properties = d
        return delete_services_bind_view_endpoint_response_422
