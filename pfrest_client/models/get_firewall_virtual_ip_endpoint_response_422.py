...
T = TypeVar("T", bound="GetFirewallVirtualIPEndpointResponse422")


@_attrs_define
class GetFirewallVirtualIPEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_virtual_ip_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_firewall_virtual_ip_endpoint_response_422.additional_properties = d
        return get_firewall_virtual_ip_endpoint_response_422
