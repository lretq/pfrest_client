...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendAddressEndpointResponse406")


@_attrs_define
class PatchServicesHAProxyFrontendAddressEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_frontend_address_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_services_ha_proxy_frontend_address_endpoint_response_406.additional_properties = d
        return patch_services_ha_proxy_frontend_address_endpoint_response_406
