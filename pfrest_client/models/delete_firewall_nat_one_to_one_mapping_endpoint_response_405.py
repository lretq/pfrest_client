...
T = TypeVar("T", bound="DeleteFirewallNATOneToOneMappingEndpointResponse405")


@_attrs_define
class DeleteFirewallNATOneToOneMappingEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_firewall_nat_one_to_one_mapping_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_firewall_nat_one_to_one_mapping_endpoint_response_405.additional_properties = d
        return delete_firewall_nat_one_to_one_mapping_endpoint_response_405
