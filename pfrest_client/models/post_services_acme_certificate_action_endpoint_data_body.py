...
T = TypeVar("T", bound="PostServicesACMECertificateActionEndpointDataBody")


@_attrs_define
class PostServicesACMECertificateActionEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_acme_certificate_action_endpoint_data_body = cls(
            command=command,
            method=method,
            parent_id=parent_id,
            status=status,
        ...
        post_services_acme_certificate_action_endpoint_data_body.additional_properties = d
        return post_services_acme_certificate_action_endpoint_data_body
