...
T = TypeVar("T", bound="GetInterfaceBridgesEndpointResponse405")


@_attrs_define
class GetInterfaceBridgesEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_interface_bridges_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_interface_bridges_endpoint_response_405.additional_properties = d
        return get_interface_bridges_endpoint_response_405
