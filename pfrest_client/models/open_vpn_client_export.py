...
T = TypeVar("T", bound="OpenVPNClientExport")


@_attrs_define
class OpenVPNClientExport:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_vpn_client_export.additional_properties = d
        return open_vpn_client_export
