...
T = TypeVar("T", bound="PostFirewallTrafficShaperLimiterEndpointResponse405")


@_attrs_define
class PostFirewallTrafficShaperLimiterEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_limiter_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_firewall_traffic_shaper_limiter_endpoint_response_405.additional_properties = d
        return post_firewall_traffic_shaper_limiter_endpoint_response_405
