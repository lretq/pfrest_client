...
T = TypeVar("T", bound="DeleteVPNOpenVPNClientEndpointResponse406")


@_attrs_define
class DeleteVPNOpenVPNClientEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_vpn_open_vpn_client_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        delete_vpn_open_vpn_client_endpoint_response_406.additional_properties = d
        return delete_vpn_open_vpn_client_endpoint_response_406
