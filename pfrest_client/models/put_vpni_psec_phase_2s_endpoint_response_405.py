...
T = TypeVar("T", bound="PutVPNIPsecPhase2SEndpointResponse405")


@_attrs_define
class PutVPNIPsecPhase2SEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_vpni_psec_phase_2s_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        put_vpni_psec_phase_2s_endpoint_response_405.additional_properties = d
        return put_vpni_psec_phase_2s_endpoint_response_405
