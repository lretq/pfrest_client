...
T = TypeVar("T", bound="GetDiagnosticsTableEndpointResponse405")


@_attrs_define
class GetDiagnosticsTableEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_diagnostics_table_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_diagnostics_table_endpoint_response_405.additional_properties = d
        return get_diagnostics_table_endpoint_response_405
