...
T = TypeVar("T", bound="PostFirewallScheduleEndpointJsonBody")


@_attrs_define
class PostFirewallScheduleEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_schedule_endpoint_json_body = cls(
            name=name,
            timerange=timerange,
        ...
        post_firewall_schedule_endpoint_json_body.additional_properties = d
        return post_firewall_schedule_endpoint_json_body
