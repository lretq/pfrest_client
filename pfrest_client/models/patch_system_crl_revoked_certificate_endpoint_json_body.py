...
T = TypeVar("T", bound="PatchSystemCRLRevokedCertificateEndpointJsonBody")


@_attrs_define
class PatchSystemCRLRevokedCertificateEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_crl_revoked_certificate_endpoint_json_body = cls(
            parent_id=parent_id,
            id=id,
            certref=certref,
            serial=serial,
        ...
        patch_system_crl_revoked_certificate_endpoint_json_body.additional_properties = d
        return patch_system_crl_revoked_certificate_endpoint_json_body
