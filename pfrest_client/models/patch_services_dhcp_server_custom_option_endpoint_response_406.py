...
T = TypeVar("T", bound="PatchServicesDHCPServerCustomOptionEndpointResponse406")


@_attrs_define
class PatchServicesDHCPServerCustomOptionEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dhcp_server_custom_option_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_services_dhcp_server_custom_option_endpoint_response_406.additional_properties = d
        return patch_services_dhcp_server_custom_option_endpoint_response_406
