...
T = TypeVar("T", bound="GetFirewallScheduleTimeRangesEndpointResponse422")


@_attrs_define
class GetFirewallScheduleTimeRangesEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_firewall_schedule_time_ranges_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_firewall_schedule_time_ranges_endpoint_response_422.additional_properties = d
        return get_firewall_schedule_time_ranges_endpoint_response_422
