...
T = TypeVar("T", bound="PostDiagnosticsPingEndpointResponse405")


@_attrs_define
class PostDiagnosticsPingEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_diagnostics_ping_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_diagnostics_ping_endpoint_response_405.additional_properties = d
        return post_diagnostics_ping_endpoint_response_405
