...
T = TypeVar("T", bound="PutServicesHAProxyBackendsEndpointJsonBodyItem")


@_attrs_define
class PutServicesHAProxyBackendsEndpointJsonBodyItem:
    """
    Attributes:
        name (str): The unique name for this backend.<br>
        agent_port (str):  Valid options are: a TCP/UDP port number<br><br>This field is only available when the
            following conditions are met:<br>- `agent_checks` must be equal to `true`<br>
        persist_cookie_name (str): The string name to track in Set-Cookie and Cookie HTTP headers.<br><br>This field is
            only available when the following conditions are met:<br>- `persist_cookie_enabled` must be equal to `true`<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_port = d.pop("agent_port")

        persist_cookie_name = d.pop("persist_cookie_name")
        ...
        put_services_ha_proxy_backends_endpoint_json_body_item = cls(
            name=name,
            agent_port=agent_port,
            persist_cookie_name=persist_cookie_name,
            servers=servers,
        ...
        put_services_ha_proxy_backends_endpoint_json_body_item.additional_properties = d
        return put_services_ha_proxy_backends_endpoint_json_body_item
