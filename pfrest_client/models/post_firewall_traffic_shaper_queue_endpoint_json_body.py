...
T = TypeVar("T", bound="PostFirewallTrafficShaperQueueEndpointJsonBody")


@_attrs_define
class PostFirewallTrafficShaperQueueEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_firewall_traffic_shaper_queue_endpoint_json_body = cls(
            name=name,
            qlimit=qlimit,
            bandwidth=bandwidth,
            upperlimit_m2=upperlimit_m2,
        ...
        post_firewall_traffic_shaper_queue_endpoint_json_body.additional_properties = d
        return post_firewall_traffic_shaper_queue_endpoint_json_body
