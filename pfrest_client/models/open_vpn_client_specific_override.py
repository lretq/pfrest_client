...
T = TypeVar("T", bound="OpenVPNClientSpecificOverride")


@_attrs_define
class OpenVPNClientSpecificOverride:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        open_vpn_client_specific_override = cls(
        ...
        open_vpn_client_specific_override.additional_properties = d
        return open_vpn_client_specific_override
