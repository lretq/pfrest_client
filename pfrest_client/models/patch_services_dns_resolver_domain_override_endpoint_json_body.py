...
T = TypeVar("T", bound="PatchServicesDNSResolverDomainOverrideEndpointJsonBody")


@_attrs_define
class PatchServicesDNSResolverDomainOverrideEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dns_resolver_domain_override_endpoint_json_body = cls(
            id=id,
            domain=domain,
            ip=ip,
            descr=descr,
        ...
        patch_services_dns_resolver_domain_override_endpoint_json_body.additional_properties = d
        return patch_services_dns_resolver_domain_override_endpoint_json_body
