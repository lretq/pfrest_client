...
T = TypeVar("T", bound="PutFirewallTrafficShapersEndpointJsonBodyItem")


@_attrs_define
class PutFirewallTrafficShapersEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_firewall_traffic_shapers_endpoint_json_body_item = cls(
            interface=interface,
            scheduler=scheduler,
            bandwidthtype=bandwidthtype,
            bandwidth=bandwidth,
        ...
        put_firewall_traffic_shapers_endpoint_json_body_item.additional_properties = d
        return put_firewall_traffic_shapers_endpoint_json_body_item
