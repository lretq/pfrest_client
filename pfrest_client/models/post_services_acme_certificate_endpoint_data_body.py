...
T = TypeVar("T", bound="PostServicesACMECertificateEndpointDataBody")


@_attrs_define
class PostServicesACMECertificateEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_acme_certificate_endpoint_data_body = cls(
            name=name,
            acmeaccount=acmeaccount,
            keypaste=keypaste,
            a_domainlist=a_domainlist,
        ...
        post_services_acme_certificate_endpoint_data_body.additional_properties = d
        return post_services_acme_certificate_endpoint_data_body
