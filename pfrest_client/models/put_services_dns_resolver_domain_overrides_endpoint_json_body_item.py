...
T = TypeVar("T", bound="PutServicesDNSResolverDomainOverridesEndpointJsonBodyItem")


@_attrs_define
class PutServicesDNSResolverDomainOverridesEndpointJsonBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_services_dns_resolver_domain_overrides_endpoint_json_body_item = cls(
            domain=domain,
            ip=ip,
            descr=descr,
        ...
        put_services_dns_resolver_domain_overrides_endpoint_json_body_item.additional_properties = d
        return put_services_dns_resolver_domain_overrides_endpoint_json_body_item
