...
T = TypeVar("T", bound="GetVPNIPsecPhase2SEndpointResponse405")


@_attrs_define
class GetVPNIPsecPhase2SEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpni_psec_phase_2s_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_vpni_psec_phase_2s_endpoint_response_405.additional_properties = d
        return get_vpni_psec_phase_2s_endpoint_response_405
