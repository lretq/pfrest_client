...
T = TypeVar("T", bound="GetVPNWireGuardTunnelEndpointResponse406")


@_attrs_define
class GetVPNWireGuardTunnelEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpn_wire_guard_tunnel_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_vpn_wire_guard_tunnel_endpoint_response_406.additional_properties = d
        return get_vpn_wire_guard_tunnel_endpoint_response_406
