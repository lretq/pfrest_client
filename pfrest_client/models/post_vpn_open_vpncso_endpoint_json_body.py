...
T = TypeVar("T", bound="PostVPNOpenVPNCSOEndpointJsonBody")


@_attrs_define
class PostVPNOpenVPNCSOEndpointJsonBody:
    """
    Attributes:
        common_name (str): The X.509 common name for the client certificate, or the username for VPNs utilizing password
            authentication.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_open_vpncso_endpoint_json_body = cls(
            common_name=common_name,
            disable=disable,
            block=block,
        ...
        post_vpn_open_vpncso_endpoint_json_body.additional_properties = d
        return post_vpn_open_vpncso_endpoint_json_body
