...
T = TypeVar("T", bound="PatchServicesDNSResolverHostOverrideAliasEndpointResponse406")


@_attrs_define
class PatchServicesDNSResolverHostOverrideAliasEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_dns_resolver_host_override_alias_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_services_dns_resolver_host_override_alias_endpoint_response_406.additional_properties = d
        return patch_services_dns_resolver_host_override_alias_endpoint_response_406
