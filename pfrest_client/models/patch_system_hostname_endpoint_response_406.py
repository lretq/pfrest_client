...
T = TypeVar("T", bound="PatchSystemHostnameEndpointResponse406")


@_attrs_define
class PatchSystemHostnameEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_system_hostname_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        patch_system_hostname_endpoint_response_406.additional_properties = d
        return patch_system_hostname_endpoint_response_406
