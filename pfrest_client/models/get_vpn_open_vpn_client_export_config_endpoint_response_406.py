...
T = TypeVar("T", bound="GetVPNOpenVPNClientExportConfigEndpointResponse406")


@_attrs_define
class GetVPNOpenVPNClientExportConfigEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vpn_open_vpn_client_export_config_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_vpn_open_vpn_client_export_config_endpoint_response_406.additional_properties = d
        return get_vpn_open_vpn_client_export_config_endpoint_response_406
