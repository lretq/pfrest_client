...
T = TypeVar("T", bound="PostDiagnosticsPingEndpointResponse422")


@_attrs_define
class PostDiagnosticsPingEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_diagnostics_ping_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        post_diagnostics_ping_endpoint_response_422.additional_properties = d
        return post_diagnostics_ping_endpoint_response_422
