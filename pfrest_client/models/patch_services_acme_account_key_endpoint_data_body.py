...
T = TypeVar("T", bound="PatchServicesACMEAccountKeyEndpointDataBody")


@_attrs_define
class PatchServicesACMEAccountKeyEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_acme_account_key_endpoint_data_body = cls(
            id=id,
            name=name,
            descr=descr,
            email=email,
        ...
        patch_services_acme_account_key_endpoint_data_body.additional_properties = d
        return patch_services_acme_account_key_endpoint_data_body
