...
T = TypeVar("T", bound="PatchFirewallTrafficShaperLimiterQueueEndpointDataBody")


@_attrs_define
class PatchFirewallTrafficShaperLimiterQueueEndpointDataBody:
    """
    Attributes:
        parent_id (int): The ID of the parent this object is nested under.
        id (int): The ID of the object or resource to interact with.
        name (str | Unset): The unique name for this limiter queue.<br>
        ...
        aqm (TrafficShaperLimiterQueueAqm | Unset): The Active Queue Management (AQM) algorithm to use for this queue.
            AQM is the intelligent drop of network packets inside the queue, when it becomes full or gets close to becoming
    ...
    aqm: TrafficShaperLimiterQueueAqm | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        aqm: TrafficShaperLimiterQueueAqm | Unset
        if isinstance(_aqm, Unset):
            aqm = UNSET
        else:
            aqm = TrafficShaperLimiterQueueAqm(_aqm)
        ...
        patch_firewall_traffic_shaper_limiter_queue_endpoint_data_body = cls(
            parent_id=parent_id,
            id=id,
            name=name,
            number=number,
        ...
        patch_firewall_traffic_shaper_limiter_queue_endpoint_data_body.additional_properties = d
        return patch_firewall_traffic_shaper_limiter_queue_endpoint_data_body
