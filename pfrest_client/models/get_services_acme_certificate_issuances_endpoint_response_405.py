...
T = TypeVar("T", bound="GetServicesACMECertificateIssuancesEndpointResponse405")


@_attrs_define
class GetServicesACMECertificateIssuancesEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_acme_certificate_issuances_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_services_acme_certificate_issuances_endpoint_response_405.additional_properties = d
        return get_services_acme_certificate_issuances_endpoint_response_405
