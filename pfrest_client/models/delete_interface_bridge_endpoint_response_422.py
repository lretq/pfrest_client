...
T = TypeVar("T", bound="DeleteInterfaceBridgeEndpointResponse422")


@_attrs_define
class DeleteInterfaceBridgeEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_interface_bridge_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        delete_interface_bridge_endpoint_response_422.additional_properties = d
        return delete_interface_bridge_endpoint_response_422
