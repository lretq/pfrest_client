...
T = TypeVar("T", bound="PatchServicesBINDSyncRemoteHostEndpointJsonBody")


@_attrs_define
class PatchServicesBINDSyncRemoteHostEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_bind_sync_remote_host_endpoint_json_body = cls(
            id=id,
        ...
        patch_services_bind_sync_remote_host_endpoint_json_body.additional_properties = d
        return patch_services_bind_sync_remote_host_endpoint_json_body
