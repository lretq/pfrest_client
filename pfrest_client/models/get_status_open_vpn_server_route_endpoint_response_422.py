...
T = TypeVar("T", bound="GetStatusOpenVPNServerRouteEndpointResponse422")


@_attrs_define
class GetStatusOpenVPNServerRouteEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_status_open_vpn_server_route_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        get_status_open_vpn_server_route_endpoint_response_422.additional_properties = d
        return get_status_open_vpn_server_route_endpoint_response_422
