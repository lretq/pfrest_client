...
T = TypeVar("T", bound="ACMECertificateIssue")


@_attrs_define
class ACMECertificateIssue:
    """
    Attributes:
        certificate (str | Unset): The name of the ACME certificate to be issued.<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        acme_certificate_issue.additional_properties = d
        return acme_certificate_issue
