...
T = TypeVar("T", bound="PatchStatusCARPEndpointResponse422")


@_attrs_define
class PatchStatusCARPEndpointResponse422:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_status_carp_endpoint_response_422 = cls(
            code=code,
            status=status,
        ...
        patch_status_carp_endpoint_response_422.additional_properties = d
        return patch_status_carp_endpoint_response_422
