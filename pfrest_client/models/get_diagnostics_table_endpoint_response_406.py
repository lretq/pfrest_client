...
T = TypeVar("T", bound="GetDiagnosticsTableEndpointResponse406")


@_attrs_define
class GetDiagnosticsTableEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_diagnostics_table_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_diagnostics_table_endpoint_response_406.additional_properties = d
        return get_diagnostics_table_endpoint_response_406
