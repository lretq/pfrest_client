...
T = TypeVar("T", bound="PostServicesACMEAccountKeyEndpointResponse405")


@_attrs_define
class PostServicesACMEAccountKeyEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_acme_account_key_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        post_services_acme_account_key_endpoint_response_405.additional_properties = d
        return post_services_acme_account_key_endpoint_response_405
