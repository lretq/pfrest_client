...
T = TypeVar("T", bound="GetSystemHostnameEndpointResponse405")


@_attrs_define
class GetSystemHostnameEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_hostname_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        get_system_hostname_endpoint_response_405.additional_properties = d
        return get_system_hostname_endpoint_response_405
