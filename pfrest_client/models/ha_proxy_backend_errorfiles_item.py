...
T = TypeVar("T", bound="HAProxyBackendErrorfilesItem")


@_attrs_define
class HAProxyBackendErrorfilesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_backend_errorfiles_item = cls(
            errorcode=errorcode,
            errorfile=errorfile,
        )

        ha_proxy_backend_errorfiles_item.additional_properties = d
        return ha_proxy_backend_errorfiles_item
