...
T = TypeVar("T", bound="DeleteInterfaceVLANEndpointResponse405")


@_attrs_define
class DeleteInterfaceVLANEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_interface_vlan_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_interface_vlan_endpoint_response_405.additional_properties = d
        return delete_interface_vlan_endpoint_response_405
