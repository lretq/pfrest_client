...
T = TypeVar("T", bound="PatchStatusCARPEndpointResponse405")


@_attrs_define
class PatchStatusCARPEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_status_carp_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_status_carp_endpoint_response_405.additional_properties = d
        return patch_status_carp_endpoint_response_405
