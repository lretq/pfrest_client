...
T = TypeVar("T", bound="PatchServicesFreeRADIUSInterfaceEndpointJsonBody")


@_attrs_define
class PatchServicesFreeRADIUSInterfaceEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_free_radius_interface_endpoint_json_body = cls(
            id=id,
            addr=addr,
            port=port,
            type_=type_,
        ...
        patch_services_free_radius_interface_endpoint_json_body.additional_properties = d
        return patch_services_free_radius_interface_endpoint_json_body
