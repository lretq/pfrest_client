...
T = TypeVar("T", bound="GetSystemRESTAPIVersionEndpointResponse406")


@_attrs_define
class GetSystemRESTAPIVersionEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_system_restapi_version_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_system_restapi_version_endpoint_response_406.additional_properties = d
        return get_system_restapi_version_endpoint_response_406
