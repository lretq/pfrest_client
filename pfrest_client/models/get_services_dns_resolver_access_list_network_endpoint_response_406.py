...
T = TypeVar("T", bound="GetServicesDNSResolverAccessListNetworkEndpointResponse406")


@_attrs_define
class GetServicesDNSResolverAccessListNetworkEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_dns_resolver_access_list_network_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_services_dns_resolver_access_list_network_endpoint_response_406.additional_properties = d
        return get_services_dns_resolver_access_list_network_endpoint_response_406
