...
T = TypeVar("T", bound="PutUserGroupsEndpointDataBodyItem")


@_attrs_define
class PutUserGroupsEndpointDataBodyItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_user_groups_endpoint_data_body_item = cls(
            name=name,
            gid=gid,
            scope=scope,
        ...
        put_user_groups_endpoint_data_body_item.additional_properties = d
        return put_user_groups_endpoint_data_body_item
