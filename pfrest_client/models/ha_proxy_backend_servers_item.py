...
T = TypeVar("T", bound="HAProxyBackendServersItem")


@_attrs_define
class HAProxyBackendServersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_backend_servers_item = cls(
            name=name,
            address=address,
            port=port,
            status=status,
        ...
        ha_proxy_backend_servers_item.additional_properties = d
        return ha_proxy_backend_servers_item
