...
T = TypeVar("T", bound="PatchUserAuthServerEndpointResponse405")


@_attrs_define
class PatchUserAuthServerEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_user_auth_server_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_user_auth_server_endpoint_response_405.additional_properties = d
        return patch_user_auth_server_endpoint_response_405
