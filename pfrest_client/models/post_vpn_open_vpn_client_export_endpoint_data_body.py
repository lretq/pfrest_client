...
T = TypeVar("T", bound="PostVPNOpenVPNClientExportEndpointDataBody")


@_attrs_define
class PostVPNOpenVPNClientExportEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_vpn_open_vpn_client_export_endpoint_data_body = cls(
            id=id,
            type_=type_,
            certref=certref,
            username=username,
        ...
        post_vpn_open_vpn_client_export_endpoint_data_body.additional_properties = d
        return post_vpn_open_vpn_client_export_endpoint_data_body
