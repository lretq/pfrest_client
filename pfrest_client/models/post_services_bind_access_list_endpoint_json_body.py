...
T = TypeVar("T", bound="PostServicesBINDAccessListEndpointJsonBody")


@_attrs_define
class PostServicesBINDAccessListEndpointJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_bind_access_list_endpoint_json_body = cls(
            name=name,
            entries=entries,
            description=description,
        )

        post_services_bind_access_list_endpoint_json_body.additional_properties = d
        return post_services_bind_access_list_endpoint_json_body
