...
T = TypeVar("T", bound="PostServicesACMEAccountKeyEndpointDataBody")


@_attrs_define
class PostServicesACMEAccountKeyEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_services_acme_account_key_endpoint_data_body = cls(
            name=name,
            acmeserver=acmeserver,
            descr=descr,
            email=email,
        ...
        post_services_acme_account_key_endpoint_data_body.additional_properties = d
        return post_services_acme_account_key_endpoint_data_body
