...
T = TypeVar("T", bound="PatchServicesHAProxyBackendActionEndpointDataBody")


@_attrs_define
class PatchServicesHAProxyBackendActionEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_backend_action_endpoint_data_body = cls(
            parent_id=parent_id,
            id=id,
            action=action,
            acl=acl,
        ...
        patch_services_ha_proxy_backend_action_endpoint_data_body.additional_properties = d
        return patch_services_ha_proxy_backend_action_endpoint_data_body
