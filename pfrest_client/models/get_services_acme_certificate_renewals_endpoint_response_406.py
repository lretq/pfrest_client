...
T = TypeVar("T", bound="GetServicesACMECertificateRenewalsEndpointResponse406")


@_attrs_define
class GetServicesACMECertificateRenewalsEndpointResponse406:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_services_acme_certificate_renewals_endpoint_response_406 = cls(
            code=code,
            status=status,
        ...
        get_services_acme_certificate_renewals_endpoint_response_406.additional_properties = d
        return get_services_acme_certificate_renewals_endpoint_response_406
