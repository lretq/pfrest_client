...
T = TypeVar("T", bound="PatchServicesHAProxyFrontendErrorFileEndpointResponse405")


@_attrs_define
class PatchServicesHAProxyFrontendErrorFileEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_services_ha_proxy_frontend_error_file_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_services_ha_proxy_frontend_error_file_endpoint_response_405.additional_properties = d
        return patch_services_ha_proxy_frontend_error_file_endpoint_response_405
