...
T = TypeVar("T", bound="DeleteRoutingStaticRouteEndpointResponse405")


@_attrs_define
class DeleteRoutingStaticRouteEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_routing_static_route_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        delete_routing_static_route_endpoint_response_405.additional_properties = d
        return delete_routing_static_route_endpoint_response_405
