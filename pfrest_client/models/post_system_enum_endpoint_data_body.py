...
T = TypeVar("T", bound="PostSystemEnumEndpointDataBody")


@_attrs_define
class PostSystemEnumEndpointDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_system_enum_endpoint_data_body = cls(
            model_name=model_name,
            model_field=model_field,
            choices=choices,
        )

        post_system_enum_endpoint_data_body.additional_properties = d
        return post_system_enum_endpoint_data_body
