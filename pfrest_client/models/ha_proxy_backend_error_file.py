...
T = TypeVar("T", bound="HAProxyBackendErrorFile")


@_attrs_define
class HAProxyBackendErrorFile:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ha_proxy_backend_error_file = cls(
            errorcode=errorcode,
            errorfile=errorfile,
        )

        ha_proxy_backend_error_file.additional_properties = d
        return ha_proxy_backend_error_file
