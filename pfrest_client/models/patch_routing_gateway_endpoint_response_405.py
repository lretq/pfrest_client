...
T = TypeVar("T", bound="PatchRoutingGatewayEndpointResponse405")


@_attrs_define
class PatchRoutingGatewayEndpointResponse405:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_routing_gateway_endpoint_response_405 = cls(
            code=code,
            status=status,
        ...
        patch_routing_gateway_endpoint_response_405.additional_properties = d
        return patch_routing_gateway_endpoint_response_405
